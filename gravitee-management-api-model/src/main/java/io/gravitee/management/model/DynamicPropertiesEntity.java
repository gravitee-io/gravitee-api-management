...
public class DynamicPropertiesEntity {
    ...
    public void setDynamicPropertiesApiUrl(String dynamicPropertiesApiUrl) {
        this.dynamicPropertiesApiUrl = dynamicPropertiesApiUrl;
    }
    ...
    public void setJoltSpecs(String joltSpecs) {
        this.joltSpecs = joltSpecs;
    }
}
