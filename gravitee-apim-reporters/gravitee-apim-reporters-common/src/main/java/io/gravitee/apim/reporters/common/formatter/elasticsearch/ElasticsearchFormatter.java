 ...
 */
package io.gravitee.apim.reporters.common.formatter.elasticsearch;
...
public class ElasticsearchFormatter<T extends Reportable> extends AbstractFormatter<T> {
    ...
    private Buffer getSource(EventMetrics metrics, Map<String, Object> esOptions) {
        final Map<String, Object> data = new HashMap<>(5);
        addCommonFields(data, metrics, esOptions);
        data.put("metrics", metrics);
    ...
    private void initFormatters() {
        ...
        formatters.put(EventMetrics.class, (r, o) -> getSource((EventMetrics) r, o));
