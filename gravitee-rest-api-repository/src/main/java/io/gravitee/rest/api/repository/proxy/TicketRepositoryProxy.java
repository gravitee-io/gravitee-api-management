 ...
 */
@Component
public class TicketRepositoryProxy extends AbstractProxy<TicketRepository> implements TicketRepository {

    @Override
    public Ticket create(Ticket item) throws TechnicalException {
