...
public class ApiContextHandlerFactory implements ReactorHandlerFactory<Api> {
    ...
    public ReactorHandler create(Api api) {
        try {
            if (api.isEnabled()) {
                ...
                ComponentProvider componentProvider = applicationContext.getBean(ComponentProvider.class);
                ...
                final RequestProcessorChainFactory requestProcessorChainFactory = requestProcessorChainFactory(
                    ...
                    authenticationHandlerSelector(
                        authenticationHandlerManager(securityProviderLoader(), authenticationHandlerEnhancer(api), componentProvider)
                    )
                );
                ...
                ExecutionContextFactory executionContextFactory = executionContextFactory(componentProvider);
    ...
    public ResponseProcessorChainFactory responseProcessorChainFactory(
        ...
        return new ResponseProcessorChainFactory(api, policyChainFactory, policyChainProviderLoader);
    }
