 ...
 */
package io.gravitee.rest.api.management.standalone.boostrap;
...
public class Bootstrap {
    ...
    private static final String CONTAINER_CLASS = "io.gravitee.rest.api.management.standalone.ManagementContainer";
    ...
    private void checkInstallRoot(File graviteeHomeDir) {
        ...
        File [] files = graviteeLibDir.listFiles(pathname ->
                pathname.getName().startsWith("gravitee-rest-api-management-standalone-bootstrap"));
