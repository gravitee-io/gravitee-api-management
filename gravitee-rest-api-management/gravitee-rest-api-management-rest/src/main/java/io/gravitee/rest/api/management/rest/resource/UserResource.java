...
public class UserResource extends AbstractResource {
    ...
    @ApiOperation(value = "Retrieve a user", notes = "User must have the MANAGEMENT_USERS[READ] permission to use this service")
    @ApiResponses(
        {
    ...
    @DELETE
    @ApiOperation(value = "Delete a user", notes = "User must have the MANAGEMENT_USERS[DELETE] permission to use this service")
    @ApiResponses(
        {
    ...
    @POST
    @ApiOperation(value = "Reset the user's password", notes = "User must have the MANAGEMENT_USERS[UPDATE] permission to use this service")
    @ApiResponses(
        {
