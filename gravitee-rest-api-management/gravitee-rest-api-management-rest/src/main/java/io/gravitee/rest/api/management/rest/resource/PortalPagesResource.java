...
public class PortalPagesResource extends AbstractResource {
    ...
    public List<PageEntity> getPortalPages(
        ...
        return pageService
            .search(
                new PageQuery.Builder().homepage(homepage).type(type).parent(parent).name(name).rootParent(rootParent).build(),
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = "Create a page", notes = "User must have the PORTAL_DOCUMENTATION[CREATE] permission to use this service")
    @ApiResponses(
        {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = "Update a page", notes = "User must have the PORTAL_DOCUMENTATION[UPDATE] permission to use this service")
    @ApiResponses(
        {
    ...
    @DELETE
    @Path("/{page}")
    @ApiOperation(value = "Delete a page", notes = "User must have the PORTAL_DOCUMENTATION[DELETE] permission to use this service")
    @ApiResponses(
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = "Import pages", notes = "User must have the PORTAL_DOCUMENTATION[CREATE] permission to use this service")
    @ApiResponses(
        {
            @ApiResponse(code = 201, message = "Page successfully created", response = PageEntity.class),
            @ApiResponse(code = 500, message = "Internal server error"),
