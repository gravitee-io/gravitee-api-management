...
public class NotificationTemplatesResource extends AbstractResource {
    ...
    public Response getNotificationTemplates(
            @ApiParam(value = "filter by notification scope")
            @QueryParam("scope") String scope,
            @ApiParam(value = "filter by notification hook")
            @QueryParam("hook") String hook
    ...
    @ApiResponses({
            ...
            @ApiResponse(code = 500, message = "Internal server error")})
    @Permissions({
            @Permission(value = RolePermission.ORGANIZATION_NOTIFICATION_TEMPLATES, acls = RolePermissionAction.CREATE)
    })
