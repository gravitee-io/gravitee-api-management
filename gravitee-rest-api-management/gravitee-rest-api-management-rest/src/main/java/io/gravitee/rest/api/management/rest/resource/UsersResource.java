...
public class UsersResource extends AbstractResource {
    ...
    @ApiResponses(
        {
            @ApiResponse(
                code = 200,
                message = "List users matching the query criteria",
                response = UserEntity.class,
                responseContainer = "PagedResult"
            ),
    ...
    @ApiOperation(value = "Create a user", notes = "User must have the MANAGEMENT_USERS[CREATE] permission to use this service")
    @ApiResponses(
        {
