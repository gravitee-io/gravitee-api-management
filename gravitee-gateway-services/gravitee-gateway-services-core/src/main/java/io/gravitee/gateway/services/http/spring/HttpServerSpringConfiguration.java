 ...
 */
package io.gravitee.gateway.services.http.spring;

import io.gravitee.gateway.services.http.auth.BasicAuthProvider;
...
public class HttpServerSpringConfiguration {
    ...
    @Bean
    public io.gravitee.gateway.services.http.HttpServer nodeHttpServer() {
        return new io.gravitee.gateway.services.http.HttpServer();
    }
