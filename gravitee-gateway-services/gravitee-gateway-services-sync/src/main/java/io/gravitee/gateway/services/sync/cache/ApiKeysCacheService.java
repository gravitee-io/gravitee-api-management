...
public class ApiKeysCacheService extends AbstractService implements EventListener<ReactorEvent, Reactable> {
    ...
    protected void doStart() throws Exception {
        ...
        beanFactory.registerSingleton(
            ...
            new ApiKeyRepositoryWrapper(this.apiKeyRepository, new ApiKeysCache(cacheManager.getMap(API_KEY_CACHE_NAME)))
        );
                    ...
                    final List<Callable<Result<Boolean>>> callables = chunks
                        ...
                        .map(
                            chunk -> {
                                ...
                                refresher.setCache(new ApiKeysCache(cacheManager.getMap(API_KEY_CACHE_NAME)));
