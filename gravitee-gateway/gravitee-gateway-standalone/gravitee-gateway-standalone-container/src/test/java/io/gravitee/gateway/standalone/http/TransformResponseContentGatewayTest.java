...
public class TransformResponseContentGatewayTest extends AbstractWiremockGatewayTest {
    ...
    public void register(ConfigurablePluginManager<PolicyPlugin> policyPluginManager) {
        ...
        PolicyPlugin transformRequestContentPolicy = PolicyBuilder.build("transform-response-content", TransformResponseContentPolicy.class);
