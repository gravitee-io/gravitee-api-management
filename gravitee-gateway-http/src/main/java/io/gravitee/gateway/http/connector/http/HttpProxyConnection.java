        ...
        httpClientRequest.exceptionHandler(event -> {
            if (!isCanceled() && !isTransmitted()) {
                ...
                if (this.timeoutHandler() != null
                    ...
                    final ProxyResponse clientResponse = ((event instanceof ConnectTimeoutException) || (event instanceof TimeoutException)) ?
                            new ClientTimeoutResponse() : new ClientConnectionResponse();
