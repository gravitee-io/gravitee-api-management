 ...
 */
public interface SwaggerToApiConverter<S extends SwaggerDescriptor> extends SwaggerConverter<S, NewSwaggerApiEntity> {

    NewSwaggerApiEntity convert(S descriptor);
}
