...
public class RedisClient {
    ...
    private final AtomicBoolean roleCheckSkippedLogged = new AtomicBoolean(false);
    ...
    private Future<RedisAPI> requireWritableMaster(final RedisAPI redisAPI) {
        return applySentinelRoleCheck(redisAPI, options.getType() == RedisClientType.SENTINEL, this::logRoleCheckSkipped);
    }
