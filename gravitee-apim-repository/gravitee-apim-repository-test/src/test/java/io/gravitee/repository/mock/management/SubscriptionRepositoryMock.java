...
public class SubscriptionRepositoryMock extends AbstractRepositoryMock<SubscriptionRepository> {
    ...
    @Override
    protected void prepare(SubscriptionRepository subscriptionRepository) throws Exception {
        ...
        sub1.setFilter("my-filter");
        sub1.setConfiguration("{}");
        sub1.setType(Subscription.Type.STANDARD);
        ...
        when(subscriptionRepository.findByIdIn(argThat(ids -> ids != null && ids.contains("sub1")))).thenReturn(List.of(sub1));
