 ...
 */
public class FlowRepositoryTest extends AbstractRepositoryTest {
    ...
    public void shouldCreate() throws TechnicalException {
        ...
        flow.setMethods(new HashSet<>(Arrays.asList(HttpMethod.CONNECT)));
        flow.setPath("/");
        ...
        flow.setPost(Arrays.asList(postStep));
