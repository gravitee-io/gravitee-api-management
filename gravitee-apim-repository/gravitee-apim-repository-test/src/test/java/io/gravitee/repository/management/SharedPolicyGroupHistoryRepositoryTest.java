...
public class SharedPolicyGroupHistoryRepositoryTest extends AbstractManagementRepositoryTest {
    ...
    @Test
    public void should_searchLastDeployedBySharedPolicyPolicyGroupId() throws TechnicalException {
        final var criteria = SharedPolicyGroupHistoryCriteria.builder().environmentId("environmentId").build();

        final var page1 = sharedPolicyGroupHistoryRepository.searchLastDeployedBySharedPolicyPolicyGroupId(
            criteria,
            new PageableBuilder().pageNumber(0).pageSize(2).build()
        );
        ...
        final var page2 = sharedPolicyGroupHistoryRepository.searchLastDeployedBySharedPolicyPolicyGroupId(
            criteria,
    ...
    @Test
    public void should_searchLastDeployedBySharedPolicyPolicyGroupId_with_no_result() throws TechnicalException {
        final var criteria = SharedPolicyGroupHistoryCriteria.builder().environmentId("unknown").build();

        final var page = sharedPolicyGroupHistoryRepository.searchLastDeployedBySharedPolicyPolicyGroupId(
            criteria,
            new PageableBuilder().pageNumber(0).pageSize(2).build()
        );
        assertThat(page).isNotNull();
    ...
    @Test
    public void should_searchLastDeployedBySharedPolicyPolicyGroupId_with_no_result_with_unknown_environment() throws TechnicalException {
        final var criteria = SharedPolicyGroupHistoryCriteria.builder().environmentId("unknown").build();
    ...
    @Test
    public void should_searchLastDeployedBySharedPolicyPolicyGroupId_with_lifecycleState_criteria() throws TechnicalException {
        final var criteria = SharedPolicyGroupHistoryCriteria
            .builder()
            .environmentId("environmentId")
        ...
        assertThat(page.getContent().get(0).getName()).isEqualTo("Name changed 9 times");
        assertThat(page.getContent().get(0).getLifecycleState()).isEqualTo(SharedPolicyGroupLifecycleState.DEPLOYED);
    }

    @Test
    public void should_throw_when_searchLastDeployedBySharedPolicyPolicyGroupId_with_sharedPolicyGroupId_criteria() {
        final var criteria = SharedPolicyGroupHistoryCriteria
            .builder()
            .environmentId("environmentId")
            .sharedPolicyGroupId("sharedPolicyGroupId_1")
        ...
        assertThatThrownBy(() ->
                sharedPolicyGroupHistoryRepository.searchLastDeployedBySharedPolicyPolicyGroupId(
                    criteria,
                    new PageableBuilder().pageNumber(0).pageSize(2).build()
                )
            )
            ...
            .hasMessage("SharedPolicyGroupHistoryCriteria must not contain sharedPolicyGroupId criteria");
    }
