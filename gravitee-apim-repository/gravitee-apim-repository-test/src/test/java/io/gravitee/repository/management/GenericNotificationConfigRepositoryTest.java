...
public class GenericNotificationConfigRepositoryTest extends AbstractManagementRepositoryTest {
    ...
    public void shouldFindByHookAndOrgId() throws Exception {
        List<GenericNotificationConfig> configs = genericNotificationConfigRepository.findByHookAndOrgId("B", "org1");
    ...
    public void shouldNotFindByHookAndOrgId() throws Exception {
        List<GenericNotificationConfig> configs = genericNotificationConfigRepository.findByHookAndOrgId("A", "org4");
