 ...
 */
package io.gravitee.repository.mock;

import static org.mockito.Mockito.mock;

import io.gravitee.repository.config.TestRepositoryInitializer;
import io.gravitee.repository.mock.management.*;
import org.springframework.context.annotation.Bean;

public class ManagementMockTestRepositoryConfiguration {
    ...
    @Bean
    public QualityRuleRepositoryMock qualityRuleRepository() {
        return new QualityRuleRepositoryMock();
    }

    @Bean
    public ApiQualityRuleRepositoryMock apiQualityRuleRepository() {
    ...
    @Bean
    public EnvironmentRepositoryMock environmentRepository() {
        return new EnvironmentRepositoryMock();
    }

    @Bean
    public OrganizationRepositoryMock organizationRepository() {
        return new OrganizationRepositoryMock();
    }

    @Bean
    public ThemeRepositoryMock themeRepository() {
    ...
    @Bean
    public IdentityProviderActivationRepositoryMock identityProviderActivationRepository() {
