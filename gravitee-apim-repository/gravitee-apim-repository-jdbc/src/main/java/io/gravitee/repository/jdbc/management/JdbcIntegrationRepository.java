...
public class JdbcIntegrationRepository extends JdbcAbstractCrudRepository<JdbcIntegration, String> implements IntegrationRepository {
        ...
        try {
            integrations =
                jdbcTemplate
                    ...
                    .stream()
                    .flatMap(JdbcIntegrationRepository::toEntityIntegration)
                    .toList();
    ...
    public Optional<Integration> findByIntegrationId(String id) throws TechnicalException {
        var integration = super
            ...
            .flatMap(jdbcIntegration -> {
                try {
                    return Optional.of(jdbcIntegration.toIntegration());
    ...
    public Integration create(final Integration integration) throws TechnicalException {
        ...
        try {
            return super.create(JdbcIntegration.fromIntegration(integration)).toIntegration();
        } catch (JsonProcessingException e) {
    ...
    public Integration update(final Integration integration) throws TechnicalException {
        ...
        try {
            return super.update(JdbcIntegration.fromIntegration(integration)).toIntegration();
        } catch (JsonProcessingException e) {
    ...
    public static Stream<Integration> toEntityIntegration(JdbcIntegration jdbcIntegration) {
        try {
            return Stream.of(jdbcIntegration.toIntegration());
        } catch (JsonProcessingException e) {
