...
public class JdbcSubscriptionFormRepository
    ...
    /**
     * A duplicate key is a collision with another form of the environment (a second default form, a name already
     * taken, an API already mapped to another form), which the caller handles as a conflict rather than as a technical failure.
     */
