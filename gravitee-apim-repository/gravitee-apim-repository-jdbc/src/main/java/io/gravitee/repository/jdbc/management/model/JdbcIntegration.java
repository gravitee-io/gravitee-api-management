...
public class JdbcIntegration {
    ...
    public Integration toIntegration() throws JsonProcessingException {
        ...
        return new Integration(id, name, description, provider, environmentId, createdAt, updatedAt, null, a2aWellKnownUrls, null);
    }

    public static JdbcIntegration fromIntegration(Integration integration) throws JsonProcessingException {
        String integration1 = integration.getWellKnownUrls() != null && !integration.getWellKnownUrls().isEmpty()
