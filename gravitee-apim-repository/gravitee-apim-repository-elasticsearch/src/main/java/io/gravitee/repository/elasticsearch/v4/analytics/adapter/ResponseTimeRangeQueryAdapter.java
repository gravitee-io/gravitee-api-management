...
public class ResponseTimeRangeQueryAdapter {
    ...
    private ObjectNode query(ResponseTimeRangeQuery query) {
        ...
        ZonedDateTime from = query.from().minus(query.interval());
        ZonedDateTime to = query.to().plus(query.interval());
        ...
        ObjectNode histogram = json()
            ...
            .set(
                ...
                json()
                    ...
                    .put("min", query.from().toInstant().toEpochMilli())
                    .put("max", query.to().toInstant().toEpochMilli())
            );
        ObjectNode agg = json()
