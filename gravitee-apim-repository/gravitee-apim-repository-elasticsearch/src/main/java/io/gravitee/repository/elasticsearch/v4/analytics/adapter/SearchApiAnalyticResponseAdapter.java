...
public class SearchApiAnalyticResponseAdapter {

    public SearchApiAnalyticResponseAdapter() {}

    public static Optional<ApiAnalytic> adaptFirst(SearchResponse response) {
    ...
    private static ApiAnalytic buildFromSource(JsonNode json) {
        return ApiAnalytic
            .builder()
            ...
            .gatewayResponseTime(asLongOr(json.get("response-content-length"), 0))
