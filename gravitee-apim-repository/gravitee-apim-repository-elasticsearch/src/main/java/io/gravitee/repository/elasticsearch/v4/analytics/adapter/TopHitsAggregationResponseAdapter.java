...
public class TopHitsAggregationResponseAdapter {
            ...
            bucket
                ...
                .forEachRemaining(bucketName -> {
                    ...
                    if (bucketName.endsWith(DELTA_BUCKET_SUFFIX)) {
                        ...
                        addTendValue(result, bucketName, (endValue - startValue));
                    }
                })
        );
    }
    ...
    private static void addTendValue(Map<String, Map<String, List<Long>>> result, String bucketName, long value) {
