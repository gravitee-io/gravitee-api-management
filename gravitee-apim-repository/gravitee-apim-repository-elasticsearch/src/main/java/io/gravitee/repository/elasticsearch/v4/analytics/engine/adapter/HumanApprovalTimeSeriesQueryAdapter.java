...
/** Human approval measures bucketed over time — the human share of an agent's spend, as it accrues. */
public class HumanApprovalTimeSeriesQueryAdapter {

    private final HumanApprovalMeasuresQueryAdapter measuresAdapter = new HumanApprovalMeasuresQueryAdapter();
    private final HumanApprovalFacetsQueryAdapter facetsAdapter = new HumanApprovalFacetsQueryAdapter();

    public String adapt(TimeSeriesQuery query) {
        HumanApprovalFacetsQueryAdapter.rejectRanges(query.ranges());
