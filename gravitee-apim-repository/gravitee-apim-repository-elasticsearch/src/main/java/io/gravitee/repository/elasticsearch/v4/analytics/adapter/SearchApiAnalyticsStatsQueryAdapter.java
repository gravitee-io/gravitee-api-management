...
public class SearchApiAnalyticsStatsQueryAdapter {

    public static String adapt(ApiAnalyticsStatsQuery query) {
    ...
    private static JsonObject buildElasticQuery(ApiAnalyticsStatsQuery query) {
        if (query == null) {
            return null;
        }
