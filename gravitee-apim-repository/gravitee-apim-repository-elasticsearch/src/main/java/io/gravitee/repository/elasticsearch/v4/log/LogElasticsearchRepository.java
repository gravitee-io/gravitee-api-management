...
public class LogElasticsearchRepository extends AbstractElasticsearchRepository implements LogRepository {
    ...
    //    private SearchHits searchLogDetails(ConnectionLogQuery connectionLogQuery, QueryContext queryContext, List<DefinitionVersion> definitionVersions) {
    //        if (connectionLogQuery.getFilter())
    //        var connectionDetailIndexes = getQueryIndexesFromDefinitionVersions(Type.LOG, Type.V4_LOG, queryContext, definitionVersions);
    //
    //        // Convert connection log query to connection log detail query
    //        var connectionLogDetailQuery = ConnectionLogDetailQuery.builder()
    //                .page(connectionLogQuery.getPage())
    //                .size(connectionLogQuery.getSize())
    //                .build();
    //        // get indexes
