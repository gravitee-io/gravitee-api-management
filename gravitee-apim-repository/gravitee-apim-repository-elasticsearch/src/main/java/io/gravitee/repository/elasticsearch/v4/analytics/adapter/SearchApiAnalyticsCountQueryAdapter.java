...
public class SearchApiAnalyticsCountQueryAdapter {

    public static String adapt(ApiAnalyticsCountQuery query) {
    ...
    private static JsonObject buildElasticQuery(ApiAnalyticsCountQuery query) {
        if (query == null) {
            return null;
        }
