...
public class SearchApiAnalyticQueryAdapter {

    public SearchApiAnalyticQueryAdapter() {}

    public static String adapt(ApiAnalyticQuery query) {
    ...
    private static JsonObject buildElasticQuery(ApiAnalyticQuery query) {
        if (query == null) {
            return null;
        }
