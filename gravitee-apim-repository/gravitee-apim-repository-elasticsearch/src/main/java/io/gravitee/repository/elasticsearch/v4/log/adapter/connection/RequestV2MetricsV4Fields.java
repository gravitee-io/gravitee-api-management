...
public class RequestV2MetricsV4Fields {
    ...
    public static final Field LLM_PROXY_TOOL = new Field(LlmProxyFields.TOOL_NAMES);
    public static final Field LLM_PROXY_REQUEST_KIND = new Field(LlmProxyFields.REQUEST_KIND);
