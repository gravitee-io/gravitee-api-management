...
class ResponseTimeRangeQueryAdapterTest {
    ...
    void buildQuery() {
        ...
        // query part
        assertThat(jsonQuery.at("/query/bool/filter/0/0/bool/should/0/bool/must/0/terms/api-id").elements())
            .toIterable()
            .extracting(JsonNode::asText)
            .contains("MyAPI");
        assertThat(jsonQuery.at("/query/bool/filter/0/0/bool/should/1/terms/api").elements())
            .toIterable()
            .extracting(JsonNode::asText)
            .contains("MyAPI");
