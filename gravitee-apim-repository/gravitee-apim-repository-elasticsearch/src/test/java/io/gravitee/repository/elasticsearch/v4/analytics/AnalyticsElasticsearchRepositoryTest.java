...
class AnalyticsElasticsearchRepositoryTest extends AbstractElasticsearchRepositoryTest {
    ...
    class TopHitsCount {
        ...
        @Test
        void should_return_top_hits_count_for_a_given_apis() {
            var result = cut.searchTopHitsApi(
                new QueryContext("org#1", "env#1"),
                TopHitsQueryCriteria.builder().apiIds(List.of(API_ID)).build()
            );
            ...
            assertThat(result)
                ...
                .hasFieldOrPropertyWithValue(API_ID, 10L);
        }
        ...
        void should_return_empty_top_hits_count_for_empty_ids_list() {
            var result = cut.searchTopHitsApi(new QueryContext("org#1", "env#1"), TopHitsQueryCriteria.builder().apiIds(List.of()).build());
