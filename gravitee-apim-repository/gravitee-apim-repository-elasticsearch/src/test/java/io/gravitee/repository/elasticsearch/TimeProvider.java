...
public class TimeProvider {
    ...
    public void setTimestamps(Map<String, Object> data) {
        ...
        IntStream.rangeClosed(1, 10).forEach(i -> data.putIfAbsent("nowMinus" + i, timestamp.minusSeconds(i * 60L).toEpochMilli()));
        IntStream.rangeClosed(1, 10).forEach(i -> data.putIfAbsent("nowPlus" + i, timestamp.plusSeconds(i * 60L).toEpochMilli()));
    }
}
