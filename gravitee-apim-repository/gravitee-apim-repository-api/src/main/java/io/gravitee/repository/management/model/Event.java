...
public class Event implements Serializable {
    ...
    public enum EventProperties {
        ...
        DEPLOYMENT_FAILURE_CAUSE("deployment_failure_cause"),
        DEPLOYMENT_FAILURE_EVENT("deployment_failure_event"),
        DEPLOYMENT_FAILURE_GATEWAY("deployment_failure_gateway"),
