...
public record ApiAnalyticsDateHistoQuery(
    ...
    public ApiAnalyticsDateHistoQuery() {
        this(Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty());
    }

    public ApiAnalyticsDateHistoQuery(String apiId, Instant from, Instant to, ApiAnalyticsField field, Duration interval) {
        this(
