 ...
 */
public class FlowSerializer extends StdScalarSerializer<FlowEntity> {

    public FlowSerializer(Class<FlowEntity> vc) {
        super(vc);
    }

    @Override
    public void serialize(FlowEntity flow, JsonGenerator jgen, SerializerProvider provider) throws IOException {
