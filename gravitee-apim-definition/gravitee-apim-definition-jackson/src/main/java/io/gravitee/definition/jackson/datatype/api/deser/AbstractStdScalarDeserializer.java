...
public abstract class AbstractStdScalarDeserializer<T> extends StdScalarDeserializer<T> {
    ...
    protected AbstractStdScalarDeserializer(Class<?> vc) {
        super(vc);
    }

    protected String readStringValue(JsonNode rootNode, String fieldName) {
        return readStringValue(rootNode, fieldName, null);
    }
