...
import io.gravitee.definition.jackson.datatype.filter.DeploymentRequiredFilterProvider;
...
public class DeploymentRequiredMapper extends ObjectMapper {
    ...
    public DeploymentRequiredMapper() {
        this.setFilterProvider(new DeploymentRequiredFilterProvider(true));
