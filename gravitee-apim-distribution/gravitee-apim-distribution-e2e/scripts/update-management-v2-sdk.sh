...
mkdir -p .tmp
sed s/'uniqueItems: true'/'uniqueItems: false'/g ../../gravitee-apim-rest-api/gravitee-apim-rest-api-management-v2/gravitee-apim-rest-api-management-v2-model/src/main/resources/openapi/openapi-environments.yaml > .tmp/openapi-environments.yaml
sed s/'uniqueItems: true'/'uniqueItems: false'/g ../../gravitee-apim-rest-api/gravitee-apim-rest-api-management-v2/gravitee-apim-rest-api-management-v2-model/src/main/resources/openapi/openapi-apis.yaml > .tmp/openapi-apis.yaml
