...
export class ApiService {
    ...
    /**
     * List Categories
     * List all categories find in public APIs for anonymous requests. List all categories find in all the APIs the current user is allowed to category for authenticated requests.  The list is sorted by alphabetic order. 
     * @param requestParameters
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    ...
    public listCategories(requestParameters: ListCategoriesRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.get<CategoriesResponse>(`${this.configuration.basePath}/apis/_categories`,
            {
                params: queryParameters,
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
