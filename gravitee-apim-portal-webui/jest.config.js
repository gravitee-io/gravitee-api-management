...
module.exports = {
  ...
  transformIgnorePatterns: [
    '/node_modules/(?!(.*\\.mjs$)|(@gravitee/ui-components/.*?\\.js)|github-slugger|lit|@lit/reactive-element|(lit-element/.*?\\.js)|(resize-observer-polyfill/.*?\\.js)|(date-fns/.*?\\.js)|(marked-extended-tables)|(@asciidoctor/.*?\\.js)$)',
  ],
  transform: {
    '\\.js$': 'babel-jest',
    '\\.mjs$': 'babel-jest',
