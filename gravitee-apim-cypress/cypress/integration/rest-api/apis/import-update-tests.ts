...
context('API - Imports - Update', () => {
  ...
  describe('Update API from import with pages', () => {
    ...
    describe('Update API with existing page ID, using previous export', () => {
      ...
      const expectedPageId = '4b07e8b5-d30d-3568-ad3b-7ba0820d2f22';
    ...
    describe('Update API, duplicating system folder', () => {
      ...
      it('should reject the import if trying to add a new system folder', () => {
        ...
        importUpdateApi(ADMIN_USER, expectedApiId, apiUpdate).badRequest();
      });
    ...
    describe('Update API page in a page tree', () => {
      ...
      const expectedFolderId = '3f8ddb41-0d27-37fc-bd30-a6801047f454';
      const expectedPageId = 'cb18fc2b-750f-3d5c-b6cf-7bc5a977b912';
