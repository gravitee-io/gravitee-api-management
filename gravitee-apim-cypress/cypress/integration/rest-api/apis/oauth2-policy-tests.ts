...
import { am_createApplication, am_deleteApplication, am_patchApplication } from '@commands/am_management/am_application-management-commands';
...
import { deleteApi, deployApi, startApi, stopApi } from '@commands/management/api-management-commands';
import { createOauth2Api } from '@commands/wrapper';
      ...
      .then(() => {
        ...
        am_createApplication(am_apiToken, am_noScopeApplicationName, am_domainId)
          ...
          .then((application: Application) => {
            ...
            createOauth2Api(am_domainHrid, application.settings.oauth.clientId, application.settings.oauth.clientSecret)
              .ok()
              .its('body')
              .then((createdApi) => {
        ...
        am_createApplication(am_apiToken, am_oneScopeApplicationName, am_domainId)
          ...
          .then((application: Application) => {
            ...
            createOauth2Api(am_domainHrid, application.settings.oauth.clientId, application.settings.oauth.clientSecret, oauthConfig)
              .ok()
              .its('body')
              .then((createdApi) => {
      ...
      requestGateway(
        ...
        },
        {
          validWhen: (response) => {
            ...
            return decodedJwtPayload.scope === 'scim';
          },
        },
      ).then((response: Cypress.Response<any>) => {
