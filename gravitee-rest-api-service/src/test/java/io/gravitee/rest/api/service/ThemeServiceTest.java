...
public class ThemeServiceTest {
    ...
    public void shouldUpdate() throws TechnicalException, JsonProcessingException {
        ...
        verify(auditService, times(1))
            .createPortalAuditLog(eq(ImmutableMap.of(THEME, THEME_ID)), eq(Theme.AuditEvent.THEME_UPDATED), any(Date.class), any(), any());
    }
    ...
    public void shouldResetToDefaultTheme() throws TechnicalException, JsonProcessingException {
        ...
        verify(auditService, times(1))
            .createPortalAuditLog(eq(ImmutableMap.of(THEME, THEME_ID)), eq(Theme.AuditEvent.THEME_RESET), any(Date.class), any(), any());
    }
    ...
    public void shouldMergeThemeDefinitionWithLegacy() throws IOException, TechnicalException {
        ...
        assertEquals(39, mergedDefinition.getData().size());
