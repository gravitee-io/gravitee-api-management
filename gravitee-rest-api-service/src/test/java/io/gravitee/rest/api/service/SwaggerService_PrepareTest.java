...
public class SwaggerService_PrepareTest {
    ...
    public void shouldPrepareAPIFromSwaggerV3WithExamples() throws IOException {
        final NewSwaggerApiEntity api = prepareInline("io/gravitee/rest/api/management/service/mock/api-with-examples.yaml", true);
    ...
    public void shouldPrepareAPIFromSwaggerV3WithSimpleTypedExamples() throws IOException {
        final NewSwaggerApiEntity api = prepareInline("io/gravitee/rest/api/management/service/mock/callback-example.yaml", true);
    ...
    public void shouldPrepareAPIFromSwaggerV3WithLinks() throws IOException {
        final NewSwaggerApiEntity api = prepareInline("io/gravitee/rest/api/management/service/mock/link-example.yaml", true);
        assertEquals("1.0.0", api.getVersion());
    ...
    public void shouldPrepareAPIFromSwaggerV3WithPetstore() throws IOException {
        final NewSwaggerApiEntity api = prepareInline("io/gravitee/rest/api/management/service/mock/petstore.yaml", true);
        assertEquals("1.0.0", api.getVersion());
    ...
    public void shouldPrepareAPIFromSwaggerV3WithPetstoreExpanded() throws IOException {
        final NewSwaggerApiEntity api = prepareInline("io/gravitee/rest/api/management/service/mock/petstore-expanded.yaml", true);
        assertEquals("1.0.0", api.getVersion());
        assertEquals("Swagger Petstore", api.getName());
    ...
    public void shouldPrepareAPIFromSwaggerV3WithExample() throws IOException {
        final NewSwaggerApiEntity api = prepareInline("io/gravitee/rest/api/management/service/mock/uspto.yaml", true);
        assertEquals("1.0.0", api.getVersion());
    ...
    public void shouldPrepareAPIFromSwaggerV3WithEnumExample() throws IOException {
        final NewSwaggerApiEntity api = prepareInline("io/gravitee/rest/api/management/service/mock/enum-example.yml", true);
    ...
    public void shouldPrepareAPIFromSwaggerV3WithMonoServer() throws IOException {
        final NewSwaggerApiEntity api = prepareInline("io/gravitee/rest/api/management/service/mock/openapi-monoserver.yaml", true);
        assertEquals("/v1", api.getContextPath());
        assertEquals(1, api.getEndpoint().size());
    ...
    public void shouldPrepareAPIFromSwaggerV3WithMultiServer() throws IOException {
        final NewSwaggerApiEntity api = prepareInline("io/gravitee/rest/api/management/service/mock/openapi-multiserver.yaml", true);
        assertEquals("/v1", api.getContextPath());
    ...
    public void shouldPrepareAPIFromSwaggerV3WithNoServer() throws IOException {
        final NewSwaggerApiEntity api = prepareInline("io/gravitee/rest/api/management/service/mock/openapi-noserver.yaml", true);
    ...
    public void shouldPrepareAPIFromSwaggerV3WithVariablesInServer() throws IOException {
        final NewSwaggerApiEntity api = prepareInline("io/gravitee/rest/api/management/service/mock/openapi-variables-in-server.yaml", true);
    ...
    public void shouldPrepareAPIFromSwaggerV3WithComplexReferences() throws IOException {
        final NewSwaggerApiEntity api = prepareInline("io/gravitee/rest/api/management/service/mock/json-api.yml", true);
