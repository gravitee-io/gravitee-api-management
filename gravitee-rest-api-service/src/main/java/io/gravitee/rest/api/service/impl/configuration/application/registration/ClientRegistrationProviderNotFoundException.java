...
public class ClientRegistrationProviderNotFoundException extends AbstractNotFoundException {
    ...
    public ClientRegistrationProviderNotFoundException(String id) {
        this.id = id;
    }
    ...
    public String getTechnicalCode() {
        return "clientRegistrationProvider.notFound";
    }

    @Override
    public Map<String, String> getParameters() {
        return singletonMap("clientRegistrationProvider", id);
    }
}
