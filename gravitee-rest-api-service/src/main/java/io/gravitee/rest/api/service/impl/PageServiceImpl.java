...
public class PageServiceImpl extends AbstractService implements PageService, ApplicationContextAware {
    ...
    private static Page merge(UpdatePageEntity updatePageEntity, Page withUpdatePage) {
        ...
        page.setExcludedAccessControls(
            updatePageEntity.isExcludedAccessControls() != null ? updatePageEntity.isExcludedAccessControls() : withUpdatePage.isExcludedAccessControls()
        );
        page.setAccessControls(
            updatePageEntity.getAccessControls() != null ? convertACL(updatePageEntity.getAccessControls()) : withUpdatePage.getAccessControls()
        );

        List<PageMedia> pageMediaList = convertMediaEntity(updatePageEntity.getAttachedMedia());
        page.setAttachedMedia(
            pageMediaList != null ? pageMediaList : withUpdatePage.getAttachedMedia()
        );
        page.setParentId(
        ...
        try {
            ...
            if (updatePageEntity.getExcludedGroups() != null && !updatePageEntity.getExcludedGroups().isEmpty()) {
                ...
                Set<AccessControlEntity> accessControlEntities = updatePageEntity.getAccessControls() != null ?
                    updatePageEntity.getAccessControls() : new HashSet<>();
    ...
    public long execAutoFetch() {
        ...
        try {
            ...
            long nbOfFetchedPages = autoFetchPages.stream()
