...
public class ApiServiceImpl extends AbstractService implements ApiService {
    ...
    public ApiEntity createFromSwagger(final SwaggerApiEntity swaggerApiEntity, final String userId,
        ...
        if (swaggerApiEntity != null && swaggerDescriptor != null) {
            ...
            if (DefinitionVersion.V1.equals(swaggerApiEntity.getGraviteeDefinitionVersion()) || swaggerApiEntity.getGraviteeDefinitionVersion() == null) {
        ...
        try {
            ...
            if (repoApi != null) {
                ...
                if (primaryOwner != null) {
                    ...
                    throw new TechnicalManagementException("Unable to create API " + createdApi.getName() + " because primary owner role has not been found");
                }
            } else {
