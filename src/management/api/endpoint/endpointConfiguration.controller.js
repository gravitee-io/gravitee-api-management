...
var ApiEndpointController = (function () {
    function ApiEndpointController(ApiService, NotificationService, $scope, $rootScope, $state, $stateParams, resolvedApi, resolvedTenants) {
        'ngInject';
    ...
    ApiEndpointController.prototype.update = function (api) {
        var _this = this;
        this.ApiService.update(api).then(function () {
            _this.onApiUpdate();
        });
    };
    ApiEndpointController.prototype.onApiUpdate = function () {
