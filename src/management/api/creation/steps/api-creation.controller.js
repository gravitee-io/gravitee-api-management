...
var ApiCreationController = (function () {
    function ApiCreationController($scope, $timeout, $mdDialog, $stateParams, $window, ApiService, NotificationService) {
        'ngInject';
        this.$scope = $scope;
    ...
    /*
     md-stepper
     */
    ApiCreationController.prototype.initStepSettings = function () {
    ...
    ApiCreationController.prototype.enableNextStep = function () {
    ...
    ApiCreationController.prototype.moveToPreviousStep = function () {
        if (this.vm.selectedStep > 0) {
            this.vm.selectedStep = this.vm.selectedStep - 1;
        }
    };
    ApiCreationController.prototype.selectStep = function (step) {
        this.vm.selectedStep = step;
    };
    ApiCreationController.prototype.submitCurrentStep = function (stepData) {
    ...
    /*
     API creation
     */
    ApiCreationController.prototype.createAPI = function (deployAndStart) {
    ...
    ApiCreationController.prototype._createAPI = function (deployAndStart) {
        var _this = this;
    ...
    /*
     API import
     */
    ApiCreationController.prototype.initImportAPISettings = function () {
        var that = this;
    ...
    ApiCreationController.prototype.importAPI = function () {
    ...
    ApiCreationController.prototype.importGraviteeIODefinition = function () {
        var _this = this;
    ...
    ApiCreationController.prototype.importSwagger = function () {
        var _this = this;
        var swagger;
        if (this.importFileMode) {
            swagger = {
    ...
    ApiCreationController.prototype.enableImport = function () {
        if (this.importFileMode) {
    ...
    ApiCreationController.prototype.isSwaggerDescriptor = function () {
        try {
    ...
    /*
     API context-path
     */
    ApiCreationController.prototype.validFirstStep = function (stepData) {
    ...
    ApiCreationController.prototype.onChangeContextPath = function () {
        this.contextPathInvalid = true;
    };
    /*
     API endpoint
     */
    ApiCreationController.prototype.selectEndpoint = function () {
        this.api.proxy.endpoints = [];
        var endpoint = {
            name: 'default',
    ...
    /*
     API plan
     */
    ApiCreationController.prototype.selectPlan = function () {
        // set validation mode
    ...
    ApiCreationController.prototype.skipAddPlan = function () {
        this.api.plans = [];
        this.plan = {};
        this.skippedStep = true;
    };
    ApiCreationController.prototype.resetRateLimit = function () {
        delete this.rateLimit;
    };
    ApiCreationController.prototype.resetQuota = function () {
        delete this.quota;
    };
    /*
     API documentation
     */
    ApiCreationController.prototype.initDocumentationSettings = function () {
        var that = this;
    ...
    ApiCreationController.prototype.selectDocumentation = function () {
        var stepMessage = "";
        _.forEach(this.api.pages, function (page) {
    ...
    ApiCreationController.prototype.selectFile = function (file) {
    ...
    ApiCreationController.prototype.pageAlreadyExist = function (pageFileName) {
        return _.some(this.api.pages, function (page) {
            return page.fileName === pageFileName;
        });
    };
    ApiCreationController.prototype.hasPage = function () {
        return this.api.pages.length > 0;
    };
    ApiCreationController.prototype.removePage = function (page) {
        var alert = this.$mdDialog.confirm({
            title: 'Warning',
    ...
    ApiCreationController.prototype.skipDocumentation = function () {
        this.api.pages = [];
        this.skippedStep = true;
    };
    ApiCreationController.prototype.steps = function () {
        return [{
                badgeClass: 'disable',
    ...
    return ApiCreationController;
}());
exports.default = ApiCreationController;
