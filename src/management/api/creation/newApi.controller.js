...
var NewApiController = (function () {
    function NewApiController($scope, $timeout, $mdDialog, $stateParams, $window, ApiService, NotificationService) {
        'ngInject';
        this.$scope = $scope;
    ...
    /*
      md-stepper
     */
    NewApiController.prototype.initStepSettings = function () {
    ...
    NewApiController.prototype.enableNextStep = function () {
    ...
    NewApiController.prototype.moveToPreviousStep = function () {
        if (this.vm.selectedStep > 0) {
            this.vm.selectedStep = this.vm.selectedStep - 1;
        }
    };
    NewApiController.prototype.selectStep = function (step) {
        this.vm.selectedStep = step;
    };
    NewApiController.prototype.submitCurrentStep = function (stepData) {
    ...
    /*
      API creation
     */
    NewApiController.prototype.createAPI = function (deployAndStart) {
    ...
    NewApiController.prototype._createAPI = function (deployAndStart) {
        var _this = this;
    ...
    /*
      API import
     */
    NewApiController.prototype.initImportAPISettings = function () {
        var that = this;
    ...
    NewApiController.prototype.importAPI = function () {
    ...
    NewApiController.prototype.importGraviteeIODefinition = function () {
        var _this = this;
    ...
    NewApiController.prototype.importSwagger = function () {
        var _this = this;
        var swagger;
        if (this.importFileMode) {
            swagger = {
    ...
    NewApiController.prototype.enableImport = function () {
        if (this.importFileMode) {
    ...
    NewApiController.prototype.isSwaggerDescriptor = function () {
        try {
    ...
    /*
      API context-path
     */
    NewApiController.prototype.validFirstStep = function (stepData) {
    ...
    NewApiController.prototype.onChangeContextPath = function () {
        this.contextPathInvalid = true;
    };
    /*
      API endpoint
     */
    NewApiController.prototype.selectEndpoint = function () {
        this.api.proxy.endpoints = [];
        var endpoint = {
            name: 'default',
    ...
    /*
      API plan
     */
    NewApiController.prototype.selectPlan = function () {
        // set validation mode
    ...
    NewApiController.prototype.skipAddPlan = function () {
        this.api.plans = [];
        this.plan = {};
        this.skippedStep = true;
    };
    NewApiController.prototype.resetRateLimit = function () {
        delete this.rateLimit;
    };
    NewApiController.prototype.resetQuota = function () {
        delete this.quota;
    };
    /*
      API documentation
     */
    NewApiController.prototype.initDocumentationSettings = function () {
        var that = this;
    ...
    NewApiController.prototype.selectDocumentation = function () {
        var stepMessage = "";
        _.forEach(this.api.pages, function (page) {
    ...
    NewApiController.prototype.selectFile = function (file) {
    ...
    NewApiController.prototype.pageAlreadyExist = function (pageFileName) {
        return _.some(this.api.pages, function (page) {
            return page.fileName === pageFileName;
        });
    };
    NewApiController.prototype.hasPage = function () {
        return this.api.pages.length > 0;
    };
    NewApiController.prototype.removePage = function (page) {
        var alert = this.$mdDialog.confirm({
            title: 'Warning',
    ...
    NewApiController.prototype.skipDocumentation = function () {
        this.api.pages = [];
        this.skippedStep = true;
    };
    NewApiController.prototype.steps = function () {
        return [{
                badgeClass: 'disable',
...
exports.default = NewApiController;
