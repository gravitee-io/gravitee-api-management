...
var InstancesController = (function () {
    function InstancesController($scope) {
        'ngInject';
        this.$scope = $scope;
    }
    InstancesController.prototype.$onInit = function () {
    ...
    InstancesController.prototype.getOSIcon = function (osName) {
        if (osName) {
    ...
    InstancesController.prototype.displayEmptyMode = function () {
