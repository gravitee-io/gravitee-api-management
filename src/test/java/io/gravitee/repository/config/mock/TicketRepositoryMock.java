...
public class TicketRepositoryMock extends AbstractRepositoryMock<TicketRepository> {
    ...
    @Override
    void prepare(TicketRepository ticketRepository) throws Exception {
        ...
        when(ticketRepository.search(
                argThat(o -> o != null && o.getFromUser() == null), nullable(Sortable.class), any())).thenReturn(searchAllResult);

        // shouldSearchAllWithCriteriaFromUserEmpty
        when(ticketRepository.search(
                argThat(o -> o != null
                        && o.getFromUser() != null && o.getFromUser().equals("")),
        ...
        when(ticketRepository.search(
                argThat(o -> o != null
                        && o.getFromUser() != null && o.getFromUser().equals("creationUser")),
                any(),
                any()
