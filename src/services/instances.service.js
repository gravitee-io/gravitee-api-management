...
var InstancesService = (function () {
    function InstancesService($http, Constants) {
        'ngInject';
        this.$http = $http;
        this.instancesURL = Constants.baseURL + "instances/";
    }
    InstancesService.prototype.list = function () {
        return this.$http.get(this.instancesURL + '?includeStopped=true');
    };
    InstancesService.prototype.get = function (id) {
        return this.$http.get(this.instancesURL + id);
    };
    InstancesService.prototype.getMonitoringData = function (id, gatewayId) {
