...
public class ApiServiceImpl implements ApiService {
    ...
    @Override
    public ApiEntity createForUser(NewApiEntity api, String username) {
        return create(api, OwnerType.USER, username);
    }

    @Override
    public ApiEntity createForTeam(NewApiEntity api, String teamName) {
    ...
    private ApiEntity create(NewApiEntity apiCreation, OwnerType ownerType, String owner) {
        Api api = convert(apiCreation);
