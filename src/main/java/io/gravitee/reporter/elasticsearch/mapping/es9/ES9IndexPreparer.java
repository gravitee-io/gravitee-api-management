 ...
 */
package io.gravitee.reporter.elasticsearch.mapping.es9;
...
public class ES9IndexPreparer extends AbstractIndexPreparer {
    ...
    protected Function<Type, CompletableSource> indexTypeMapper() {
        return type -> {
            ...
            final String template = freeMarkerComponent.generateFromTemplate("/es9x/mapping/index-template-" + typeName + ".ftl", data);
