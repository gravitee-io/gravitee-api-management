...
public class AvailabilityResponse implements Response {
    ...
    public List<FieldBucket<Double>> getEndpointAvailabilities() {
        return endpointAvailabilities;
    }

    public void setEndpointAvailabilities(List<FieldBucket<Double>> endpointAvailabilities) {
        this.endpointAvailabilities = endpointAvailabilities;
    }
}
