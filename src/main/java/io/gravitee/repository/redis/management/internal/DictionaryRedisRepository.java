 ...
 */
public interface DictionaryRedisRepository {

    Set<RedisDictionary> findAll();

    RedisDictionary findById(String dictionaryId);

    RedisDictionary saveOrUpdate(RedisDictionary dictionary);
