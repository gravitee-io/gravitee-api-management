...
export function FormDataContentDispositionFromJSON(json) {
    return FormDataContentDispositionFromJSONTyped(json, false);
}
export function FormDataContentDispositionFromJSONTyped(json, ignoreDiscriminator) {
...
export function FormDataContentDispositionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
