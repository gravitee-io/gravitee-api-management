...
export function NewApiMetadataEntityFromJSON(json) {
    return NewApiMetadataEntityFromJSONTyped(json, false);
}
export function NewApiMetadataEntityFromJSONTyped(json, ignoreDiscriminator) {
...
export function NewApiMetadataEntityToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
