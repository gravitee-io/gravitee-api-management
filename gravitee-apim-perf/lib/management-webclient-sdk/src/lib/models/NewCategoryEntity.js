...
export function NewCategoryEntityFromJSON(json) {
    return NewCategoryEntityFromJSONTyped(json, false);
}
export function NewCategoryEntityFromJSONTyped(json, ignoreDiscriminator) {
...
export function NewCategoryEntityToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
