...
export function ContentDispositionFromJSON(json) {
    return ContentDispositionFromJSONTyped(json, false);
}
export function ContentDispositionFromJSONTyped(json, ignoreDiscriminator) {
...
export function ContentDispositionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
