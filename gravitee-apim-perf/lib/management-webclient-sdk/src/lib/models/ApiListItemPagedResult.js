...
export function ApiListItemPagedResultFromJSON(json) {
    return ApiListItemPagedResultFromJSONTyped(json, false);
}
export function ApiListItemPagedResultFromJSONTyped(json, ignoreDiscriminator) {
...
export function ApiListItemPagedResultToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
