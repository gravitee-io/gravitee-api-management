...
export function ConsoleAuthenticationFromJSON(json) {
    return ConsoleAuthenticationFromJSONTyped(json, false);
}
export function ConsoleAuthenticationFromJSONTyped(json, ignoreDiscriminator) {
...
export function ConsoleAuthenticationToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
