...
export function UpdateTagEntityFromJSON(json) {
    return UpdateTagEntityFromJSONTyped(json, false);
}
export function UpdateTagEntityFromJSONTyped(json, ignoreDiscriminator) {
...
export function UpdateTagEntityToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
