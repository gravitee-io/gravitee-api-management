...
export function NewApiQualityRuleEntityFromJSON(json) {
    return NewApiQualityRuleEntityFromJSONTyped(json, false);
}
export function NewApiQualityRuleEntityFromJSONTyped(json, ignoreDiscriminator) {
...
export function NewApiQualityRuleEntityToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
