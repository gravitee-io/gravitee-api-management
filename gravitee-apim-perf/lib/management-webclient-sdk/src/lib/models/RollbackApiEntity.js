...
import { ApiLifecycleStateFromJSON, ApiLifecycleStateToJSON, ApiMetadataEntityFromJSON, ApiMetadataEntityToJSON, FlowFromJSON, FlowToJSON, PlanFromJSON, PlanToJSON, PropertyFromJSON, PropertyToJSON, ProxyFromJSON, ProxyToJSON, ResourceFromJSON, ResourceToJSON, ServicesFromJSON, ServicesToJSON, VisibilityFromJSON, VisibilityToJSON, } from './';
export function RollbackApiEntityFromJSON(json) {
    return RollbackApiEntityFromJSONTyped(json, false);
}
export function RollbackApiEntityFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'plans': (json['plans'].map(PlanFromJSON)),
...
export function RollbackApiEntityToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'plans': (value.plans.map(PlanToJSON)),
...
* @enum {string}
*/
export var RollbackApiEntityFlowModeEnum;
(function (RollbackApiEntityFlowModeEnum) {
    RollbackApiEntityFlowModeEnum["DEFAULT"] = "DEFAULT";
    RollbackApiEntityFlowModeEnum["BESTMATCH"] = "BEST_MATCH";
})(RollbackApiEntityFlowModeEnum || (RollbackApiEntityFlowModeEnum = {}));
