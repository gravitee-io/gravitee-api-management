...
import { AccessControlEntityFromJSON, AccessControlEntityToJSON, PageMediaEntityFromJSON, PageMediaEntityToJSON, PageSourceEntityFromJSON, PageSourceEntityToJSON, VisibilityFromJSON, VisibilityToJSON, } from './';
export function UpdatePageEntityFromJSON(json) {
    return UpdatePageEntityFromJSONTyped(json, false);
}
export function UpdatePageEntityFromJSONTyped(json, ignoreDiscriminator) {
...
export function UpdatePageEntityToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
