...
export function NewMetadataEntityFromJSON(json) {
    return NewMetadataEntityFromJSONTyped(json, false);
}
export function NewMetadataEntityFromJSONTyped(json, ignoreDiscriminator) {
...
export function NewMetadataEntityToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
