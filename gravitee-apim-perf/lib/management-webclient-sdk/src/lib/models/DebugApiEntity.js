...
export function DebugApiEntityToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
* @enum {string}
*/
export var DebugApiEntityExecutionModeEnum;
(function (DebugApiEntityExecutionModeEnum) {
    DebugApiEntityExecutionModeEnum["V3"] = "V3";
    DebugApiEntityExecutionModeEnum["JUPITER"] = "JUPITER";
})(DebugApiEntityExecutionModeEnum || (DebugApiEntityExecutionModeEnum = {}));
/**
* @export
* @enum {string}
*/
export var DebugApiEntityFlowModeEnum;
(function (DebugApiEntityFlowModeEnum) {
    DebugApiEntityFlowModeEnum["DEFAULT"] = "DEFAULT";
    DebugApiEntityFlowModeEnum["BESTMATCH"] = "BEST_MATCH";
})(DebugApiEntityFlowModeEnum || (DebugApiEntityFlowModeEnum = {}));
/**
* @export
* @enum {string}
*/
export var DebugApiEntityStateEnum;
(function (DebugApiEntityStateEnum) {
    DebugApiEntityStateEnum["INITIALIZED"] = "INITIALIZED";
    DebugApiEntityStateEnum["STOPPED"] = "STOPPED";
    DebugApiEntityStateEnum["STOPPING"] = "STOPPING";
    DebugApiEntityStateEnum["STARTED"] = "STARTED";
    DebugApiEntityStateEnum["CLOSED"] = "CLOSED";
})(DebugApiEntityStateEnum || (DebugApiEntityStateEnum = {}));
