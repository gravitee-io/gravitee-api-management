...
- Install http://nodejs.org[nodejs] LTS (v12.18.4), it comes with http://npmjs.org[npm]
...
The build artifacts will be stored in the `dist/` directory. Use the `npm run build:prod` flag for a production build.
