...
%JAVA% %JAVA_OPTS% -javaagent:%GRAVITEE_HOME%/boot/jetty-alpn-agent-2.0.9.jar -cp %GRAVITEE_BOOT_CLASSPATH% -Dgravitee.home=%GRAVITEE_HOME% io.gravitee.gateway.standalone.boostrap.Bootstrap "%*"
