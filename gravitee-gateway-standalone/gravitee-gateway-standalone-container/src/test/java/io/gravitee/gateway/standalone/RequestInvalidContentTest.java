...
@ApiConfiguration(
        ...
        contextPath = "/echo")
public class RequestInvalidContentTest extends AbstractGatewayTest {
    ...
    public void register(PolicyPluginManager policyPluginManager) {
        ...
        PolicyPlugin errorRequestStreamPolicy = PolicyBuilder.build("content-error", ValidateRequestPolicy.class);
