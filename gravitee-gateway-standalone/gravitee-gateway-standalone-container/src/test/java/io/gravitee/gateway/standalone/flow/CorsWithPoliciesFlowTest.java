 ...
 */
@ApiDescriptor("/io/gravitee/gateway/standalone/flow/cors-with-policies-flow.json")
public class CorsWithPoliciesFlowTest extends AbstractWiremockGatewayTest {

    @Test
    public void shouldRunFlows_preflightWithPolicies() throws Exception {
        ...
        wireMockRule.verify(0, optionsRequestedFor(urlEqualTo("/team/my_team")).withHeader("my-counter", equalTo("1")));
    }
