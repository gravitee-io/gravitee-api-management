...
const MOCK_APIS: Api[] = [
    ...
    },
    {
        ...
        type: 'PROXY',
        definitionVersion: 'V4',
        description: 'Create, update, and track customer orders across channels.',
        _public: true,
        running: true,
        entrypoints: ['/orders/v2'],
        owner: { id: 'user-6', displayName: 'Commerce Team' },
        categories: ['Commerce'],
    },
    {
        id: 'api-inventory',
        ...
        type: 'PROXY',
        definitionVersion: 'V4',
        description: 'Check stock levels and reserve items for fulfillment.',
        _public: true,
        running: true,
        entrypoints: ['/inventory/v1'],
        owner: { id: 'user-7', displayName: 'Supply Chain' },
    ...
    },
    {
        ...
        type: 'PROXY',
        definitionVersion: 'V4',
        description: 'Calculate shipping rates and create delivery labels.',
        _public: true,
        running: true,
        entrypoints: ['/shipping/v1'],
        owner: { id: 'user-8', displayName: 'Logistics Team' },
    ...
    },
    {
        ...
        type: 'PROXY',
        definitionVersion: 'V4',
        description: 'Generate invoices and manage subscription billing cycles.',
        _public: true,
        running: true,
        entrypoints: ['/billing/v2'],
        owner: { id: 'user-9', displayName: 'Finance Team' },
    ...
    },
    {
        ...
        type: 'PROXY',
        definitionVersion: 'V4',
        description: 'Open and manage customer support tickets and case history.',
        _public: true,
        running: false,
        entrypoints: ['/support/v1'],
        owner: { id: 'user-10', displayName: 'Customer Success' },
        categories: ['Support'],
    },
];
