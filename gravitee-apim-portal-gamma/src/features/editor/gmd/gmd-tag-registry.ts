...
export const CUSTOM_GMD_BLOCK_TYPES = new Set([
    ...
    'graviteeAiWorkspaceOverview',
    'graviteeAiKey',
    'graviteeAiEndpoint',
    'graviteeAiBudget',
    'graviteeAiModels',
    'graviteeAiSnippets',
    'graviteeAiUsageHistory',
    'graviteeAiDashboard',
    'graviteeAiCredentials',
    'graviteeAiAnalytics',
    'graviteeAiTryIt',
]);
...
export const GMD_TAG_MAPPINGS: Record<string, GmdTagMapping> = {
    ...
    graviteeAiWorkspaceOverview: {
        tagName: 'gmd-ai-workspace-overview',
        blockType: 'graviteeAiWorkspaceOverview',
        selfClosing: true,
        propsToAttrs: props => attrsFromProps(props, ['workspaceId', 'showProviders', 'showStatus']),
        attrsToProps: el => propsFromAttrs(el, ['workspaceId', 'showProviders', 'showStatus']),
    },
    graviteeAiKey: {
        tagName: 'gmd-ai-key',
        blockType: 'graviteeAiKey',
        selfClosing: true,
        propsToAttrs: props => attrsFromProps(props, ['workspaceId', 'label', 'allowRegenerate']),
        attrsToProps: el => propsFromAttrs(el, ['workspaceId', 'label', 'allowRegenerate']),
    },
    graviteeAiEndpoint: {
        tagName: 'gmd-ai-endpoint',
        blockType: 'graviteeAiEndpoint',
        selfClosing: true,
        propsToAttrs: props => attrsFromProps(props, ['workspaceId', 'label', 'urlOverride']),
        attrsToProps: el => propsFromAttrs(el, ['workspaceId', 'label', 'urlOverride']),
    },
    graviteeAiBudget: {
        tagName: 'gmd-ai-budget',
        blockType: 'graviteeAiBudget',
        selfClosing: true,
        propsToAttrs: props => attrsFromProps(props, ['workspaceId', 'variant', 'showBreakdown']),
        attrsToProps: el => propsFromAttrs(el, ['workspaceId', 'variant', 'showBreakdown']),
    },
    graviteeAiModels: {
        tagName: 'gmd-ai-models',
        blockType: 'graviteeAiModels',
        selfClosing: true,
        propsToAttrs: props => attrsFromProps(props, ['workspaceId']),
        attrsToProps: el => propsFromAttrs(el, ['workspaceId']),
    },
    graviteeAiSnippets: {
        tagName: 'gmd-ai-snippets',
        blockType: 'graviteeAiSnippets',
        selfClosing: true,
        propsToAttrs: props => attrsFromProps(props, ['workspaceId', 'languages', 'useRealKey']),
        attrsToProps: el => propsFromAttrs(el, ['workspaceId', 'languages', 'useRealKey']),
    },
    graviteeAiUsageHistory: {
        tagName: 'gmd-ai-usage-history',
        blockType: 'graviteeAiUsageHistory',
        selfClosing: true,
        propsToAttrs: props => attrsFromProps(props, ['workspaceId', 'range']),
        attrsToProps: el => propsFromAttrs(el, ['workspaceId', 'range']),
    },
    graviteeAiDashboard: {
        tagName: 'gmd-ai-dashboard',
        blockType: 'graviteeAiDashboard',
        selfClosing: true,
        propsToAttrs: props => attrsFromProps(props, ['workspaceId']),
        attrsToProps: el => propsFromAttrs(el, ['workspaceId']),
    },
    graviteeAiCredentials: {
        tagName: 'gmd-ai-credentials',
        blockType: 'graviteeAiCredentials',
        selfClosing: true,
        propsToAttrs: props => attrsFromProps(props, ['workspaceId', 'languages', 'useRealKey']),
        attrsToProps: el => propsFromAttrs(el, ['workspaceId', 'languages', 'useRealKey']),
    },
    graviteeAiAnalytics: {
        tagName: 'gmd-ai-analytics',
        blockType: 'graviteeAiAnalytics',
        selfClosing: true,
        propsToAttrs: props => attrsFromProps(props, ['workspaceId', 'range']),
        attrsToProps: el => propsFromAttrs(el, ['workspaceId', 'range']),
    },
    graviteeAiTryIt: {
        tagName: 'gmd-ai-try-it',
        blockType: 'graviteeAiTryIt',
        selfClosing: true,
        propsToAttrs: props => attrsFromProps(props, ['workspaceId']),
        attrsToProps: el => propsFromAttrs(el, ['workspaceId']),
    },
