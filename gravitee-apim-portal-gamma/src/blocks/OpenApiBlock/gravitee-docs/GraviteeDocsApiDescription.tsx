...
interface GraviteeDocsApiDescriptionProps {
    readonly spec: ParsedOpenApiSpec;
}

export function GraviteeDocsApiDescription({ spec }: GraviteeDocsApiDescriptionProps) {
    ...
    return <p className={styles.apiDescription}>{description}</p>;
}
