...
public class EndpointDiscoverySerializer extends ServiceSerializer<EndpointDiscoveryService> {
    ...
    public EndpointDiscoverySerializer(Class<EndpointDiscoveryService> t) {
        super(t);
    }

    @Override
    protected void doSerialize(EndpointDiscoveryService service, JsonGenerator jgen, SerializerProvider serializerProvider) throws IOException {
