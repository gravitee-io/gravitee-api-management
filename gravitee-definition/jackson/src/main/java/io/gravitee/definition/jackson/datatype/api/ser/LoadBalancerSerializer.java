...
public class LoadBalancerSerializer extends StdScalarSerializer<LoadBalancer> {
    ...
    public LoadBalancerSerializer(Class<LoadBalancer> t) {
        super(t);
    }

    @Override
    public void serialize(LoadBalancer loadBalancer, JsonGenerator jgen, SerializerProvider provider) throws IOException {
