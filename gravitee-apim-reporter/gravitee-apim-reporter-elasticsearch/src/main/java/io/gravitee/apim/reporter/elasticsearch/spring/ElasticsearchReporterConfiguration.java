 ...
 */
package io.gravitee.apim.reporter.elasticsearch.spring;

import static io.gravitee.apim.reporter.elasticsearch.config.PipelineConfiguration.DEFAULT_PIPELINE_INGEST_PLUGINS;
