...
@TestPropertySource(
    properties = {
        ...
        // The data-stream type. The policy has to arrive as a property: the field is @Value-annotated,
        // so Spring populates it after the @Bean method has run and overwrites anything set there.
