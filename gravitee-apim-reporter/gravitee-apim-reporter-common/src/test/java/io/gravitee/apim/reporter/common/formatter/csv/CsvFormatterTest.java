    ...
    @CsvSource(
        {
            ...
            "v4 log without api product, v4.log.Log, v4/log-without-api-product.json, csv/v4/log-without-api-product.csv",
            ...
            "v4 metrics without api product, v4.metric.Metrics, v4/metrics-without-api-product.json, csv/v4/metrics-without-api-product.csv",
