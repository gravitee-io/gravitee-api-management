...
import io.gravitee.apim.reporter.common.formatter.csv.v4.DecisionReportFormatter;
...
import io.gravitee.apim.reporter.common.formatter.csv.v4.MetricsFormatter;
import io.gravitee.apim.reporter.common.formatter.csv.v4.OperationEventMetricsFormatter;
import io.gravitee.apim.reporter.common.formatter.csv.v4.TopicEventMetricsFormatter;
...
public class CsvFormatter<T extends Reportable> extends AbstractFormatter<T> {
    ...
    static {
        ...
        FORMATTERS.put(io.gravitee.reporter.api.log.Log.class, new io.gravitee.apim.reporter.common.formatter.csv.LogFormatter());
        FORMATTERS.put(io.gravitee.reporter.api.http.Metrics.class, new io.gravitee.apim.reporter.common.formatter.csv.MetricsFormatter());
        ...
        FORMATTERS.put(DecisionReport.class, new DecisionReportFormatter());
    }
