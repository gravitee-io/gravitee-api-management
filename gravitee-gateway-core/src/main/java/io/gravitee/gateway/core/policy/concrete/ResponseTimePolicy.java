 ...
 */
package io.gravitee.gateway.core.policy.concrete;
...
public class ResponseTimePolicy {
    ...
    public void onResponse(Request request, Response response, PolicyChain handler) {
        ...
        response.headers().put(GraviteeHttpHeader.X_GRAVITEE_RESPONSE_TIME.toString(), String.valueOf(endTime - startTime));
        handler.doNext(request, response);
    }
