  ...
  ({ side = 'left', variant = 'sidebar', collapsible = 'offcanvas', className, children, ...props }, ref) => {
    ...
    return (
      ...
      >
        <div
          className={cn(
            'relative h-[calc(100svh-var(--topnav-height))] w-(--sidebar-width) bg-transparent transition-[width] duration-200 ease-linear',
        ...
        <div
          className={cn(
            'fixed top-[var(--topnav-height)] bottom-0 z-10 hidden h-[calc(100svh-var(--topnav-height))] w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex',
            side === 'left'
