...
/**
 * Script to build gravitee-dashboard library for console-webui
...
console.log('🚀   Building gravitee-dashboard library for console-webui...');
...
console.log('🔨  Building gravitee-dashboard library with console configuration...');
try {
  execSync('yarn build:gravitee-dashboard:console', { stdio: 'inherit' });
} catch (error) {
  console.error('❌  Error during build:', error.message);
  process.exit(1);
}

console.log('✅  gravitee-dashboard library built successfully!');
