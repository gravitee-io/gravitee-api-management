...
import { ApiV4, ApiV2 as ApiV2FromMAPIV2, ApiV1 as ApiV1FromMAPIV2 } from '../entities/management-api-v2';
...
export const isApiV4 = (api: ApiV1V2FromMAPIV1 | ApiV1FromMAPIV2 | ApiV2FromMAPIV2 | ApiV4): api is ApiV4 => {
