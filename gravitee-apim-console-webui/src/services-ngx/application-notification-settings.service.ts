...
export class ApplicationNotificationSettingsService {
  constructor(
  ...
  getAll(apiId: string): Observable<NotificationSettings[]> {
    return this.http.get<NotificationSettings[]>(`${this.constants.env.baseURL}/applications/${apiId}/notificationsettings`);
  }

  getSingleNotificationSetting(apiId: string, selectedId: string): Observable<NotificationSettings> {
    return this.http.get<NotificationSettings[]>(`${this.constants.env.baseURL}/applications/${apiId}/notificationsettings`).pipe(
  ...
  delete(apiId: string, id: string): Observable<NotificationSettings[]> {
    return this.http.delete<NotificationSettings[]>(`${this.constants.env.baseURL}/applications/${apiId}/notificationsettings/${id}`);
  }

  getNotifiers(apiId: string): Observable<Notifier[]> {
    return this.http.get<Notifier[]>(`${this.constants.env.baseURL}/applications/${apiId}/notifiers`);
  }

  create(apiId: string, notificationConfig: NewNotificationSettings): Observable<NewNotificationSettings> {
    return this.http.post<NewNotificationSettings>(
      `${this.constants.env.baseURL}/applications/${apiId}/notificationsettings`,
      notificationConfig,
    );
  }
  ...
  update(apiId: string, notificationId: string, notificationConfig: NotificationSettings): Observable<NotificationSettings> {
    return this.http.put<NotificationSettings>(
      `${this.constants.env.baseURL}/applications/${apiId}/notificationsettings/${notificationId === 'PORTAL' ? '' : notificationId}`,
      notificationConfig,
    );
  }

  getHooks(): Observable<Hooks[]> {
    return this.http.get<Hooks[]>(`${this.constants.env.baseURL}/applications/hooks`);
  }
}
