...
export class GroupService {
  ...
  inviteMember(groupId: string, invitation: Invitation) {
    return this.http.post<any>(`${this.constants.env.baseURL}/configuration/groups/${groupId}/invitations/`, invitation);
  }
  ...
  deleteInvitation(groupId: string, email: string): Observable<void> {
    return this.http.delete<void>(`${this.constants.env.baseURL}/configuration/groups/${groupId}/invitations/${email}`);
  }
