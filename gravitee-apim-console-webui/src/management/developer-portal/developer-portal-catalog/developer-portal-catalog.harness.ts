...
export class DeveloperPortalCatalogHarness extends ComponentHarness {
  static readonly hostSelector = 'developer-portal-catalog';
  ...
  private getTable = this.locatorFor(MatTableHarness.with({ selector: '[aria-label="developer-portal-catalog list"]' }));
}
