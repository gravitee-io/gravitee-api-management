...
@Component({
  selector: 'developer-portal-top-bar',
  templateUrl: './developer-portal-top-bar.component.html',
  styleUrls: ['./developer-portal-top-bar.component.scss'],
  imports: [CommonModule, GioIconsModule, GioLoaderModule, MatButtonModule, MatTableModule, MatTooltipModule],
  standalone: true,
})
export class DeveloperPortalTopBarComponent {
