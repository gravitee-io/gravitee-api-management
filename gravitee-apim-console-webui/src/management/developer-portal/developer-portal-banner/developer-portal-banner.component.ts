...
@Component({
  selector: 'developer-portal-banner',
  templateUrl: './developer-portal-banner.component.html',
  styleUrls: ['./developer-portal-banner.component.scss'],
  imports: [CommonModule, GioSaveBarModule, MatCardModule, MatFormFieldModule, MatInputModule, ReactiveFormsModule],
  standalone: true,
})
export class DeveloperPortalBannerComponent {
