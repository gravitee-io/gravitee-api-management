    ...
    of(true)
      .pipe(
        switchMap((): Observable<number> => {
          ...
          return this.integrationsService.previewIntegration(this.activatedRoute.snapshot.paramMap.get('integrationId'));
        }),
        switchMap((totalCount: number) => {
          ...
          return this.matDialog
            .open<GioConfirmDialogComponent, GioConfirmDialogData>(GioConfirmDialogComponent, {
              ...
              data: {
                title: 'Discover',
                content: `By proceeding, you'll initiate the creation of ${totalCount} new Federated APIs in Gravitee for each API uncovered at the provider. Are you ready to continue?`,
