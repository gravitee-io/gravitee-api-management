...
export interface ImportToolsFromOpenApiDialogHarnessOptions extends BaseHarnessFilters {}

export class ImportToolsFromOpenApiDialogHarness extends ComponentHarness {
  public static readonly hostSelector = `import-tools-from-open-api-dialog`;

  public static with(options: ImportToolsFromOpenApiDialogHarnessOptions): HarnessPredicate<ImportToolsFromOpenApiDialogHarness> {
    return new HarnessPredicate(ImportToolsFromOpenApiDialogHarness, options);
  }
