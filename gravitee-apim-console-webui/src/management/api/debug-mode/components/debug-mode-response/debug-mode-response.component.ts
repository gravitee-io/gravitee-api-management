...
@Component({
  selector: 'debug-mode-response',
  templateUrl: './debug-mode-response.component.html',
  styleUrls: ['./debug-mode-response.component.scss'],
  standalone: false,
})
export class DebugModeResponseComponent implements OnChanges {
  @Input()
