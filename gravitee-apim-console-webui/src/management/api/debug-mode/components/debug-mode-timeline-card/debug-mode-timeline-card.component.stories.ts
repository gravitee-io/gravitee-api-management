...
import { DebugModeTimelineCardComponent, TimelineStep } from './debug-mode-timeline-card.component';
...
export default {
  ...
  component: DebugModeTimelineCardComponent,
  decorators: [
    moduleMetadata({
      declarations: [DebugModeTimelineHoverComponent],
  ...
  render: ({ timelineStep, selected }) => ({
    ...
    template: '<debug-mode-timeline-card [timelineStep]="timelineStep"></debug-mode-timeline-card>',
  }),
} as Meta;
