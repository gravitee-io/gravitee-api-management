...
@Component({
  selector: 'debug-mode-timeline-card',
  templateUrl: './debug-mode-timeline-card.component.html',
  styleUrls: ['./debug-mode-timeline-card.component.scss'],
  standalone: false,
})
export class DebugModeTimelineCardComponent implements OnChanges {
  @Input()
