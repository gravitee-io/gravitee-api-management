...
import { DebugModeTimelineOverviewComponent } from './debug-mode-timeline-overview.component';
...
export default {
  ...
  component: DebugModeTimelineOverviewComponent,
  decorators: [
    moduleMetadata({
  ...
  render: ({ timelineSteps, onStepSelected }) => ({
    ...
    template: `
    <debug-mode-timeline-overview [timelineSteps]="timelineSteps" (selected)="onStepSelected($event)">
