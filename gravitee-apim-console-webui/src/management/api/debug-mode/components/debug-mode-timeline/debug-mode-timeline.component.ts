...
@Component({
  selector: 'debug-mode-timeline',
  templateUrl: './debug-mode-timeline.component.html',
  styleUrls: ['./debug-mode-timeline.component.scss'],
  standalone: false,
})
export class DebugModeTimelineComponent implements AfterViewInit, OnDestroy {
  @Input()
