...
@Component({
  selector: 'debug-mode-inspector-body',
  templateUrl: './debug-mode-inspector-body.component.html',
  styleUrls: ['./debug-mode-inspector-body.component.scss'],
  standalone: false,
})
export class DebugModeInspectorBodyComponent implements OnChanges {
  @Input()
  input: string;
