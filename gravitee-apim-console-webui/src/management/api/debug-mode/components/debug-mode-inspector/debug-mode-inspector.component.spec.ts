...
import { getDiffState, DebugModeInspectorComponent } from './debug-mode-inspector.component';

import { fakeRequestDebugStep } from '../../models/DebugStep.fixture';
import { DebugModeModule } from '../../debug-mode.module';

describe('DebugModeInspectorComponent', () => {
  let fixture: ComponentFixture<DebugModeInspectorComponent>;
  let component: DebugModeInspectorComponent;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DebugModeInspectorComponent);
