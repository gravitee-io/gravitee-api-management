...
@Component({
  selector: 'debug-mode-inspector-table',
  templateUrl: './debug-mode-inspector-table.component.html',
  styleUrls: ['./debug-mode-inspector-table.component.scss'],
  standalone: false,
})
export class DebugModeInspectorTableComponent implements OnChanges {
  @Input()
  name: string;
