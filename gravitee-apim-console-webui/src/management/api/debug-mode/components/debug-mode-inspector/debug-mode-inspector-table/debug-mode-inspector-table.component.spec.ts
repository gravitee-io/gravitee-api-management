...
import { DebugModeInspectorTableComponent } from './debug-mode-inspector-table.component';

import { DebugModeModule } from '../../../debug-mode.module';

describe('DebugModeInspectorTableComponent', () => {
  let fixture: ComponentFixture<DebugModeInspectorTableComponent>;
  let component: DebugModeInspectorTableComponent;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DebugModeInspectorTableComponent);
