...
@Component({
  selector: 'debug-mode-inspector',
  templateUrl: './debug-mode-inspector.component.html',
  styleUrls: ['./debug-mode-inspector.component.scss'],
  standalone: false,
})
export class DebugModeInspectorComponent implements OnChanges {
  @Input()
