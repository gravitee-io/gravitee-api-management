...
describe('convertDebugEventToDebugResponse', () => {
  ...
  it('should convert request and response debug step', () => {
    ...
    expect(debugResponse.requestDebugSteps).toStrictEqual(expectedRequestDebugSteps);
    expect(debugResponse.responseDebugSteps).toStrictEqual(expectedResponseDebugSteps);
  });
  ...
  it('should convert debug steps with only request policies', () => {
    ...
    expect(debugResponse.requestDebugSteps).toStrictEqual(expectedRequestDebugSteps);
    expect(debugResponse.responseDebugSteps).toStrictEqual([]);
  });
  ...
  it('should convert debug steps with only response policies', () => {
    ...
    expect(debugResponse.requestDebugSteps).toStrictEqual([]);
    expect(debugResponse.responseDebugSteps).toStrictEqual([
      {
        ...expectedResponseDebugSteps[0],
        policyOutput: {
          ...expectedResponseDebugSteps[0].policyOutput,
          attributes: {
            'gravitee.attribute.context-path': '/09770e92ee2112001ade3747-echo/',
          },
        },
      },
      {
        ...
        policyOutput: {
          ...expectedResponseDebugSteps[1].policyOutput,
          attributes: {
            'gravitee.attribute.context-path': '/09770e92ee2112001ade3747-echo/',
          },
        },
