...
@Component({
  selector: 'policy-studio-debug-response-try-it',
  template: require('./policy-studio-debug-response-try-it.component.html'),
  styles: [require('./policy-studio-debug-response-try-it.component.scss')],
})
export class PolicyStudioDebugResponseTryItComponent implements OnChanges {
  @Input()
