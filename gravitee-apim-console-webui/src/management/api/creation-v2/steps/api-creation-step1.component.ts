  ...
  controller: [
    ...
    class {
      ...
      onSelectOpen = () => {
        ...
        setTimeout(() => {
          // Find the scroll container (check your DOM for the correct class)
          const selectMenuContainer = document.querySelector('.md-select-menu-container.md-active.md-clickable');

          if (selectMenuContainer) {
            this.scrollContainer = selectMenuContainer.querySelector('md-content[aria-label="Groups"]');
