...
import { Api, DefinitionVersion } from '../../../../entities/management-api-v2';
...
export class ApiGeneralInfoPromoteDialogComponent {
  ...
  private readonly apiDefinitionVersion: DefinitionVersion;
  ...
  constructor() {
    ...
    this.apiDefinitionVersion = this.dialogData.api.definitionVersion;
  ...
  onPromote() {
    ...
    this.promotionService
      .promote(this.apiId, this.apiDefinitionVersion, promotionTarget)
      .pipe(
        tap(() => {
