...
import { ApiRuntimeLogsMessagesModule } from './runtime-logs-details/runtime-logs-messages';

@NgModule({
  imports: [CommonModule, ApiRuntimeLogsModule, ApiRuntimeLogsSettingsModule, ApiRuntimeLogsMessagesModule],
})
