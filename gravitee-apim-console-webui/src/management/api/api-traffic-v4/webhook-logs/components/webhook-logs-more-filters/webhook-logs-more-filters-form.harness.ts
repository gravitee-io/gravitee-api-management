...
export class WebhookLogsMoreFiltersFormHarness extends ComponentHarness {
  static hostSelector = 'webhook-logs-more-filters-form';
  ...
  public getCallbackUrlsSelect = this.locatorFor(MatSelectHarness.with({ selector: '[formControlName="callbackUrls"]' }));
}
