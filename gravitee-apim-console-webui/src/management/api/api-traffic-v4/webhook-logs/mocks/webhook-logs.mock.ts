  ...
  data: [
    {
      ...
      status: 500,
      application: { id: '8ff0178d-9326-465c-b017-8d9326a65cb7', name: 'Acme Monitoring', type: 'SIMPLE', apiKeyMode: 'UNSPECIFIED' },
    ...
    },
    {
      ...
      method: 'POST' as HttpMethod,
      status: 200,
      application: { id: '8ff0178d-9326-465c-b017-8d9326a65cb7', name: 'Acme Webhook Client', type: 'SIMPLE', apiKeyMode: 'UNSPECIFIED' },
      plan: { id: 'plan-1', name: 'Webhook Plan', mode: 'PUSH' },
      requestEnded: true,
...

    {
      ...
      method: 'POST' as HttpMethod,
      status: 0,
      application: { id: '8ff0178d-9326-465c-b017-8d9326a65cb7', name: 'Acme Loyalty', type: 'SIMPLE', apiKeyMode: 'UNSPECIFIED' },
...
export const WEBHOOK_SAMPLE_LOG: WebhookLog = { ...WEBHOOK_LOGS_MOCK_RESPONSE.data[0] }; // First active log (req-5-from-benoit)
