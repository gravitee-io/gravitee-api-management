...
export interface WebhookAdditionalMetrics {
  'string_webhook_request-method': string;
  string_webhook_url: string;
  'keyword_webhook_application-id': string;
  'keyword_webhook_subscription-id': string;
  'int_webhook_retry-count': number;
  'string_webhook_retry-timeline': string;
  'string_webhook_last-error'?: string | null;
  'long_webhook_request-timestamp': number;
  'string_webhook_request-headers'?: string | null;
  'string_webhook_request-body'?: string | null;
  'long_webhook_response-time'?: number;
  'int_webhook_response-status': number;
  'int_webhook_response-payload-size'?: number;
  'string_webhook_response-headers'?: string | null;
  'string_webhook_response-body'?: string | null;
  'boolean_webhook_dl-queue': boolean;
}
