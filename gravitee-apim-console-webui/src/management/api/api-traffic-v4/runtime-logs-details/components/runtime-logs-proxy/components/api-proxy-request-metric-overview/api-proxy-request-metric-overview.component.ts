...
@Component({
  ...
  templateUrl: './api-proxy-request-metric-overview.component.html',
  styleUrls: ['./api-proxy-request-metric-overview.component.scss'],
  imports: [DatePipe, MatCard, MatCardContent, MatExpansionPanel, MatExpansionPanelHeader, MatExpansionPanelTitle],
})
