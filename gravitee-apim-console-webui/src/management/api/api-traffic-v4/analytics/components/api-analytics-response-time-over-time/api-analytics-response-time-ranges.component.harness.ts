...
export class ApiAnalyticsResponseTimeRangesHarness extends ComponentHarness {
  ...
  static with(options: ApiAnalyticsResponseStatusRangesHarnessFilters = {}): HarnessPredicate<ApiAnalyticsResponseTimeRangesHarness> {
    return new HarnessPredicate(ApiAnalyticsResponseTimeRangesHarness, options).addOption('title', options.title, (harness, title) =>
