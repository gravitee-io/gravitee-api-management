...
import { GioLicenseService, GioSaveBarHarness } from '@gravitee/ui-particles-angular';
...
describe('PolicyStudioResourcesComponent', () => {
  ...
  it('should open dialog calling on display-resource-cta event', async () => {
    ...
    expect(openDialog).toHaveBeenCalledWith({
      feature: 'apim-en-schema-registry-provider',
      utm: { campaign: 'oss_apim_to_ee_apim', medium: 'resource_confluent_schema_registry', source: 'oss_apim' },
    });
  });
