...
} from './api-subscription-edit-push-config-dialog.component';

@Component({
  selector: 'story-component',
  template: `<button id="open-dialog" (click)="open()">Open dialog</button>`,
  imports: [ApiSubscriptionEditPushConfigDialogComponent, MatDialogModule, MatIconTestingModule],
  standalone: true,
})
class StoryDialogComponent {
  constructor(private readonly matDialog: MatDialog) {}

  public open(data?: ApiSubscriptionEditPushConfigDialogData) {
...
export default {
  title: 'ApiSubscriptionEditPushConfigDialogComponent story',
