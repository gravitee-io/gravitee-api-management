 ...
 */
export const isWindowedCountValidFormat = (): ValidatorFn | null => {
  return (control: AbstractControl): ValidationErrors | null => {
    ...
    try {
      let windowedCount = WindowedCount.parse(formControlValue);
      return { invalidFormat: !windowedCount.isValid() };
    } catch (error) {
