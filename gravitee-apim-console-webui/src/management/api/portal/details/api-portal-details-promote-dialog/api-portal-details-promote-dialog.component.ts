...
@Component({
  selector: 'api-portal-details-promote-dialog',
  template: require('./api-portal-details-promote-dialog.component.html'),
  styles: [require('./api-portal-details-promote-dialog.component.scss')],
})
export class ApiPortalDetailsPromoteDialogComponent implements OnDestroy {
