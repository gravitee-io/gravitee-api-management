...
@Component({
  selector: 'api-portal-details-quality',
  template: require('./api-portal-details-quality.component.html'),
  styles: [require('./api-portal-details-quality.component.scss')],
})
export class ApiPortalDetailsQualityComponent implements OnChanges, OnDestroy {
