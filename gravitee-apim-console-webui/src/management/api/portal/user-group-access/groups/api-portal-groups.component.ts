...
@Component({
  selector: 'api-portal-access-groups',
  template: require('./api-portal-groups.component.html'),
  styles: [require('./api-portal-groups.component.scss')],
})
export class ApiPortalGroupsComponent implements OnInit, OnDestroy {
