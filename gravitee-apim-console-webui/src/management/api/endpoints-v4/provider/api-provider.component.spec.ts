...
import { ApiProviderComponent } from './api-provider.component';
import { ApiProviderModule } from './api-provider.module';
import { ApiProviderHarness } from './api-provider.harness';
...
describe('ApiProviderComponent', () => {
  const API_ID = 'api-id';
  let fixture: ComponentFixture<ApiProviderComponent>;
  let componentHarness: ApiProviderHarness;
  ...
  const initComponent = async (
    ...
    await TestBed.configureTestingModule({
      imports: [NoopAnimationsModule, GioTestingModule, MatIconTestingModule, ApiProviderModule, RouterTestingModule],
      providers: [
        {
    ...
    fixture = TestBed.createComponent(ApiProviderComponent);
    httpTestingController = TestBed.inject(HttpTestingController);
    componentHarness = await TestbedHarnessEnvironment.harnessForFixture(fixture, ApiProviderHarness);
