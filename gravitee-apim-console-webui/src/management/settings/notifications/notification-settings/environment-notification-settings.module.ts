...
@NgModule({
  ...
  exports: [EnvironmentNotificationSettingsDetailsComponent, EnvironmentNotificationSettingsListComponent],
  imports: [NotificationSettingsListModule],
})
export class EnvironmentNotificationSettingsModule {}
