  ...
  newField() {
    this.$mdDialog
      .show({
        ...
        controllerAs: '$ctrl',
        template: require('html-loader!./dialog/save.custom-user-field.dialog.html').default, // eslint-disable-line @typescript-eslint/no-var-requires
        locals: {
  ...
  deleteField(field) {
    this.$mdDialog
      .show({
        ...
        controllerAs: '$ctrl',
        template: require('html-loader!./dialog/delete.custom-user-field.dialog.html').default, // eslint-disable-line @typescript-eslint/no-var-requires
        locals: {
          field: field,
        },
      })
