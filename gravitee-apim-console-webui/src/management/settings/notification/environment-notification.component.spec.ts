...
describe('AppNotificationComponent', () => {
  const ENVIRONMENT_ID = 'an-env-id';
  ...
  function initComponent(permissions = ['environment-notification-c', 'environment-notification-d', 'environment-notification-u']) {
  ...
  describe('Add new notification', () => {
    it('should add new notification', async () => {
      ...
      const req = httpTestingController.expectOne({
        method: 'POST',
        url: `${CONSTANTS_TESTING.env.baseURL}/configuration/notificationsettings`,
      });
  ...
  describe('Delete a notification', () => {
    it('should delete notification', async () => {
      ...
      httpTestingController.expectOne({
        method: 'DELETE',
        url: `${CONSTANTS_TESTING.env.baseURL}/configuration/notificationsettings/${EMAIL_NOTIFICATION_ID}`,
      });
    });
  ...
  describe('Edit a notification', () => {
    ...
    describe('using Webhook Notifier', () => {
      ...
      it('should edit the notification', async () => {
        ...
        const req = httpTestingController.expectOne({
          method: 'PUT',
          url: `${CONSTANTS_TESTING.env.baseURL}/configuration/notificationsettings/${WEBHOOK_NOTIFICATION_ID}`,
        });
        expect(req.request.body).toEqual({
    ...
    it.each([
      ...
      httpTestingController
        .expectOne({
          method: 'PUT',
          url: `${CONSTANTS_TESTING.env.baseURL}/configuration/notificationsettings/${id}`,
        })
        .flush([]);
  ...
  function expectHooksRequest(
    ...
    const req = httpTestingController.expectOne(`${CONSTANTS_TESTING.env.baseURL}/configuration/hooks`);
  ...
  function expectNotificationSettingsRequest(response = [PORTAL_NOTIFICATION, EMAIL_NOTIFICATION, WEBHOOK_NOTIFICATION]) {
    const req = httpTestingController.expectOne(`${CONSTANTS_TESTING.env.baseURL}/configuration/notificationsettings`);
    if (!req.cancelled) req.flush(response);
  }

  function expectNotifiersRequest() {
    const req = httpTestingController.expectOne(`${CONSTANTS_TESTING.env.baseURL}/configuration/notifiers`);
    req.flush([
