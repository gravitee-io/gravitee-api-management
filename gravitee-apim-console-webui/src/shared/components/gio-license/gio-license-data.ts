...
export enum ApimFeature {
  ...
  APIM_API_PRODUCTS_DEPLOY = 'apim-api-products-deploy',
...
export const getFeatureInfoData = (ctaConfig: CTAConfiguration): Record<ApimFeature, FeatureInfo> => {
  ...
  return {
    ...
    [ApimFeature.APIM_API_PRODUCTS_DEPLOY]: {
      title,
      image: 'assets/gio-ee-unlock-dialog/api-products.svg',
      description: `API Products deployment is part of ${ee}. Creating and deploying API Products requires a Universe license.`,
      trialButtonLabel,
      hideDays,
    },
