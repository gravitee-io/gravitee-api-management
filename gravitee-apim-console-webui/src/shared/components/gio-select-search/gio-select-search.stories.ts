...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: `
A multi-select dropdown component with search functionality that uses a custom overlay instead of mat-select.

## Features
- Multi-selection with checkboxes on the left
- Search/filter options with debounced input
