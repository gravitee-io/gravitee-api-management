...
export class CategoryListHarness extends ComponentHarness {
  ...
  private bothPortalBadgeLocator = this.locatorFor('[data-testid="both-portal-badge"]');

  async getBothPortalBadge(): Promise<TestElement> {
    return await this.bothPortalBadgeLocator();
  }
