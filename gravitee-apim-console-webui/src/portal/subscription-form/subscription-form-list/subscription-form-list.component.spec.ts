...
describe('SubscriptionFormListComponent', () => {
  ...
  it('should offer to delete every form but the default one', async () => {
    await init([defaultForm, partnerForm]);
    ...
    expect(fixture.debugElement.query(By.css('[data-testid=delete-form-button-form-default]'))).toBeFalsy();
  ...
  it('should not offer to delete without the delete permission', async () => {
    await init([defaultForm, partnerForm], true, null, false);
