...
<style>
  ...
  .form-demo {
    ...
    --gmd-input-field-border-color: #94a3b8;
    --gmd-input-field-border-radius: 8px;

    --gmd-textarea-label-text-color: #0f172a;
    --gmd-textarea-field-text-color: #0f172a;
    --gmd-textarea-field-border-color: #94a3b8;
    --gmd-textarea-field-border-radius: 8px;

    --gmd-select-label-text-color: #0f172a;
    --gmd-select-field-text-color: #0f172a;
    --gmd-select-field-border-color: #94a3b8;
    --gmd-select-field-border-radius: 8px;
