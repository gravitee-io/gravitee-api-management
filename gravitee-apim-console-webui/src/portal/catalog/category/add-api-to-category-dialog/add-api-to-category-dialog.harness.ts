...
export class AddApiToCategoryDialogHarness extends ComponentHarness {
  public static readonly hostSelector = 'add-api-to-category-dialog';
  ...
  private cancelButtonLocator: AsyncFactoryFn<MatButtonHarness> = this.locatorFor(
  ...
  public async fillFormAndSubmit(value: string): Promise<void> {
    ...
    await inputAutocomplete.selectOption({ text: value });
