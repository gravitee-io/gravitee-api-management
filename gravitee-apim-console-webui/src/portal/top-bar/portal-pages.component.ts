...
import { SectionsTreeComponent } from '../sections/sections-tree.component';
...
@Component({
  ...
  imports: [PortalHeaderComponent, GraviteeMarkdownEditorModule, ReactiveFormsModule, SectionsTreeComponent, TreeComponent],
})
