...
export const COMPARE_CONTROLS_NAMES = ['operator', 'multiplier', 'property'] as const;
export const STRING_CONTROLS_NAMES = ['operator', 'reference'] as const;
export const OPTIONAL_CONTROLS_NAMES = [...THRESHOLD_CONTROLS_NAMES, ...COMPARE_CONTROLS_NAMES, ...STRING_CONTROLS_NAMES] as const;
