...
### Using gravitee-markdown library in console-webui

The library is used as a dependency in the console-webui application. After building, you can import and use the components:
...
The library components are available for use in the console application's templates and can be imported from the built library package.
