...
class ApisResourceTest extends AbstractResourceTest {
    ...
    @Test
    void shouldReturnSharedPolicyGroupState() {
        var state = put("shared-policy-group.json");
        SoftAssertions.assertSoftly(soft -> {
            ...
            soft.assertThat(state.getHrid()).isEqualTo("api-foo");
        });
    }
    ...
    private ApiV4State put(String spec) {
        return put(spec, false);
    }

    private ApiV4State put(String spec, boolean dryRun) {
