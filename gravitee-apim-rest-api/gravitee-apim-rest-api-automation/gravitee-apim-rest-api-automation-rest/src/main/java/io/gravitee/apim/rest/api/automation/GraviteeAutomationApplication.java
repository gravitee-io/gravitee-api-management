...
import io.gravitee.apim.rest.api.automation.resource.SubscriptionFormResource;
import io.gravitee.apim.rest.api.automation.resource.SubscriptionFormsResource;
...
public class GraviteeAutomationApplication extends ResourceConfig {
    ...
    public GraviteeAutomationApplication() {
        ...
        register(SubscriptionFormsResource.class);
        register(SubscriptionFormResource.class);
