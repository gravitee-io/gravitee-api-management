...
public interface ApiMapper {
    ...
    default Map<String, PlanCRD> mapApiV4SpecPlans(ApiV4Spec apiV4Spec) {
        ...
        return apiV4Spec
            .getPlans()
            .stream()
            .filter(planV4 -> planV4.getHrid() != null)
            .collect(Collectors.toMap(PlanV4::getHrid, this::map));
    }
    ...
    default Map<String, PageCRD> mapApiV4SpecPages(ApiV4Spec apiV4Spec) {
        ...
        return apiV4Spec
            .getPages()
            .stream()
            .filter(pageV4 -> pageV4.getHrid() != null)
            .collect(Collectors.toMap(PageV4::getHrid, this::map));
    }
