...
public class SubscriptionResource extends AbstractResource {
    ...
    public Response getSubscriptionByHRID() {
        ...
        try {
            ...
            SubscriptionEntity subscriptionEntity = subscriptionCrudService.get(toId(executionContext, hrid));
            subscriptionState.setId(subscriptionEntity.getId());

            Api api = apiCrudService.get(IdBuilder.builder(executionContext, subscriptionEntity.getApiId()).buildId());
            ...
            subscriptionState.setEndingAt(subscriptionEntity.getEndingAt().toOffsetDateTime());
    ...
    public Response deleteSubscriptionByHrid() {
        ...
        try {
            subscriptionCrudService.delete(toId(executionContext, hrid));
