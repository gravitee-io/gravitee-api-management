...
public class SubscriptionsResource extends AbstractResource {
    ...
    public Response createOrUpdate(@Valid @NotNull SubscriptionSpec spec) {
        ...
        SubscriptionCRDSpec subscriptionCRDSpec = new SubscriptionCRDSpec(
            toId(auditInfo, spec.getHrid()),
            toId(auditInfo, spec.getApplicationHrid()),
            toId(auditInfo, spec.getApiHrid()),
            toId(auditInfo, spec.getPlanHrid()),
            spec.getEndingAt().toZonedDateTime()
        );
