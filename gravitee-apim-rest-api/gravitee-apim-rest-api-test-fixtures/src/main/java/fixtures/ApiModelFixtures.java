...
public class ApiModelFixtures {
    ...
    private static final ApiEntity.ApiEntityBuilder BASE_MODEL_API_HTTP_V4 = ApiEntity.builder()
        .id("my-id")
        .crossId("my-cross-id")
        .name("my-name")
        .apiVersion("v1.0")
    ...
    private static final NativeApiEntity.NativeApiEntityBuilder BASE_MODEL_API_NATIVE_V4 = NativeApiEntity.builder()
        .id("my-id")
        .crossId("my-cross-id")
        .name("my-name")
        .apiVersion("v1.0")
        ...
        .description("my-description")
        .tags(Set.of("tag1", "tag2"))
        .listeners(List.of(ListenerModelFixtures.aModelKafkaListener()))
        .endpointGroups(List.of(EndpointModelFixtures.aModelEndpointGroupNativeV4()))
        .properties(List.of(PropertyModelFixtures.aModelPropertyV4()))
        .resources(List.of(ResourceModelFixtures.aResourceEntityV4()))
        .flows(List.of(FlowModelFixtures.aModelFlowNativeV4()))
        .services(new io.gravitee.definition.model.v4.nativeapi.NativeApiServices())
        .groups(Set.of("my-group1", "my-group2"))
        .visibility(io.gravitee.rest.api.model.Visibility.PUBLIC)
        .state(Lifecycle.State.STARTED)
        .primaryOwner(PrimaryOwnerModelFixtures.aPrimaryOwnerEntity())
    ...
    public static NativeApiEntity aModelNativeApiV4() {
        return BASE_MODEL_API_NATIVE_V4.build();
    }
