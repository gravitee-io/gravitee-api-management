...
public enum RolePermission {
    ...
    ENVIRONMENT_AUTHZ_ENTITIES(RoleScope.ENVIRONMENT, EnvironmentPermission.AUTHZ_ENTITIES),
    ...
    ENVIRONMENT_SUBSCRIPTION_FORM(RoleScope.ENVIRONMENT, EnvironmentPermission.SUBSCRIPTION_FORM),
    ENVIRONMENT_AUTHZ_SCIM_CONNECTION(RoleScope.ENVIRONMENT, EnvironmentPermission.AUTHZ_SCIM_CONNECTION),
    ENVIRONMENT_AUTHZ_SCIM_SYNC(RoleScope.ENVIRONMENT, EnvironmentPermission.AUTHZ_SCIM_SYNC),
