...
/**
 * DTO for updating a client certificate.
 */
@Schema(name = "UpdateClientCertificate", description = "DTO for updating a client certificate")
public record UpdateClientCertificate(
