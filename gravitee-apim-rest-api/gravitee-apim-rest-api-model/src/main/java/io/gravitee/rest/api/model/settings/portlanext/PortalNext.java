 ...
 */
package io.gravitee.rest.api.model.settings.portlanext;
...
public class PortalNext {
    ...
    @ParameterKey(Key.PORTAL_HOMEPAGE_BANNER_TITLE)
    private String homepageBannerTitle;

    @ParameterKey(Key.PORTAL_HOMEPAGE_SUBTITLE)
