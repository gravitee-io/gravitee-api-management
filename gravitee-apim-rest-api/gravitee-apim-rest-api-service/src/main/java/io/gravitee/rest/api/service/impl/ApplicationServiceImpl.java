...
public class ApplicationServiceImpl extends AbstractService implements ApplicationService {
    ...
    private Set<ApplicationEntity> convert(ExecutionContext executionContext, Collection<Application> applications)
        ...
        final List<String> appIds = applications
            .stream()
            .filter(app -> !ApplicationStatus.ARCHIVED.equals(app.getStatus()))
