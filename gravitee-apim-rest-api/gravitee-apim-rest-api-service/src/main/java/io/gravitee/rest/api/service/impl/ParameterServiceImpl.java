...
public class ParameterServiceImpl extends TransactionalService implements ParameterService {
    ...
    public <T> List<T> findAll(
        ...
        try {
            ...
            throw new TechnicalManagementException(String.format("An error occurs while trying to find parameter values with key: %s", key), ex);
        }
    }
    ...
    public <T> Map<String, List<T>> findAll(
        ...
        try {
            ...
            throw new TechnicalManagementException(String.format("An error occurs while trying to find parameter values with keys: %s", keys), ex);
        }
    }
    ...
    public Parameter save(
        ...
        try {
            ...
            throw new TechnicalManagementException(String.format("An error occurs while trying to create parameter for key/value: %s/%s", key, value), ex);
        }
    }
    ...
    public Parameter save(
        ...
        log.debug("Saving parameter for key: {}, List of values: {}, referenceId: {}, referenceType: {}", key, values, referenceId, referenceType);
        return save(
            executionContext,
            key,
    ...
    public Parameter save(
        ...
        log.debug("Saving parameter for key: {}, Map of values: {}, referenceId: {}, referenceType: {}", key, values, referenceId, referenceType);
        return save(
            executionContext,
            key,
            values == null
