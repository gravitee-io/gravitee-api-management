...
public class ApiStateServiceImpl implements ApiStateService {
    ...
    public boolean startV2DynamicProperties(String apiId) {
        try {
            ...
            throw new TechnicalManagementException("An error occurs while trying to start V2 Dynamic properties for API " + apiId, ex);
        }
    }
    ...
    public boolean startV4DynamicProperties(String apiId) {
        try {
            ...
            throw new TechnicalManagementException("An error occurs while trying to start V4 Dynamic properties for API " + apiId, ex);
        }
    }
