...
public interface ApplicationService {
    ...
    Set<ApplicationListItem> findByIds(final ExecutionContext executionContext, List<String> applicationIds);

    Set<ApplicationListItem> findByUser(final ExecutionContext executionContext, String username);
