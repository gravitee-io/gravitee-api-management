...
public interface RoleService {
    ...
    void delete(ExecutionContext executionContext, String roleId, String organizationId);
    ...
    RoleEntity update(ExecutionContext executionContext, UpdateRoleEntity role, String organizationId);
