 ...
 */
public class DictionaryPropertyValueRequiredException extends AbstractValidationException {

    private final String propertyKey;

    public DictionaryPropertyValueRequiredException(String propertyKey) {
    ...
    public String getTechnicalCode() {
        return "dictionary.property.valueRequired";
    }
