...
public interface FilteringService {
    FilteredEntities<String> getApisOrderByNumberOfSubscriptions(Set<String> ids, boolean excluded);

    FilteredEntities<String> getApplicationsOrderByNumberOfSubscriptions(Set<String> ids);

    FilteredEntities<String> filterApis(final Set<String> apis, final FilterType filterType, final FilterType excludedFilterType);

    FilteredEntities<String> filterApis(
        final String userId,
