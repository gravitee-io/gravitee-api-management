...
/**
 * Converts an OpenAPI descriptor into a Gravitee V2 API definition with flows.
 *
...
public class OAIToAPIV2Converter implements SwaggerToApiConverter<OAIDescriptor>, OAIDescriptorVisitor<SwaggerApiEntity> {
    ...
    private final ImportSwaggerDescriptorEntity swaggerDescriptor;
    ...
    private Collection<? extends OAIOperationVisitor> getVisitors() {
        if (visitors == null) {
    ...
    private void fill(SwaggerApiEntity apiEntity, OpenAPI oai) {
                            ...
                            getVisitors().forEach(
                                (Consumer<OAIOperationVisitor>) oaiOperationVisitor -> {
                                    ...
                                    if (policy.isPresent()) {
                                        ...
                                        String policyId = policy.get().getName();
