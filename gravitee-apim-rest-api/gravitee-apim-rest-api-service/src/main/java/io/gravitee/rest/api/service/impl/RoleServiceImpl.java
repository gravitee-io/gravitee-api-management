...
public class RoleServiceImpl extends AbstractService implements RoleService {
    ...
    @Override
    public RoleEntity update(ExecutionContext executionContext, final UpdateRoleEntity roleEntity, final String organizationId) {
    ...
    @Override
    public void delete(ExecutionContext executionContext, final String roleId, final String organizationId) {
        try {
            ...
            List<RoleEntity> defaultRoleByScopes = findDefaultRoleByScopes(organizationId, scope);
