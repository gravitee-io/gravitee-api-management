 ...
 */
public class IdentityProviderAlreadyExistsException extends AbstractManagementException {

    private final String identityProviderName;

    public IdentityProviderAlreadyExistsException(String identityProviderName) {
