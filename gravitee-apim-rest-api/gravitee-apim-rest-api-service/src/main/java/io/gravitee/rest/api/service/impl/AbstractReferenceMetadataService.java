...
public abstract class AbstractReferenceMetadataService extends AbstractService {
    ...
    protected void delete(
        ...
        try {
            ...
            throw new TechnicalManagementException(String.format("An error occurs while trying to delete metadata %s", metadataId), ex);
        }
    }
    ...
    protected ReferenceMetadataEntity create(
        ...
        try {
            ...
            throw new TechnicalManagementException(String.format("An error occurred while trying to create metadata %s on reference %s" , metadataEntity.getName(), referenceId ), ex);
        }
    }
    ...
    protected ReferenceMetadataEntity update(
        ...
        try {
            ...
            throw new TechnicalManagementException( String.format( "An error occurred while trying to update metadata %s on REFERENCE %s", metadataEntity.getName(), referenceId), ex);
        }
    }
