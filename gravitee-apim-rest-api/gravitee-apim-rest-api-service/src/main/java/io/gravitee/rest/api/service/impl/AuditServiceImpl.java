...
public class AuditServiceImpl extends AbstractService implements AuditService {
    ...
    private Map<String, String> getMetadata(ExecutionContext executionContext, List<AuditEntity> content) {
        ...
        for (AuditEntity auditEntity : content) {
            ...
            } else if (auditEntity.getReferenceId() != null && Audit.AuditReferenceType.APPLICATION.name().equals(auditEntity.getReferenceType().name())) {
            ...
            } else if (auditEntity.getReferenceId() != null && Audit.AuditReferenceType.API.name().equals(auditEntity.getReferenceType().name())) {
