...
public class AuditServiceImpl extends AbstractService implements AuditService {
    ...
    public void createAuditLog(
        ...
        try {
            ...
            LOGGER.error("Error occurs during the creation of an Audit Log id={}, with organization id {} and environment id {} for user {}.",audit.getId(), audit.getOrganizationId(),audit.getEnvironmentId(), audit.getUser(), e);
        }
    }
