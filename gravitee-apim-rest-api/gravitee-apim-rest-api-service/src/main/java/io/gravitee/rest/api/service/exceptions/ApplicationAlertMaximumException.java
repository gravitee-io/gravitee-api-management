 ...
 */
public class ApplicationAlertMaximumException extends AbstractManagementException {
    ...
    public String getMessage() {
        return "The application [" + application + "] has reached the maximum of " + maximum + " alerts.";
    }
