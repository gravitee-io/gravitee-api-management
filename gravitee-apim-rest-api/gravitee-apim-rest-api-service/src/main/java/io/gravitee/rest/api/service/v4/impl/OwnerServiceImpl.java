...
import io.gravitee.rest.api.service.v4.OwnerService;
...
@Component
@Slf4j
public class OwnerServiceImpl extends TransactionalService implements OwnerService {

    private final UserService userService;
    private final MembershipService membershipService;
    private final GroupService groupService;

    public OwnerServiceImpl(final UserService userService, final MembershipService membershipService, final GroupService groupService) {
