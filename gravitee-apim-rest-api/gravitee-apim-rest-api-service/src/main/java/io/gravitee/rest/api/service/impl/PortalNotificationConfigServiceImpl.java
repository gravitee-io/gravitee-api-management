...
public class PortalNotificationConfigServiceImpl extends AbstractService implements PortalNotificationConfigService {
    ...
    public PortalNotificationConfigEntity findById(String user, NotificationReferenceType referenceType, String referenceId) {
        try {
            ...
            return getDefaultEmpty(user, referenceType, referenceId, GraviteeContext.getExecutionContext().getOrganizationId());
        } catch (TechnicalException te) {
    ...
    private PortalNotificationConfigEntity getDefaultEmpty(
        String user,
        ...
        portalNotificationConfigEntity.setOrganizationId(organizationId);
