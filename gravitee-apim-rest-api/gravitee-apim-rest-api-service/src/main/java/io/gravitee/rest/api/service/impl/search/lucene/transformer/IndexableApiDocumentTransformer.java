...
import static io.gravitee.rest.api.service.impl.search.lucene.transformer.ApiDocumentTransformer.FIELD_DEFINITION_VERSION_SORTED;
...
public class IndexableApiDocumentTransformer implements DocumentTransformer<IndexableApi> {
    ...
    public Document transform(IndexableApi indexableApi) {
        ...
        if (api.getDefinitionVersion() != null) {
            ...
            doc.add(new SortedDocValuesField(FIELD_DEFINITION_VERSION_SORTED, toSortedValue(api.getDefinitionVersion().getLabel())));
        }
