...
/**
 * Adds a form to the environment catalog. The new form starts disabled and is not the environment
 * default: it only reaches consumers once enabled and mapped to APIs, or promoted to default.
 *
...
public class CreateSubscriptionFormUseCase {
    ...
    public record Input(String environmentId, String name, String gmdContent) {}
