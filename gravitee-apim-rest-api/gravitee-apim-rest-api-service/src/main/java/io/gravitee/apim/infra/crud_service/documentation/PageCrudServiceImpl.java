...
public class PageCrudServiceImpl implements PageCrudService {
    ...
    public Page updateDocumentationPage(Page pageToUpdate) {
        try {
            ...
            throw new TechnicalDomainException(String.format("An error occurred while updating homepage attribute from id %s: %s", pageToUpdate.getId(), pageToUpdate), e);
        }
    }
    ...
    public void unsetHomepage(Collection<String> ids) {
        try {
            ...
            throw new ApiPageInvalidReferenceTypeException(ids.iterator().next(), String.format("An error occurred while unsetting homepage for Page ids %s", ids, e.getMessage()));
        }
    }
    ...
    private io.gravitee.repository.management.model.Page createDocumentation(io.gravitee.repository.management.model.Page page) {
        try {
            ...
            throw new TechnicalDomainException(String.format("An error occurred while creating Page with id %s: %s", page.getId(), page), e);
        }
    }
}
