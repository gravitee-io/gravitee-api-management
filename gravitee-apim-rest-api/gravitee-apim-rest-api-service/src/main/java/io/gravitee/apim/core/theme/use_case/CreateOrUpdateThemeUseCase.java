...
public class CreateOrUpdateThemeUseCase {
    ...
    public Output execute(ValidateThemeDomainService.Input input) {
        ...
        var themeId = HRIDToUUID.theme().context(sanitized.auditInfo()).hrid(sanitized.themeHrid()).id();
        ...
        currentThemeDomainService.disablePreviousEnabledTheme(saved);
