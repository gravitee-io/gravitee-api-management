...
public class FlowCrudServiceImpl extends TransactionalService implements FlowCrudService {
    ...
    @Override
    public java.util.Map<String, java.util.List<NativeFlow>> getNativePlanFlows(java.util.Collection<String> planIds) {
    ...
    @Override
    public java.util.Map<String, java.util.List<io.gravitee.definition.model.flow.Flow>> getPlanV2Flows(
        java.util.Collection<String> planIds
    ) {
        if (planIds == null || planIds.isEmpty()) {
            return java.util.Map.of();
        }
