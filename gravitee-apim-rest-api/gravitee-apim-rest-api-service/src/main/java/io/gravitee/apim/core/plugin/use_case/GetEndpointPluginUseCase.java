...
public class GetEndpointPluginUseCase {

    private final EndpointPluginQueryService endpointPluginQueryService;

    public GetEndpointPluginUseCase(EndpointPluginQueryService endpointPluginQueryService) {
        this.endpointPluginQueryService = endpointPluginQueryService;
    }

    public Output getEndpointPluginsByOrganization(Input input) {
        return new Output(this.endpointPluginQueryService.findByOrganization(input.organizationId));
    }
