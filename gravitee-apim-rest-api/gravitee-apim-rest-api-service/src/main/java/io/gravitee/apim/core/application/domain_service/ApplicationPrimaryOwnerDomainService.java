...
public interface ApplicationPrimaryOwnerDomainService {
    PrimaryOwnerEntity getApplicationPrimaryOwner(ExecutionContext executionContext, String applicationId)
