...
public class ValidateApiCRDUseCase {

    private final ValidateApiCRDDomainService validator;

    public ImportApiCRDUseCase.Output execute(ImportApiCRDUseCase.Input input) {
        ...
        return new ImportApiCRDUseCase.Output(statusBuilder.build());
    }
}
