...
public class CloseSubscriptionUsecase {
    ...
    public CloseSubscriptionUsecase(CloseSubscriptionDomainService closeSubscriptionDomainService) {
    ...
    public record Input(String subscriptionId, AuditInfo auditInfo) {}
