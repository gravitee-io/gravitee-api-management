...
public class SubscriptionFormQueryServiceImpl implements SubscriptionFormQueryService {
    ...
    public Optional<SubscriptionForm> findByApiId(String environmentId, String apiId) {
        try {
            return subscriptionFormRepository.findByEnvironmentIdAndApiId(environmentId, apiId).map(subscriptionFormAdapter::toEntity);
        } catch (TechnicalException e) {
            throw new TechnicalDomainException(
                String.format(
    ...
    public Optional<SubscriptionForm> findDefaultForEnvironmentId(String environmentId) {
        try {
            return subscriptionFormRepository.findDefaultByEnvironmentId(environmentId).map(subscriptionFormAdapter::toEntity);
        } catch (TechnicalException e) {
            throw new TechnicalDomainException(
