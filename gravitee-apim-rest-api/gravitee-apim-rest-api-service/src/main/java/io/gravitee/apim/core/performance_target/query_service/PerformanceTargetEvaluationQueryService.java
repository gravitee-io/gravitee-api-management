 ...
 */
package io.gravitee.apim.core.performance_target.query_service;
...
public interface PerformanceTargetEvaluationQueryService {
    /**
     * @return the latest evaluation of every target of the reference
     */
    List<PerformanceTargetEvaluation> findLatestByReference(String environmentId, String reference);

    List<PerformanceTargetEvaluation> findLatestByReferences(String environmentId, Collection<String> references);
