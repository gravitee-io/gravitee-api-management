...
public class CreateAgentApiUseCase {
    ...
    public record Input(NewAgentApi newAgentApi, AuditInfo auditInfo) {
        public Input {
            if (newAgentApi == null || newAgentApi.getType() != ApiType.AGENT) {
                throw new ApiInvalidTypeException(java.util.List.of(ApiType.AGENT));
            }
        }
    }
    ...
    public Output execute(Input input) {
        ...
        Api newApi = ApiModelFactory.fromNewAgentApi(input.newAgentApi, auditInfo.environmentId());
