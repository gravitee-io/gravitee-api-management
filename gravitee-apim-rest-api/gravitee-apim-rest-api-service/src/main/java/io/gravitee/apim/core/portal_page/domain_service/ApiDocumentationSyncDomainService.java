...
public class ApiDocumentationSyncDomainService {
    ...
    /**
     * Cleans up the API's own subtree — its folder subtree and its documentation pages, wherever they are
     * rooted — enumerated by reference rather than by iterating nav-api rows: the subtree belongs to the
     * API, not to any listing. Nav-api rows are owned by their {@code PortalListing}, so none are touched here.
     */
    public void cleanupForApi(AuditInfo auditInfo, String apiId) {
        ...
        navigationItemsQueryService
            ...
            .forEach(page -> navigationItemCrudService.delete(page.getId()));
    }
