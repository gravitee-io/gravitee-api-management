...
@Component
@CustomLog
class AggregatedMessageLogCrudServiceImpl implements AggregatedMessageLogCrudService {

    private final LogRepository logRepository;

    public AggregatedMessageLogCrudServiceImpl(@Lazy LogRepository logRepository) {
        this.logRepository = logRepository;
    }

    @Override
    public SearchLogsResponse<AggregatedMessageLog> searchApiAggregatedMessageLog(
