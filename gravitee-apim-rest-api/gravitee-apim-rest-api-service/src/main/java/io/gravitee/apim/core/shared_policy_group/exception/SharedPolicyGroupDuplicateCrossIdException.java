 ...
 */
public class SharedPolicyGroupDuplicateCrossIdException extends AbstractNotFoundException {
    ...
    public Map<String, String> getParameters() {
        return Map.of("sharedPolicyGroupId", sharedPolicyGroupId, "environmentId", environmentId);
    }
}
