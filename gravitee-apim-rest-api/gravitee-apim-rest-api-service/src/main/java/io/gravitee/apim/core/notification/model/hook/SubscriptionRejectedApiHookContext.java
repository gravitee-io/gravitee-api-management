...
public class SubscriptionRejectedApiHookContext extends ApiHookContext {

    String applicationId;
    String planId;

    public SubscriptionRejectedApiHookContext(String apiId, String applicationId, String planId) {
