...
import io.gravitee.definition.model.cluster.ClusterDefinition;
...
public abstract class ClusterAdapter {
    ...
    public abstract ClusterDb toRepository(Cluster cluster);
    ...
    public abstract Cluster fromRepository(ClusterDb cluster);

    @Named("mapConfiguration")
    public Object mapConfiguration(ClusterDb cluster) throws JsonProcessingException {
        ClusterDefinition clusterDefinition = mapper.readValue(cluster.getDefinition(), ClusterDefinition.class);
