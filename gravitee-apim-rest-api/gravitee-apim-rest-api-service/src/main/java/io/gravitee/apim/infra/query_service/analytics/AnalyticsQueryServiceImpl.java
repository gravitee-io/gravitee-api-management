...
import io.gravitee.apim.infra.adapter.ApiAnalyticAdapter;
...
public class AnalyticsQueryServiceImpl implements AnalyticsQueryService {
    ...
    @Override
    public Optional<ApiAnalytic> searchApiMetric(ExecutionContext executionContext, String apiId, String requestId) {
        return analyticsRepository
            .searchApiMetric(executionContext.getQueryContext(), new ApiAnalyticQuery(apiId, requestId))
            .map(ApiAnalyticAdapter.INSTANCE::map);
    }
