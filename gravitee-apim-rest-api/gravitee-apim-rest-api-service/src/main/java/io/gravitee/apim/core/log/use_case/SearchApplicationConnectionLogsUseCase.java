...
public class SearchApplicationConnectionLogsUseCase {
    ...
    public Output execute(ExecutionContext executionContext, Input input) {
        ...
        var response = connectionLogsCrudService.searchApplicationConnectionLogs(executionContext, input.logsFilters(), pageable);
    ...
    private Output mapToResponse(SearchLogsResponse<BaseConnectionLog> logs) {
        ...
        var metadata = connectionLogMetadataDomainService.getApplicationMetadata(data);
    ...
    private Api getApiInfo(String apiId) {
        final Api unknownApi = Api.builder().id(apiId).name(UNKNOWN).build();
        try {
            return apiId != null ? apiCrudService.get(apiId) : unknownApi;
    ...
    private Plan getPlanInfo(String planId) {
        final Plan unknownPlan = Plan.builder().id(planId).name(UNKNOWN).build();
        try {
