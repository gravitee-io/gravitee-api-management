...
public class ParentRule implements CreatePortalNavigationItemValidationRule, UpdatePortalNavigationItemValidationRule {
    ...
    public void validate(CreatePortalNavigationItem item, String environmentId, CreateValidationContext ctx) {
        validateParent(
            ...
            environmentId,
            item.getPublished(),
            resolveVisibility(item.getVisibility())
        );
    }
    ...
    private PortalVisibility resolveVisibility(String visibility) {
        return visibility == null ? PortalVisibility.PUBLIC : PortalVisibility.valueOf(visibility);
    }
}
