 ...
 * and V4 KeyStore (io.gravitee.plugin.configurations.ssl) objects.
 */
@UtilityClass
public final class KeyStoreMigration {

    public static @Nullable KeyStore convert(io.gravitee.definition.model.ssl.@Nullable KeyStore v2KeyStore) {
