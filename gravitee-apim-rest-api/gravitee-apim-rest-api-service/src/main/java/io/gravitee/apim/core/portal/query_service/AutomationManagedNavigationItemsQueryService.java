...
public class AutomationManagedNavigationItemsQueryService {
    ...
    /**
     * Unlike {@link #automationManagedApiDocPages}, this needs no {@code PortalNavigationApi} row: a
     * link's automation ownership lives on the nav item, so it is queryable by reference alone.
     */
