...
@UseCase
public class GetApiSpecUseCase {

    private final AnalyticsDefinitionQueryService definitionDomainService;

    public GetApiSpecUseCase(AnalyticsDefinitionQueryService definitionDomainService) {
