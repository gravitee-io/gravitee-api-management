...
public class ApiProductPrimaryOwnerDomainService {
    ...
    // Returns the PrimaryOwnerEntity for the given API Product, or throws if not found
                ...
                membershipQueryService
                    ...
                    .map(membership ->
                        PrimaryOwnerEntity.builder()
                            ...
                            .displayName(membership.getMemberId()) // You may want to fetch display name from user/group service
