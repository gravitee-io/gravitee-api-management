...
public class SearchAnalyticsCountUseCase {
    ...
    public Output execute(ExecutionContext executionContext, Input input) {
        ...
        var count = analyticsQueryService.searchCount(executionContext, input.apiId(), input.from().orElse(null), input.to().orElse(null));
        return new Output(new AnalyticsCountResponse(count));
    }
    ...
    public record Output(AnalyticsCountResponse response) {}
}
