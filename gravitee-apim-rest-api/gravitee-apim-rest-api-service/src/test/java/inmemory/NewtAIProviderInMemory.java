...
public class NewtAIProviderInMemory implements NewtAIProvider, InMemoryAlternative<NewtAIProviderInMemory.Tuple> {
    ...
    public static sealed interface Tuple {
        String inputMessage();

        public static record Success(String inputMessage, ELGenReply reply) implements NewtAIProviderInMemory.Tuple {}

        public static record Fail(String inputMessage, Throwable reply) implements NewtAIProviderInMemory.Tuple {}
    }
}
