...
public class SubscriptionFormFixtures {
    ...
    public static SubscriptionForm aSubscriptionForm() {
        return aSubscriptionFormBuilder().build();
    }

    /**
     * Subscription form without id nor page content (for create flow where both are generated by CrudService).
     */
    public static SubscriptionForm aSubscriptionFormWithNullId() {
        return aSubscriptionFormBuilder().id(null).portalPageContentId(null).build();
    }

    public static SubscriptionForm anEnabledSubscriptionForm() {
        return aSubscriptionFormBuilder().enabled(true).build();
    }
