...
class NewHttpApiTest {
    ...
    @Test
    void should_set_allowInApiProduct_true_for_v4_proxy_http_api() {
    ...
    @Test
    void should_not_set_allowInApiProduct_for_non_proxy_http_api_types() {
        // MCP proxy
        ...
        assertThat(mcpDefinition.getAllowInApiProduct()).isNull();
        ...
        assertThat(llmDefinition.getAllowInApiProduct()).isNull();
    }

    @Test
    void should_not_set_allowInApiProduct_when_definition_version_is_not_v4() {
