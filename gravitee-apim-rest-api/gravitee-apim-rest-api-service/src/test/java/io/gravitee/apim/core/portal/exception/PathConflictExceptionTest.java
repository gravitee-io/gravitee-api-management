...
class PathConflictExceptionTest {
    ...
    @Test
    void listingEntry_builds_an_exception_referencing_the_location() {
        var exception = PathConflictException.listingEntry("/projects/alpha");

        assertThat(exception.getMessage()).contains("/projects/alpha");
    }

    @Test
    void linkEntry_builds_an_exception_referencing_the_location() {
        var exception = PathConflictException.linkEntry("/projects/alpha");
