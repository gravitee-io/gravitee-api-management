...
class GetEntrypointPluginUseCaseTest {
    ...
    private final GetEntrypointPluginUseCase getEntrypointPluginUseCase = new GetEntrypointPluginUseCase(
    ...
    @Test
    void should_return() {
        var res = getEntrypointPluginUseCase.getEntrypointPluginsByOrganization(new GetEntrypointPluginUseCase.Input("org-id"));
