...
class CreateOrUpdatePortalLinkUseCaseTest {
    ...
    private final ValidatePortalLinkDomainService validator = new ValidatePortalLinkDomainService(scopeEnforcer);
    ...
    @Test
    void should_throw_validation_error_when_href_is_invalid() {
        var throwable = catchThrowable(() -> useCase.execute(input("External Docs", "not-a-url", "/projects/alpha", 3)));
    ...
    void should_throw_validation_error_when_name_is_blank() {
        var throwable = catchThrowable(() -> useCase.execute(input("  ", "https://docs.example.com", "/projects/alpha", 3)));
    ...
    void should_throw_validation_error_when_location_is_malformed() {
        var throwable = catchThrowable(() -> useCase.execute(input("External Docs", "https://docs.example.com", "projects/alpha", 3)));
