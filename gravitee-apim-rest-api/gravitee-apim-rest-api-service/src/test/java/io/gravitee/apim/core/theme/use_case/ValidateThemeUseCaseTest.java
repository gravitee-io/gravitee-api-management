...
class ValidateThemeUseCaseTest {
    ...
    private ValidateThemeUseCase useCase;

    @BeforeEach
    void setUp() {
        useCase = new ValidateThemeUseCase(new ValidateThemeDomainService(new ThemeCrudServiceInMemory()));
    }
