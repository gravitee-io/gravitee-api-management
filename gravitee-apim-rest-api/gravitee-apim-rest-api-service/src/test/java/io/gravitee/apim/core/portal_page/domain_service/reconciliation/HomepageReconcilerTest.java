...
class HomepageReconcilerTest {
    ...
    void keeps_the_active_homepage_untouched() {
        ...
        navItemCrud.create(homepage(ACTIVE_ID, PortalId.of(PORTAL_ID), contentId));
    ...
    void drops_stale_homepage_of_same_portal_and_its_content() {
        ...
        navItemCrud.create(homepage(STALE_ID, PortalId.of(PORTAL_ID), staleContentId));
    ...
    void does_not_touch_homepage_of_a_different_portal() {
        ...
        navItemCrud.create(homepage(OTHER_PORTAL_ID, PortalId.of(OTHER_PORTAL_UUID), otherContentId));
    ...
    void drops_non_page_homepage_without_touching_page_contents() {
        var folder = PortalNavigationFolder.builder()
            ...
            .reference(PortalId.of(PORTAL_ID))
            .title("Stale Folder")
