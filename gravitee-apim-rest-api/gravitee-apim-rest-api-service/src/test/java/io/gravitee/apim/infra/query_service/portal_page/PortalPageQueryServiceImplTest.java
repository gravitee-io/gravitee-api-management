...
class PortalPageQueryServiceImplTest {
    ...
    void should_propagate_expanded_createdAt_and_updatedAt_fields_to_core_response() throws Exception {
        ...
        var ctx = PortalPageContext
            ...
            .published(true)
            .build();
        when(contextRepository.findAllByContextTypeAndEnvironmentId(eq(PortalPageContextType.HOMEPAGE), eq(environmentId)))
        ...
        var result = service.findByEnvironmentIdAndContext(
            environmentId,
            PortalViewContext.HOMEPAGE,
            List.of(ExpandsViewContext.UPDATED_AT, ExpandsViewContext.CREATED_AT)
        );
