...
import io.gravitee.apim.core.apim.service_provider.ApimMetadata;
...
class GenerateELUseCaseTest {
    ...
    private final Metadata apimMetadata = new Metadata();
    ...
    @Data
    private static class Metadata implements ApimMetadata {
