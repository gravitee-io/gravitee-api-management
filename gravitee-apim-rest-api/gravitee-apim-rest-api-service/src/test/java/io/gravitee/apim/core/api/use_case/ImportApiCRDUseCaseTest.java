...
class ImportApiCRDUseCaseTest {
    ...
    class Create {
        ...
        void should_create_notification() {
            ...
            verify(notificationCRDService, atMostOnce()).savePortalNotifications(API_ID, notification, ACTOR_USER_ID);
        }
    ...
    class Update {
        ...
        void should_save_notification() {
            ...
            verify(notificationCRDService, times(1)).savePortalNotifications(API_ID, notification, ACTOR_USER_ID);
        }
    }
