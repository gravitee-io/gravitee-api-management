...
class PortalPageContextCrudServiceImplTest {
    ...
    void should_create_portal_page_context_successfully() throws TechnicalException {
        ...
        var toCreate = new io.gravitee.apim.core.portal_page.model.PortalPageView(PortalViewContext.HOMEPAGE, true);
        // No exception thrown by repository create
        service.create(PageId.of(id), toCreate, "env-1");
    ...
    void should_throw_domain_exception_when_create_fails() throws TechnicalException {
        ...
        var toCreate = new io.gravitee.apim.core.portal_page.model.PortalPageView(PortalViewContext.HOMEPAGE, false);
        ...
        assertThrows(TechnicalDomainException.class, () -> service.create(PageId.of(id), toCreate, "env-1"));
    }
}
