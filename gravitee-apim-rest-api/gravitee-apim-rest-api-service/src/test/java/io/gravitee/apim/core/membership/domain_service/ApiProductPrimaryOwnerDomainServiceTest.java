    ...
    class GetApiProductPrimaryOwner {
        ...
        public void should_return_a_user_primary_owner_of_an_api_product() {
            ...
            Assertions.assertThat(result).isEqualTo(
                PrimaryOwnerEntity.builder().id(MEMBER_ID).displayName(MEMBER_ID).type(PrimaryOwnerEntity.Type.USER).build()
            );
        }
        ...
        public void should_return_a_group_primary_owner_of_an_api_product() {
            ...
            Assertions.assertThat(result).isEqualTo(
                PrimaryOwnerEntity.builder().id(GROUP_ID).displayName(GROUP_ID).type(PrimaryOwnerEntity.Type.GROUP).build()
            );
        }
        ...
        public void should_throw_exception_when_no_primary_owner_found() {
            ...
            assertThat(throwable).isInstanceOf(RuntimeException.class).hasMessageContaining("Primary owner not found for API Product");
        }
    }
