...
class PromotionQueryServiceImplTest {
    ...
    class Search {
        ...
        void should_throw_when_technical_exception_occurs() {
            ...
            // When
            Throwable throwable = catchThrowable(() -> service.search(PromotionQuery.builder().apiId(API_ID).build()));
        ...
        void should_return_empty_when_no_report() {
            ...
            var result = service.search(PromotionQuery.builder().apiId(API_ID).build());
        ...
        void should_find_promotion_by_target_api() {
            var query = PromotionQuery.builder().apiId(API_ID).build();
        ...
        void should_find_promotion_by_target_statuses() {
            var query = PromotionQuery.builder().statuses(Set.of(PromotionStatus.ACCEPTED, PromotionStatus.REJECTED)).build();
        ...
        void should_find_promotion_by_target_cockpit_ids() {
            var query = PromotionQuery.builder().targetEnvCockpitIds(Set.of(COCKPIT_ID)).build();
        ...
        void should_find_promotion_by_target_api_exists() {
            var query = PromotionQuery.builder().apiId(API_ID).targetApiExists(true).build();
