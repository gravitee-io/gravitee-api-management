...
import io.gravitee.apim.core.promotion.domain_service.ValidatePromotionDomainService;
...
class ValidatePromotionDomainServiceTest {
    ...
    private final ValidatePromotionDomainService service = new ValidatePromotionDomainService(
    ...
    void should_find_promotion_with_api() {
        ...
        var result = service.validate(promotion.getId());
    ...
    void should_throw_exception_definition_version_not_exist() {
        ...
        Throwable throwable = catchThrowable(() -> service.validate(promotion.getId()));
