...
import io.gravitee.apim.core.shared_policy_group.use_case.DeploySharedPolicyGroupUseCase.Input;
...
class DeploySharedPolicyGroupUseCaseTest {
    ...
    private DeploySharedPolicyGroupUseCase cut;
        ...
        assertThat(auditCrudService.storage())
            ...
            .containsExactly(
                AuditEntity
                    ...
                    .event(SharedPolicyGroupAuditEvent.SHARED_POLICY_GROUP_DEPLOYED.name())
