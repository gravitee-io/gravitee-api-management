...
import io.gravitee.apim.infra.domain_service.api.RollbackApiDomainServiceImpl;
...
class RollbackApiUseCaseTest {
    ...
    void setUp() {
        ...
        RollbackApiDomainService rollbackApiDomainService = new RollbackApiDomainServiceImpl(
            auditDomainService,
            eventCrudService,
            planQueryService,
        ...
        useCase = new RollbackApiUseCase(rollbackApiDomainService);
    ...
    void tearDown() {
        Stream
            .of(auditCrudService, eventCrudService, planCrudService, planQueryService, userCrudService)
    ...
    void should_not_rollback_api_when_event_is_not_publish() {
        ...
        eventCrudService.initWith(List.of(event));
