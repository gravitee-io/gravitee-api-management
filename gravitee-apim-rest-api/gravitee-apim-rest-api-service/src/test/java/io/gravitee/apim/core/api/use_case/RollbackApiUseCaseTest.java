...
class RollbackApiUseCaseTest {
    ...
    @AfterEach
    void tearDown() {
        Stream.of(auditCrudService, eventCrudService, eventQueryService, planCrudService, planQueryService, userCrudService).forEach(
    ...
    void should_rollback_api() throws JsonProcessingException {
        ...
        verify(delegateApiService).update(
            ...
            argThat(updateApiEntity -> {
                ...
                assertThat(updateApiEntity.getListeners().get(0).getEntrypoints().get(0)).isEqualTo(
