...
class SubscriptionFormSpecDomainServiceTest {
    ...
    void should_accept_a_valid_spec_and_return_what_to_persist() {
        ...
        var validation = service.validate(aSpec("Partners", true, List.of("api-1")));
    ...
    void should_report_a_name_used_by_another_form() {
        ...
        var validation = service.validate(aSpec("partners", true, null));
    ...
    void should_reject_a_blank_hrid_before_anything_else() {
        var validation = service.validate(new SubscriptionFormSpecDomainService.Spec(AUDIT_INFO, " ", "Partners", GMD, true, null));
