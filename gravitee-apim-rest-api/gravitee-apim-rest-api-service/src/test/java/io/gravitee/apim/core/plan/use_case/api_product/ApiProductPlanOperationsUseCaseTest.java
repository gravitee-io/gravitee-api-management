...
class ApiProductPlanOperationsUseCaseTest {
    ...
    @Mock
    private PlanOperationsDomainService planOperationsDomainService;
    ...
    class CloseOperation {
        ...
        void should_close_plan_and_return_updated_plan() {
            ...
            when(apiProductPlanSearchQueryService.findByPlanIdIdForApiProduct(eq(PLAN_ID), eq(API_PRODUCT_ID))).thenReturn(plan);
            when(planOperationsDomainService.closePlanForApiProduct(eq(GraviteeContext.getExecutionContext()), eq(PLAN_ID))).thenReturn(
                closedPlan
            );
            ...
            verify(planOperationsDomainService).closePlanForApiProduct(eq(GraviteeContext.getExecutionContext()), eq(PLAN_ID));
        }
    }
    ...
    class PublishOperation {
        ...
        void should_publish_plan_and_return_updated_plan() {
            ...
            when(apiProductPlanSearchQueryService.findByPlanIdIdForApiProduct(eq(PLAN_ID), eq(API_PRODUCT_ID))).thenReturn(plan);
            when(planOperationsDomainService.publish(eq(GraviteeContext.getExecutionContext()), eq(PLAN_ID))).thenReturn(publishedPlan);
            ...
            verify(planOperationsDomainService).publish(eq(GraviteeContext.getExecutionContext()), eq(PLAN_ID));
        }
    }
    ...
    class DeprecateOperation {
        ...
        void should_deprecate_plan_and_return_updated_plan() {
            ...
            when(apiProductPlanSearchQueryService.findByPlanIdIdForApiProduct(eq(PLAN_ID), eq(API_PRODUCT_ID))).thenReturn(plan);
            when(planOperationsDomainService.deprecate(eq(GraviteeContext.getExecutionContext()), eq(PLAN_ID))).thenReturn(deprecatedPlan);
            ...
            verify(planOperationsDomainService).deprecate(eq(GraviteeContext.getExecutionContext()), eq(PLAN_ID));
        }
    }
