...
class GraviteeDefinitionAdapterTest {
    ...
    @Test
    void mapV4_should_propagate_allowInApiProduct_from_definition() {
        ...
        v4Definition.setAllowInApiProduct(true);
        ...
        // Then
        assertThat(descriptor.allowInApiProduct()).isTrue();
    }

    @Test
    void mapV4_should_leave_allowInApiProduct_null_when_missing_in_definition() {
        var v4Definition = new io.gravitee.definition.model.v4.Api();
        v4Definition.setDefinitionVersion(DefinitionVersion.V4);
        v4Definition.setType(ApiType.PROXY);
        v4Definition.setApiVersion("1.0.0");
        v4Definition.setName("my-api");
        // no allowInApiProduct set
        ...
        assertThat(descriptor.allowInApiProduct()).isNull();
    }
}
