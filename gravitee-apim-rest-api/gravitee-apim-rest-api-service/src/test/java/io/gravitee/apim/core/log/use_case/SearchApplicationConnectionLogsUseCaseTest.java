...
class SearchApplicationConnectionLogsUseCaseTest {
    ...
    @BeforeEach
    void setUp() {
        cut = new SearchApplicationConnectionLogsUseCase(logStorageService, applicationStorageService, planStorageService, apiCrudServiceInMemory, new ConnectionLogMetadataDomainService());
    ...
    void should_return_connection_logs_of_an_api() {
        ...
        var result = cut.execute(
            ...
            new SearchApplicationConnectionLogsUseCase.Input(
                    APPLICATION_ID, SearchLogsFilters.builder().from(FIRST_FEBRUARY_2020).to(SECOND_FEBRUARY_2020).build(), Optional.empty())
        );
    ...
    void should_return_api_connection_logs_sorted_by_desc_timestamp() {
        ...
        var result = cut.execute(
            GraviteeContext.getExecutionContext(),
                new SearchApplicationConnectionLogsUseCase.Input(
                        API_ID, SearchLogsFilters.builder().from(FIRST_FEBRUARY_2020).to(FIFTH_FEBRUARY_2020).build())
        );
    ...
    void should_return_api_connection_logs_with_only_plan_id_if_plan_cannot_be_found() {
        ...
        var result = cut.execute(
            GraviteeContext.getExecutionContext(),
                new SearchApplicationConnectionLogsUseCase.Input(
                        API_ID, SearchLogsFilters.builder().from(FIRST_FEBRUARY_2020).to(SECOND_FEBRUARY_2020).build())
        );
        assertThat(result.data())
            .extracting(ConnectionLog::getPlan)
    ...
    void should_return_api_connection_logs_with_only_application_id_if_application_cannot_be_found() {
        ...
        var result = cut.execute(
            GraviteeContext.getExecutionContext(),
                new SearchApplicationConnectionLogsUseCase.Input(
                        APPLICATION_ID, SearchLogsFilters.builder().from(FIRST_FEBRUARY_2020).to(SECOND_FEBRUARY_2020).build())
        );
        assertThat(result.data())
            .extracting(ConnectionLog::getApplicationId)
    ...
    void should_return_application_connection_logs_for_apis() {
        ...
        var result = cut.execute(
            GraviteeContext.getExecutionContext(),
                new SearchApplicationConnectionLogsUseCase.Input(
                        APPLICATION_ID, SearchLogsFilters.builder().applicationIds(Set.of("app1", "app2")).build())
        );
        assertThat(result.data())
            .extracting(ConnectionLog::getRequestId, ConnectionLog::getApplicationId)
    ...
    void should_return_api_connection_logs_for_plans() {
        ...
        var result = cut.execute(
            GraviteeContext.getExecutionContext(),
                new SearchApplicationConnectionLogsUseCase.Input(
                        APPLICATION_ID, SearchLogsFilters.builder().planIds(Set.of("plan1", "plan2")).build())
        );
        assertThat(result.data())
    ...
    void should_return_api_connection_logs_filtered_by_timestamp_date_range() {
        ...
        var result = cut.execute(
            GraviteeContext.getExecutionContext(),
                new SearchApplicationConnectionLogsUseCase.Input(
                        APPLICATION_ID, SearchLogsFilters.builder().from(FIRST_FEBRUARY_2020).to(FOURTH_FEBRUARY_2020).build(), Optional.empty())
        );
    ...
    void should_return_api_connection_logs_from_timestamp() {
        ...
        var result = cut.execute(
            GraviteeContext.getExecutionContext(),
                new SearchApplicationConnectionLogsUseCase.Input(
                        APPLICATION_ID, SearchLogsFilters.builder().from(FOURTH_FEBRUARY_2020).build(), Optional.empty())
        );
    ...
    void should_return_api_connection_logs_to_timestamp() {
        ...
        var result = cut.execute(
            GraviteeContext.getExecutionContext(),
                new SearchApplicationConnectionLogsUseCase.Input(
                        APPLICATION_ID, SearchLogsFilters.builder().to(FOURTH_FEBRUARY_2020).build(), Optional.empty())
        );
    ...
    void should_return_api_connection_logs_for_entrypoint() {
        ...
        var result = cut.execute(
            GraviteeContext.getExecutionContext(),
                new SearchApplicationConnectionLogsUseCase.Input(
                        APPLICATION_ID, SearchLogsFilters.builder().entrypointIds(Set.of("http-get")).build(), Optional.empty())
        );
