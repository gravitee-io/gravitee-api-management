...
class AbstractDocumentSearcherTest {
    ...
    class BuildFilterQuery {
        ...
        void should_remap_field() {
            ...
            // When
            Optional<org.apache.lucene.search.Query> query = customSearcher.buildFilterQuery(filters, remapFields);
        ...
        void should_remap_one_field_among_other() {
            ...
            // Then
            assertThat(query).map(Objects::toString).contains("+field1_remap:value1 +field2:value2 +(+field1_remap:value1 +field2:value2)");
        }
    }
}
