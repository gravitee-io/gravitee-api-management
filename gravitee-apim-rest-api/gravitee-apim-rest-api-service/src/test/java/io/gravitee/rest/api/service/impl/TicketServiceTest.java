...
public class TicketServiceTest {
    ...
    public void shouldSearchForTicketsFromUser() throws TechnicalException {
        ...
        when(apiSearchService.findGenericById(GraviteeContext.getExecutionContext(), API_ID, false, false)).thenReturn(apiEntity);
    ...
    public void shouldSetAPIToUnknownWhenAPINotFound() throws TechnicalException {
        ...
        when(ticketRepository.findById("ticket1")).thenReturn(Optional.of(ticket));
        when(apiSearchService.findGenericById(GraviteeContext.getExecutionContext(), API_ID, false, false)).thenThrow(
