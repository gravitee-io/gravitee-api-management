...
public class DocumentationSystemFolderUpgraderTest {
    ...
    private DocumentationSystemFolderUpgrader upgrader;
    ...
    public void setUp() throws Exception {
        upgrader = new DocumentationSystemFolderUpgrader(pageService, apiRepository);
    ...
    public void shouldDoNothingIfSystemFoldersAlreadyExist() {
        ...
        upgrader.upgradeEnvironment(executionContext);
