...
public class ApiStateServiceImplTest {
    ...
    public void shouldThrowApiNotFoundException() throws Exception {
        ...
        assertThrows(ApiNotFoundException.class, () -> apiStateService.startV4DynamicProperties(API_ID));
    }
    ...
    public void shouldThrowTechnicalManagementExceptionOnTechnicalException() throws Exception {
        ...
        assertThrows(TechnicalManagementException.class, () -> apiStateService.startV4DynamicProperties(API_ID));
    }
    ...
    public void shouldThrowApiNotFoundExceptionWhenApiDoesNotExist() throws Exception {
        ...
        assertThrows(ApiNotFoundException.class, () -> apiStateService.stopV4DynamicProperties(API_ID));
    }
    ...
    public void shouldThrowTechnicalManagementExceptionOnRepositoryFailure() throws Exception {
        ...
        assertThrows(TechnicalManagementException.class, () -> apiStateService.stopV4DynamicProperties(API_ID));
    }
    ...
    public void should_throw_ApiNotFoundException_when_api_not_found() throws Exception {
        ...
        assertThrows(ApiNotFoundException.class, () -> apiStateService.startV2DynamicProperties(API_ID));
    }
    ...
    public void should_throw_TechnicalManagementException_on_repository_failure() throws Exception {
        ...
        assertThrows(TechnicalManagementException.class, () -> apiStateService.startV2DynamicProperties(API_ID));
    }
    ...
    public void should_throw_ApiNotFoundException_when_api_not_found_v2() throws Exception {
        ...
        // Act & Assert
        assertThrows(ApiNotFoundException.class, () -> apiStateService.stopV2DynamicProperties(API_ID));
    }
    ...
    public void should_throw_TechnicalManagementException_on_repository_failure_v2() throws Exception {
        ...
        // Act & Assert
        assertThrows(TechnicalManagementException.class, () -> apiStateService.stopV2DynamicProperties(API_ID));
    }
}
