...
public class ApiMapperTest {
    ...
    public void shouldCreateEntityFromApiDefinition() throws JsonProcessingException {
        ...
        api.setType(ApiType.REQUEST_RESPONSE);
        api.setName("name");
        ...
        assertThat(apiEntity.getType()).isEqualTo(ApiType.REQUEST_RESPONSE);
    ...
    public void shouldCreateRepositoryApiFromNewEntity() throws JsonProcessingException {
        ...
        newApiEntity.setType(ApiType.EVENT_NATIVE);
        ...
        assertThat(api.getType()).isEqualTo(ApiType.EVENT_NATIVE);
        ...
        apiDefinition.setType(ApiType.EVENT_NATIVE);
