...
public class OrganizationEntrypointsResource extends AbstractResource {

    @Inject
    private GetEntrypointPluginUseCase getEntrypointPluginUseCase;
    ...
    public Set<ConnectorPlugin> getEntrypoints() {
        ...
        return ConnectorPluginMapper.INSTANCE.mapCorePlugin(
            getEntrypointPluginUseCase.getEntrypointPluginsByOrganization(new GetEntrypointPluginUseCase.Input(organizationId)).plugins()
        );
    }
}
