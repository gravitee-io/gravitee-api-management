...
@Mapper
public interface PortalMenuLinkMapper {
    PortalMenuLinkMapper INSTANCE = Mappers.getMapper(PortalMenuLinkMapper.class);

    io.gravitee.apim.core.portal_menu_link.model.CreatePortalMenuLink map(CreatePortalMenuLink createPortalMenuLink);
    io.gravitee.apim.core.portal_menu_link.model.UpdatePortalMenuLink map(UpdatePortalMenuLink updatePortalMenuLink);

    PortalMenuLink map(io.gravitee.apim.core.portal_menu_link.model.PortalMenuLink portalMenuLink);
    List<PortalMenuLink> map(List<io.gravitee.apim.core.portal_menu_link.model.PortalMenuLink> portalMenuLinkList);
}
