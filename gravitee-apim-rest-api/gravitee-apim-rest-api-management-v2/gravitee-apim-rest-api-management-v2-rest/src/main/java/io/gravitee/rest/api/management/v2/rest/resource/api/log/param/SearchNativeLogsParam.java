...
public class SearchNativeLogsParam implements TimeInterval {
    ...
    public static final String CONNECTION_STATUSES_QUERY_PARAM_NAME = "connectionStatuses";
    ...
    @QueryParam(CONNECTION_STATUSES_QUERY_PARAM_NAME)
