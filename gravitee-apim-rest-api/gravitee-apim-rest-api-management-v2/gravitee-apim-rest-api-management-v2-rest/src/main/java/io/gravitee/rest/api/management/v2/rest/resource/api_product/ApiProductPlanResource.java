...
public class ApiProductPlanResource extends AbstractResource {
    ...
    public Response deleteApiProductPlan(@PathParam("planId") String planId) {
        apiProductPlanOperationsUseCase.execute(new ApiProductPlanOperationsUseCase.Input(planId, apiProductId, DELETE));
    ...
    public Response closeApiProductPlan(@PathParam("planId") String planId) {
        var output = apiProductPlanOperationsUseCase.execute(new ApiProductPlanOperationsUseCase.Input(planId, apiProductId, CLOSE));
        return Response.ok(planMapper.mapGenericPlan(output.planEntity())).build();
    }
    ...
    public Response publishApiProductPlan(@PathParam("planId") String planId) {
        var output = apiProductPlanOperationsUseCase.execute(new ApiProductPlanOperationsUseCase.Input(planId, apiProductId, PUBLISH));
        return Response.ok(planMapper.mapGenericPlan(output.planEntity())).build();
    }
    ...
    public Response deprecateApiProductPlan(@PathParam("planId") String planId) {
        var output = apiProductPlanOperationsUseCase.execute(new ApiProductPlanOperationsUseCase.Input(planId, apiProductId, DEPRECATE));
        return Response.ok(planMapper.mapGenericPlan(output.planEntity())).build();
    }
