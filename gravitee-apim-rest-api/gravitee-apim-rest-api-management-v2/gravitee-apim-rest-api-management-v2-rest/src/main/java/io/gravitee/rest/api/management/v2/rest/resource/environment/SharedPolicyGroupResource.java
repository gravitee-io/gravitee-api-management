...
public class SharedPolicyGroupResource extends AbstractResource {
    ...
    public Response getSharedPolicyGroup() {
        ...
        return Response.ok(this.getLocationHeader(output.sharedPolicyGroup().getId()))
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Permissions(
        { @Permission(value = RolePermission.ENVIRONMENT_SHARED_POLICY_GROUP_CONFIGURATION, acls = { RolePermissionAction.UPDATE }) }
    )
    ...
    @DELETE
    @Permissions(
        { @Permission(value = RolePermission.ENVIRONMENT_SHARED_POLICY_GROUP_CONFIGURATION, acls = { RolePermissionAction.DELETE }) }
    )
