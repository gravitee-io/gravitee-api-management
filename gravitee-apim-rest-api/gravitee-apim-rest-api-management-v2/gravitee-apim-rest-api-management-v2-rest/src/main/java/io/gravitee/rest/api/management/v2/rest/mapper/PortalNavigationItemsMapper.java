...
import io.gravitee.rest.api.management.v2.rest.model.PortalNavigationApi;
...
public interface PortalNavigationItemsMapper {
    ...
    @Mapping(source = "apiDefinition.apiLifecycleState", target = "apiLifecycleState")
    @Mapping(source = "apiDefinition.visibility", target = "apiVisibility")
