...
public class ApiProductsResource extends AbstractResource {
    ...
    public Response getApiProductsForApi(@PathParam("apiId") String apiId, @BeanParam @Valid PaginationParam paginationParam) {
        Set<io.gravitee.apim.core.api_product.model.ApiProduct> coreApiProducts = apiProductQueryService.findByApiId(apiId);
        List<io.gravitee.rest.api.management.v2.rest.model.ApiProduct> restApiProducts = coreApiProducts
            .stream()
