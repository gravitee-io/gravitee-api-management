...
class ApiProductPlanResourceTest extends AbstractResourceTest {
    ...
    class GetApiProductPlanTest {
        ...
        void should_get_api_product_plan_by_id() {
            PlanEntity planEntity = PlanFixtures.aPlanEntityV4()
                .toBuilder()
                .id(PLAN_ID)
            ...
            when(getApiProductPlansUseCase.execute(any())).thenReturn(GetApiProductPlansUseCase.Output.single(Optional.of(planEntity)));
            ...
            assertAll(
                ...
                () -> assertThat(result.getName()).isEqualTo(planEntity.getName())
            );
        }
    ...
    class CloseApiProductPlanTest {
        ...
        void should_close_api_product_plan() {
            ...
            when(apiProductPlanOperationsUseCase.execute(any())).thenReturn(new ApiProductPlanOperationsUseCase.Output(planEntity));
    ...
    class DeprecateApiProductPlanTest {
        ...
        void should_deprecate_api_product_plan() {
            PlanEntity planEntity = PlanFixtures.aPlanEntityV4()
                ...
                .referenceType(GenericPlanEntity.ReferenceType.API_PRODUCT)
                .referenceId(API_PRODUCT_ID)
                .status(io.gravitee.definition.model.v4.plan.PlanStatus.DEPRECATED)
                .build();
