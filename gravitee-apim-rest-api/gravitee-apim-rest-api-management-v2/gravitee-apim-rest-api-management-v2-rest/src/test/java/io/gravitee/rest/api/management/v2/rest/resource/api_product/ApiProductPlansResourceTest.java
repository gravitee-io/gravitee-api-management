...
class ApiProductPlansResourceTest extends AbstractResourceTest {
    ...
    class GetApiProductPlansTest {
        ...
        void should_return_plans_list() {
            PlanEntity plan1 = PlanFixtures.aPlanEntityV4().toBuilder().id("plan-1").order(1).build();
            PlanEntity plan2 = PlanFixtures.aPlanEntityV4().toBuilder().id("plan-2").order(2).build();
