...
public class FlowFixtures {
    ...
    private static final FlowV4.FlowV4Builder BASE_FLOW_HTTP_V4 = FlowV4.builder()
        .name("Flow")
        .enabled(true)
    ...
    private static final FlowV4.FlowV4Builder BASE_FLOW_NATIVE_V4 = FlowV4.builder()
        .name("Flow")
        .enabled(true)
