...
public class FlowFixtures {
    ...
    private static final ChannelSelector.ChannelSelectorBuilder BASE_CHANNEL_SELECTOR_V4 = ChannelSelector
        .builder()
        .channel("channel")
        ...
        .channelOperator(Operator.EQUALS);

    private static final Step.StepBuilder BASE_STEP_V4 = Step
        .builder()
        .name("step")
    ...
    private static final Flow.FlowBuilder BASE_FLOW_V4 = Flow
        .builder()
        .name("Flow")
        .enabled(true)
        .selectors(List.of(BASE_CHANNEL_SELECTOR_V4.build()))
    ...
    private static final io.gravitee.definition.model.flow.Step.StepBuilder BASE_STEP_V2 = io.gravitee.definition.model.flow.Step
        .builder()
        .name("step")
        .description("description")
        .enabled(true)
    ...
    private static final io.gravitee.definition.model.flow.Flow.FlowBuilder BASE_FLOW_V2 = io.gravitee.definition.model.flow.Flow
        .builder()
        .name("Flow")
        .enabled(true)
        .condition("{#context.attribute['condition'] == true}")
