...
class AuditCleanerServiceTest {
    ...
    @BeforeEach
    void setup() {
        sut = new AuditCleanerService(scheduler, "", true, 1, removeOldAuditDataUseCase, organizationService, environmentService);
    }
