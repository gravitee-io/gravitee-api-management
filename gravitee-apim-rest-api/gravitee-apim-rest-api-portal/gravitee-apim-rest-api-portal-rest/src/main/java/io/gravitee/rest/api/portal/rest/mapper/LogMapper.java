...
public class LogMapper {
    ...
    public Log convert(ConnectionLog connectionLog, Optional<ConnectionLogDetail> connectionLogDetail, Map<String, Map<String, Object>> metadata) {
    ...
    private Request convert(ConnectionLogDetail.Request request) {
        if (request == null) {
            return null;
        }

        final Request portalRequest = new Request();
        portalRequest.setMethod(convert(request.getMethod()));
    ...
    private Response convert(ConnectionLogDetail.Response response) {
        if (response == null) {
            return null;
        }
