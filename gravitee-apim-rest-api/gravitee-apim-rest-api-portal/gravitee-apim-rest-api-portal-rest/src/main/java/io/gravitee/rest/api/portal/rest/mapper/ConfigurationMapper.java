...
public class ConfigurationMapper {
    ...
    private ConfigurationPortalNext convert(PortalNext portalNext) {
        ConfigurationPortalNext configuration = new ConfigurationPortalNext();
        configuration.setHomepageTitle(portalNext.getHomepageTitle());
        configuration.setHomepageBannerTitle(portalNext.getHomepageBannerTitle());
        configuration.setHomepageSubtitle(portalNext.getHomepageSubtitle());
        return configuration;
    }
