...
public class UserMapstructMapperTest {
    ...
    @Test
    public void testConvertPrimaryUserEntity() {
        PrimaryOwnerEntity source = new PrimaryOwnerEntity();
        source.setId(USER_ID);
        source.setEmail(USER_EMAIL);
        source.setDisplayName(SEARCHABLE_USER_DISPLAY_NAME);
        source.setType("USER_TYPE");

        User user = new User();
        user.setId(USER_ID);
        user.setEmail(USER_EMAIL);
        user.setDisplayName(SEARCHABLE_USER_DISPLAY_NAME);

        User mapped = UserMapstructMapper.INSTANCE.primaryOwnerEntityToUser(source);
    ...
    public void testConvertUserEntity() {
        ...
        User responseUser = UserMapstructMapper.INSTANCE.userEntityToUser(userEntity);
        ...
        assertEquals(null, responseUser.getPermissions());
    }
    ...
    public void testConvertSearchableUser() {
        ...
        // Test
        User responseUser = UserMapstructMapper.INSTANCE.seachableUserToUser(searchableUser);
        assertNotNull(responseUser);
        assertEquals(USER_ID, responseUser.getId());
        assertEquals(USER_EMAIL, responseUser.getEmail());
        assertEquals(USER_FIRSTNAME, responseUser.getFirstName());
    ...
    public void testConvertRegisterUserInput() {
        ...
        NewExternalUserEntity newExternalUserEntity = UserMapstructMapper.INSTANCE.toNewExternalUserEntity(input);
    ...
    public void testConvertFinalizeRegistrationInput() {
        ...
        RegisterUserEntity registerUserEntity = UserMapstructMapper.INSTANCE.toRegisterUserEntity(input);
