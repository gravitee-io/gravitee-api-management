...
public class ApplicationSubscriptionResourceTest extends AbstractResourceTest {
    ...
    public void shouldGetApplicationSubscription_onPlanV2() {
        ...
        when(apiSearchServiceV4.findGenericById(eq(GraviteeContext.getExecutionContext()), eq(API_ID), eq(false))).thenReturn(apiV2);
    ...
    public void shouldGetApplicationSubscription_onPlanV4() {
        ...
        when(apiSearchServiceV4.findGenericById(eq(GraviteeContext.getExecutionContext()), eq(API_ID), eq(false))).thenReturn(apiV4);
