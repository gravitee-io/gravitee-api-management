 ...
 */
public class ECJWKSourceResolverTest {

    private ECJWKSourceResolver<SecurityContext> sourceResolver;

    @Test
    public void resolveValidPublicKey() throws NoSuchAlgorithmException, IOException {
        ...
        sourceResolver = new ECJWKSourceResolver<>(writer::toString);
    ...
    public void shouldNotResolveNullPublicKey() {
        sourceResolver = new ECJWKSourceResolver<>(() -> null);
        sourceResolver.resolve();
