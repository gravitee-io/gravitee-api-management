...
public class PortalNotificationPageResult extends PagedResult<PortalNotificationEntity> {

    public PortalNotificationPageResult(Collection<PortalNotificationEntity> data) {
        super(data);
    }
}
