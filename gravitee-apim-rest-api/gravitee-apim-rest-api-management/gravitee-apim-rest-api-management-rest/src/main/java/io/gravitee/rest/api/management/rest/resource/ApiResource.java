...
public class ApiResource extends AbstractResource {
    ...
    @ApiResponses({ @ApiResponse(code = 200, message = "API's background"), @ApiResponse(code = 500, message = "Internal server error") })
    ...
    @ApiResponses(
        { @ApiResponse(code = 204, message = "API successfully deleted"), @ApiResponse(code = 500, message = "Internal server error") }
    )
    ...
    @Permissions({ @Permission(value = RolePermission.API_DEFINITION, acls = RolePermissionAction.UPDATE) })
    public Response deployApi(@ApiParam(name = "apiDeployment") @Valid final ApiDeploymentEntity apiDeploymentEntity) {
        try {
    ...
    @Path("notifiers")
    @ApiOperation(
        value = "List available notifiers for API",
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(
        value = "Send a message to existing consumers of an API",
    ...
    @ApiResponses({ @ApiResponse(code = 204, message = "Updated API"), @ApiResponse(code = 500, message = "Internal server error") })
    @Permissions(
        {
            @Permission(value = RolePermission.API_DEFINITION, acls = RolePermissionAction.UPDATE),
    ...
    public Response doApiReviewAction(
        @Context HttpHeaders headers,
        @ApiParam(required = true, allowableValues = "ASK") @NotNull @Valid @QueryParam("action") ReviewActionParam action,
