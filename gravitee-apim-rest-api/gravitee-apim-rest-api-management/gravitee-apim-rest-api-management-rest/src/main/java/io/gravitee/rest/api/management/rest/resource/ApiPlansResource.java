...
@Tag(
    name = "API Plans",
    description = "Manage API plans. Only V1 and V2 API definitions are supported. For V4 or Federated APIs, use Management API v2 (/management/v2/environments/{envId}/apis/{apiId}/plans)."
)
