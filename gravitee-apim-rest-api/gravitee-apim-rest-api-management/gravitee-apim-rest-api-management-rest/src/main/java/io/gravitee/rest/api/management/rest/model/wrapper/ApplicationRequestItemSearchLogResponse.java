...
public class ApplicationRequestItemSearchLogResponse extends SearchLogResponse<ApplicationRequestItem> {

    public ApplicationRequestItemSearchLogResponse(long total) {
        super(total);
    }
}
