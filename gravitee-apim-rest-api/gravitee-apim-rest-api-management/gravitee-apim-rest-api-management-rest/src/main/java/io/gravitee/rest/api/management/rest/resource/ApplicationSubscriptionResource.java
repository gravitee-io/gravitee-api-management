...
public class ApplicationSubscriptionResource extends AbstractResource {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(
        value = "Deprecated, use GET /applications/{applicationId}/subscriptions/{subscriptionId}/apikeys instead",
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(
        value = "Deprecated, use POST /applications/{applicationId}/subscriptions/{subscriptionId}/apikeys/_renew instead",
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(
        value = "Deprecated, use DELETE /applications/{applicationId}/subscriptions/{subscriptionId}/apikeys/{apiKeyId}",
        notes = "User must have the MANAGE_API_KEYS permission to use this service"
    )
    @ApiResponses(
        {
    ...
    @Permissions({ @Permission(value = RolePermission.APPLICATION_SUBSCRIPTION, acls = RolePermissionAction.DELETE) })
    public Response revokeApiKeyForApplicationSubscription(@PathParam("key") String apiKey) {
        SubscriptionEntity subscriptionEntity = subscriptionService.findById(subscription);
