...
const managementUsersResourceAsAdminUser = new UsersApi(forManagementAsAdminUser());
...
describe('User tokens crud tests', () => {
  ...
  describe('Create', () => {
    it('should create a token', async () => {
      ...
      await succeed(
        managementUsersResourceAsAdminUser.updateUserRolesRaw({
          userId: apiUser.id,
          userReferenceRoleEntity: {
            referenceId: orgId,
            referenceType: 'ORGANIZATION',
            roles: [createdTokenRole.id],
            user: apiUser.id,
          },
          orgId,
          envId,
