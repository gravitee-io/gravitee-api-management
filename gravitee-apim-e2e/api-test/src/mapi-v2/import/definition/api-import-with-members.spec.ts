...
<<<<<<< HEAD:gravitee-apim-e2e/api-test/src/mapi-v2/import/definition/api-import-with-members.spec.ts
    let primaryOwner: UserEntity;
=======
    let memberWithUnknownRole: UserEntity;
    let memberWithNoRole: UserEntity;
>>>>>>> c3e3c6d451 (refactor(import): fallback to default API role on membert imports):gravitee-apim-e2e/api-test/src/apis/imports/mapi-v2/import-api-definition/api-v4-import-with-members.spec.ts
