 ...
 * @export
 */
export const PlanEntityV4PlanStatusEnum = {
    STAGING: 'STAGING',
    PUBLISHED: 'PUBLISHED',
    DEPRECATED: 'DEPRECATED',
    CLOSED: 'CLOSED'
} as const;
export type PlanEntityV4PlanStatusEnum = typeof PlanEntityV4PlanStatusEnum[keyof typeof PlanEntityV4PlanStatusEnum];
...
export function PlanEntityV4FromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanEntityV4 {
    ...
    return {
        ...
        'planSecurity': !exists(json, 'planSecurity') ? undefined : PlanSecurityV4FromJSON(json['planSecurity']),
        'planStatus': !exists(json, 'planStatus') ? undefined : json['planStatus'],
        'planValidation': !exists(json, 'planValidation') ? undefined : PlanValidationTypeV4FromJSON(json['planValidation']),
...
export function PlanEntityV4ToJSON(value?: PlanEntityV4 | null): any {
    ...
    return {
        ...
        'name': value.name,
        'order': value.order,
        'planSecurity': PlanSecurityV4ToJSON(value.planSecurity),
        'planStatus': value.planStatus,
        'planValidation': PlanValidationTypeV4ToJSON(value.planValidation),
