...
export function ApiEntityV4FromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiEntityV4 {
    ...
    return {
        ...
        'definitionContext': !exists(json, 'definitionContext') ? undefined : DefinitionContextFromJSON(json['definitionContext']),
...
export function ApiEntityV4ToJSON(value?: ApiEntityV4 | null): any {
    ...
    return {
        ...
        'definitionContext': DefinitionContextToJSON(value.definitionContext),
