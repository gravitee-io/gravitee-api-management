...
public class PKCS12KeyStoreDeserializer extends AbstractStdScalarDeserializer<PKCS12KeyStore> {
    ...
    public PKCS12KeyStoreDeserializer(Class<PKCS12KeyStore> vc) {
        super(vc);
    }

    @Override
    public PKCS12KeyStore deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
