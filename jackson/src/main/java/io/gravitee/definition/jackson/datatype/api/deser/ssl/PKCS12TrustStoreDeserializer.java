...
public class PKCS12TrustStoreDeserializer extends AbstractStdScalarDeserializer<PKCS12TrustStore> {
    ...
    public PKCS12TrustStoreDeserializer(Class<PKCS12TrustStore> vc) {
        super(vc);
    }

    @Override
    public PKCS12TrustStore deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
        JsonNode node = jp.getCodec().readTree(jp);

        PKCS12TrustStore truststore = new PKCS12TrustStore();
