 ...
 */
public class MonitoringSerializer extends StdScalarSerializer<Monitoring> {

    public MonitoringSerializer(Class<Monitoring> t) {
        super(t);
    }

    @Override
    public void serialize(Monitoring monitoring, JsonGenerator jgen, SerializerProvider provider) throws IOException {
