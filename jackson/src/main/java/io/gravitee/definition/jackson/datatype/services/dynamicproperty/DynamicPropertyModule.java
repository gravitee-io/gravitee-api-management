...
public class DynamicPropertyModule extends GraviteeModule {
    ...
    public DynamicPropertyModule() {
        ...
        // first deserializers
        addDeserializer(DynamicPropertyService.class, new io.gravitee.definition.jackson.datatype.services.dynamicproperty.deser.DynamicPropertyDeserializer(DynamicPropertyService.class));
        addDeserializer(HttpDynamicPropertyProviderConfiguration.class, new io.gravitee.definition.jackson.datatype.services.dynamicproperty.deser.http.HttpDynamicPropertyProviderConfigurationDeserializer(HttpDynamicPropertyProviderConfiguration.class));
