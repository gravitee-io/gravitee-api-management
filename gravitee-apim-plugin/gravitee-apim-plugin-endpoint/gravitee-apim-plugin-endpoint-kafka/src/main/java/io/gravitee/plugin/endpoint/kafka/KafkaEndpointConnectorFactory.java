...
public class KafkaEndpointConnectorFactory implements EndpointAsyncConnectorFactory {
    ...
    public KafkaEndpointConnectorFactory(final ConnectorConfigurationHelper connectorConfigurationHelper) {
    ...
    public KafkaEndpointConnector createConnector(final String configuration) {
        try {
            return new KafkaEndpointConnector(
                connectorConfigurationHelper.getConnectorConfiguration(KafkaEndpointConnectorConfiguration.class, configuration),
                qosStrategyFactory
            );
