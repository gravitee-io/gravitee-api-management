...
class WebSocketEntrypointConnectorFactoryTest {
    ...
    @BeforeEach
    void init() {
        cut = new WebSocketEntrypointConnectorFactory(connectorConfigurationHelper);
    }
    ...
    void shouldCreateConnector() throws PluginConfigurationException {
        when(
            connectorConfigurationHelper.getConnectorConfiguration(WebSocketEntrypointConnectorConfiguration.class, CONNECTOR_CONFIGURATION)
        )
