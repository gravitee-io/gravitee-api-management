...
import { GmdFormEditorComponent } from '../../gravitee-markdown-editor/components/gravitee-markdown-form-editor/gmd-form-editor.component';
...
`,
  ...
  parameters: {
    docs: {
      description: {
        story: 'Form editor with live validation tracking. Shows how the gmd-form-editor component tracks field states and displays validation status in real-time.',
      },
    },
  },
};
