...
import { GmdFieldErrorCode, GmdFieldState } from '../input/gmd-input.component';
...
export class GmdCheckboxComponent {
  ...
  // Public computed signals and view models
  ...
  valueVM = () => this.internalValue();
  touchedVM = () => this.touched();
