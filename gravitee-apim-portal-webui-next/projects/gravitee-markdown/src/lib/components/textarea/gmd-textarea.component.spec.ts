...
import { GmdFieldState } from '../input/gmd-input.component';
...
describe('GmdTextareaComponent', () => {
  ...
  describe('Validation', () => {
    ...
    it('should validate pattern', () => {
      ...
      const textarea = fixture.nativeElement.querySelector('textarea') as HTMLTextAreaElement;
      textarea.value = 'abc123';
      textarea.dispatchEvent(new Event('input'));
      fixture.detectChanges();

      expect(textareaComponent.valid()).toBe(false);
      expect(textareaComponent.errors()).toContain('pattern');
    });

    it('should handle invalid pattern regex', () => {
      fixture.componentRef.setInput('pattern', '[invalid');
      fixture.detectChanges();
      ...
      expect(textareaComponent.errors()).toContain('invalidPattern');
    });
