...
import { GmdInputComponent, GmdFieldState } from './gmd-input.component';
...
describe('GmdInputComponent', () => {
  ...
  describe('Validation', () => {
    ...
    it('should handle invalid pattern regex', async () => {
      ...
      expect(inputComponent.errors()).toContain('invalidPattern');
    });
