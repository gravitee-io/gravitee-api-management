...
import { DATE_TIME_FORMATS } from './utils/time-frame-ranges';
...
@Component({
  ...
  providers: [
    { provide: OWL_DATE_TIME_FORMATS, useValue: DATE_TIME_FORMATS },
    {
      ...
      useExisting: TimeFrameComponent,
      multi: true,
    },
  ],
  templateUrl: './time-frame.component.html',
  styleUrl: './time-frame.component.scss',
})
export class TimeFrameComponent implements ControlValueAccessor {
