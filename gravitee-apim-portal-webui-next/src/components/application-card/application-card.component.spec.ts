...
describe('ApplicationCardComponent', () => {
  ...
  beforeEach(async () => {
    ...
    fixture.componentRef.setInput('applicationId', mockData.applicationId);
    fixture.componentRef.setInput('title', mockData.title);
    fixture.componentRef.setInput('description', mockData.description);
