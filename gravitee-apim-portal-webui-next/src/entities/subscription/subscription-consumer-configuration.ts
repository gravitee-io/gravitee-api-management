...
export interface SslOptions {
  ...
  trustAll?: boolean;
  trustStore?: SslTrustStoreOptions;
  keyStore?: SslKeyStoreOptions;
}

export type SslStoreOptionsType = '' | 'JKS' | 'PKCS12' | 'PEM';

export interface SslTrustStoreOptions {
  type: SslStoreOptionsType;
  password?: string;
  content?: string;
}

export interface SslKeyStoreOptions {
  type: SslStoreOptionsType;
  password?: string;
  alias?: string;
  keyPassword?: string;
