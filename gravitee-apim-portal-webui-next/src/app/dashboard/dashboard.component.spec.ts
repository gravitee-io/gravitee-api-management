...
describe('DashboardComponent', () => {
  ...
  it('should omit Analytics from menu items when portal next analytics is not enabled', async () => {
    ...
    expect(fixture.componentInstance.menuItems().map(item => item.path)).toEqual(['subscriptions', 'applications']);
  });
  ...
  it('should include Analytics in menu items when portal next analytics is enabled', async () => {
    ...
    expect(fixture.componentInstance.menuItems().map(item => item.path)).toEqual(['subscriptions', 'applications', 'analytics']);
  });
