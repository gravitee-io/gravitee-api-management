...
export class MessageLogDetailDialogComponent {
  ...
  // private readonly initialData: MessageLogDetailDialogData;
  ...
  private transformConnector(connector: MessageLogDetailConnectorData): MessageLogDetailConnectorVM {
    return {...connector,
      headers: this.transformHeaders(connector.headers),
      metadata: this.transformMetadata(connector.metadata),
    }
  }
