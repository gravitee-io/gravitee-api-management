...
import { MessageLogDetailDialogComponent, MoreFiltersDialogData } from './message-log-detail-dialog.component';
...
class TestComponent {
  ...
  public openDialog() {
    this.matDialog
      .open<MessageLogDetailDialogComponent, MoreFiltersDialogData>(MessageLogDetailDialogComponent, {
...
describe('MoreFiltersDialogComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [TestComponent, MessageLogDetailDialogComponent, NoopAnimationsModule],
    })
  ...
  it('should only select start date that is before today', async () => {
    const dialog = await rootHarnessLoader.getHarness(MessageLogDetailDialogHarness);
