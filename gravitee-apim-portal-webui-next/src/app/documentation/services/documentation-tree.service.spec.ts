 ...
 */
import { DocumentationTreeService } from './documentation-tree.service';
import { MOCK_ITEMS } from '../../../mocks/portal-navigation-item.mocks';

let service: DocumentationTreeService;

beforeEach(() => {
  service = new DocumentationTreeService();
});

describe('DocumentationTreeService', () => {
  it('should create tree', () => {
    const itemsTree = service.mapItemsToNodes(MOCK_ITEMS);
