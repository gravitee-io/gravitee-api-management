...
import { PortalNavigationPage, PortalPageContent } from '../../entities';
...
export class HomepageComponent implements HasUnsavedChanges {
  contentControl = new FormControl({ value: '', disabled: true });
  ...
  private executeTogglePublish(): void {
    ...
    this.matDialog
      ...
      .pipe(
        ...
        tap(updatedPage => {
          const currentNav = this.portalHomepage()?.navigationItem;
          if (currentNav) {
