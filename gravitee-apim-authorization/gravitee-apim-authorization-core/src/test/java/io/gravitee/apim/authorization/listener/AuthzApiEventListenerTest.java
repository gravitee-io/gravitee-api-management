...
import io.gravitee.apim.authorization.service.EntityIdValidator;
import io.gravitee.apim.authorization.service.EntityServiceImpl;
...
class AuthzApiEventListenerTest {
    ...
    void setUp() {
        ...
        entityService = new EntityServiceImpl(
            ...
            policyRepository,
            validator,
            new io.gravitee.apim.authorization.service.SchemaServiceImpl(entityRepository, policyRepository),
            mock(AuthzEventPublisher.class),
            mock(AuthzAuditPort.class)
        );
        eventManager = new EventManagerImpl();
        listener = new AuthzApiEventListener(eventManager, entityService, new AuthzEntityIdExtractor());
    }
    ...
    void subscribe_routes_v4_repo_api_event_through_adapter_into_handle() {
        ...
        AuthzApiEventListener listenerWithStub = new AuthzApiEventListener(
            eventManager,
            entityService,
            new AuthzEntityIdExtractor(),
            repoApi -> preBuiltCoreApi
        );
        ...
        assertThat(entityRepository.findAll(ENV))
            .extracting(io.gravitee.apim.authorization.domain.Entity::entityId)
    ...
    void deploy_event_with_partial_batch_failure_continues_remaining_entities() {
        ...
        io.gravitee.apim.authorization.api.EntityRepository faultyRepo = new io.gravitee.apim.authorization.api.EntityRepository() {
            @Override
            public io.gravitee.apim.authorization.domain.Entity save(io.gravitee.apim.authorization.domain.Entity entity) {
            ...
            @Override
            public java.util.Optional<io.gravitee.apim.authorization.domain.Entity> findById(String envId, String id) {
                return delegate.findById(envId, id);
            }

            @Override
            public java.util.Optional<io.gravitee.apim.authorization.domain.Entity> findByEntityId(String envId, String entityId) {
                return delegate.findByEntityId(envId, entityId);
            }

            @Override
            public java.util.List<io.gravitee.apim.authorization.domain.Entity> findAll(String envId) {
                return delegate.findAll(envId);
            }

            @Override
            public java.util.List<io.gravitee.apim.authorization.domain.Entity> findByKind(
                String envId,
                io.gravitee.apim.authorization.domain.EntityKind kind
            ) {
                return delegate.findByKind(envId, kind);
            }

            @Override
            public java.util.List<io.gravitee.apim.authorization.domain.Entity> findByEntityIdPrefix(String envId, String prefix) {
                return delegate.findByEntityIdPrefix(envId, prefix);
            }

            @Override
            public boolean deleteById(String envId, String id) {
                return delegate.deleteById(envId, id);
            }

            @Override
            public boolean deleteByEntityId(String envId, String entityId) {
                return delegate.deleteByEntityId(envId, entityId);
            }
        };
        ...
        EntityServiceImpl faultyService = new EntityServiceImpl(
            ...
            new io.gravitee.apim.authorization.service.SchemaServiceImpl(faultyRepo, faultyPolicyRepository),
            mock(AuthzEventPublisher.class),
            mock(AuthzAuditPort.class)
        );
        AuthzApiEventListener faultyListener = new AuthzApiEventListener(eventManager, faultyService, new AuthzEntityIdExtractor());
