...
public class RoundRobinLoadBalancerTest {
    ...
    public void shouldInvokeEndpointWithEncodedTargetURI() {
        ...
        final String targetURIAttribute = ExecutionContext.ATTR_PREFIX + "target.uri";

        when(executionContext.getAttribute(ExecutionContext.ATTR_REQUEST_ENDPOINT)).thenReturn(targetUri);
        when(executionContext.getAttribute(targetURIAttribute)).thenReturn(expectedTargetUri);
        ...
        verify(executionContext).setAttribute(targetURIAttribute, expectedTargetUri);
    }
}
