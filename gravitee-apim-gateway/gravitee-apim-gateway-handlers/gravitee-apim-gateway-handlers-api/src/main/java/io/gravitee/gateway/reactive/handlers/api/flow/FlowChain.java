...
public class FlowChain implements Hookable<ChainHook> {
     ...
     */
    private Flowable<FlowEntity> resolveFlows(GenericExecutionContext ctx) {
        return Flowable.defer(() -> {
            Flowable<FlowEntity> flows = ctx.getInternalAttribute(resolvedFlowAttribute);
     ...
     */
    private Completable executeFlow(final ExecutionContext ctx, final FlowEntity flow, final ExecutionPhase phase) {
