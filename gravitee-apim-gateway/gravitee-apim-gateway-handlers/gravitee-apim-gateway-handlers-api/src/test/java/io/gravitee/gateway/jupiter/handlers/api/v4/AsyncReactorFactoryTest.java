...
public class AsyncReactorFactoryTest {

    private AsyncReactorFactory factory;
    ...
    public void init() {
        ...
        factory = new AsyncReactorFactory(null, null, null, null, null, null, null, null);
    }
    ...
    @Test
    public void shouldNotCreateApiWithSync() {
        when(api.getDefinitionVersion()).thenReturn(DefinitionVersion.V4);
        when(definition.getType()).thenReturn(ApiType.SYNC);
    ...
    public void shouldNotCreateApiIfDisabled() {
        ...
        ReactorHandler handler = factory.create(api);
        assertNull(handler);
    }
}
