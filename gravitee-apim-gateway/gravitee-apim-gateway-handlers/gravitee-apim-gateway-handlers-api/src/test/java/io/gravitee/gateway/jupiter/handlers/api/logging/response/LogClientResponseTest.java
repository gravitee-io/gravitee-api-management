...
class LogClientResponseTest {
    ...
    void shouldLogStatusOnly() {
        ...
        when(loggingContext.responseHeaders()).thenReturn(false);
        when(loggingContext.responsePayload()).thenReturn(false);

        final LogClientResponse logResponse = new LogClientResponse(loggingContext, response);
    ...
    void shouldLogHeaders() {
        ...
        when(loggingContext.responseHeaders()).thenReturn(true);
        when(loggingContext.responsePayload()).thenReturn(false);
    ...
    void shouldLogBody() {
        ...
        when(loggingContext.responseHeaders()).thenReturn(false);
        when(loggingContext.responsePayload()).thenReturn(true);
