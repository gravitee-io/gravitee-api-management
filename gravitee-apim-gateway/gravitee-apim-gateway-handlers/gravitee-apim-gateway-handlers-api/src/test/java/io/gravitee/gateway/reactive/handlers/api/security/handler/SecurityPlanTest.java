 ...
 */
package io.gravitee.gateway.reactive.handlers.api.security.handler;

import static io.gravitee.gateway.reactive.api.context.ExecutionContext.ATTR_API;
import static io.gravitee.gateway.reactive.handlers.api.security.handler.SecurityPlan.CONTEXT_ATTRIBUTE_CLIENT_ID;
...
class SecurityPlanTest {
    ...
    void shouldValidateSubscription() throws TechnicalException {
        ...
        when(ctx.getAttribute(CONTEXT_ATTRIBUTE_CLIENT_ID)).thenReturn(CLIENT_ID);
