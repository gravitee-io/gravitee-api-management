...
public class LogGuardService extends AbstractService<LogGuardService> {
    ...
    private final int strategyDurationInSeconds;
    ...
    public void doStart() throws Exception {
        if (isLogGuardEnabled) {
            if (!strategy.isEmpty() && strategy.equals("cooldown")) {
                logGuardStrategy = new CoolDownLogGuardStrategy(nodeHealthCheckService, Duration.ofSeconds(strategyDurationInSeconds));
            } else {
