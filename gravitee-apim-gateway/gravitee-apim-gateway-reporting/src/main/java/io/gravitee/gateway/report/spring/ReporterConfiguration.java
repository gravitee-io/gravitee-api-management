...
public class ReporterConfiguration {
    ...
    public LogGuardService logGuardService(
        ...
        @Value("${reporters.logging.memory_pressure_guard.strategy.duration:60}") int durationInSeconds,
        NodeHealthCheckService nodeHealthCheckService
    ) {
        return new LogGuardService(enabled, strategy, durationInSeconds, nodeHealthCheckService);
    }
}
