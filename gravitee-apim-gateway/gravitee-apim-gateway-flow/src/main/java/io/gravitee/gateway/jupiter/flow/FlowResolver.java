...
public interface FlowResolver {
     ...
     */
    Flowable<Flow> provideFlows(final HttpExecutionContext ctx);
     ...
     *
     * Initial flow list must be provided by a concrete implementation of {@link #provideFlows(HttpExecutionContext)}.
     *
     * @param ctx the current context.
     * @return a {@link Flowable} of {@link Flow} that have passed the filter step.
     */
    Flowable<Flow> resolve(final HttpExecutionContext ctx);
}
