...
public interface FlowResolver<C extends BaseExecutionContext> {
     ...
     * @return a {@link Flowable} of {@link FlowV2}.
     */
    Flowable<FlowV2> provideFlows(final C ctx);
     ...
     *
     * @param ctx the current context.
     * @return a {@link Flowable} of {@link FlowV2} that have passed the filter step.
     */
    Flowable<FlowV2> resolve(final C ctx);
}
