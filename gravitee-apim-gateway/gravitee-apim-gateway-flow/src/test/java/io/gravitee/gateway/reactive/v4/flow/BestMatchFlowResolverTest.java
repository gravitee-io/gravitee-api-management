...
public class BestMatchFlowResolverTest extends BestMatchFlowBaseTest {
    ...
    public AbstractBestMatchFlowSelector<FlowV4> bestMatchFlowSelector = new BestMatchFlowSelector();
    ...
    public void should_resolve_bestMatchFlow_with_api_sync() {
        ...
        final TestSubscriber<FlowV4> obs = cut.resolve(executionContext).test();
        obs.assertComplete();
