...
public class BestMatchFlowSelectorTest {
    ...
    @Before
    public void setUp() {
        cut = BestMatchFlowSelector.instance();
    }

    @Test
    public void should_return_empty_when_flow_null() {
        assertThat(cut.providePath(null, null)).isEmpty();
    }

    @Test
    public void should_return_empty_string_when_flow_has_no_path() {
        assertThat(cut.providePath(null, new Flow())).isNotEmpty().containsSame("");
    }
    ...
    public void should_return_flow_path() {
        ...
        assertThat(cut.providePath(null, flow)).isNotEmpty().containsSame("path");
    }
}
