...
for /f %%i in ('dir ..\lib\gravitee-apim-gateway-standalone-bootstrap*.jar /s /b') do set runjar=%%i
...
%JAVA% %JAVA_OPTS% -cp %GRAVITEE_BOOT_CLASSPATH% -Dgravitee.home=%GRAVITEE_HOME% io.gravitee.gateway.standalone.boostrap.Bootstrap "%*"
