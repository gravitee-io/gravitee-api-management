 ...
 */
@ApiDescriptor("/io/gravitee/gateway/standalone/http/ssl-pkcs12-support.json")
public class SSLPKCS12TrustStoreTest extends AbstractWiremockGatewayTest {
    ...
    @Test
    public void http_request_ssl() throws Exception {
