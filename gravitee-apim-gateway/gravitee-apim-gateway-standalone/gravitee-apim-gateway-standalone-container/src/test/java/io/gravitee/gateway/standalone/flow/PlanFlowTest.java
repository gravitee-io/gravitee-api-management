 ...
 */
@ApiDescriptor("/io/gravitee/gateway/standalone/flow/plan-flow.json")
public class PlanFlowTest extends AbstractWiremockGatewayTest {
    ...
    protected void overridePlans() {
        // Do not override plans from the definition
    }
}
