 ...
 *
 * Encode as base64
 * > cat truststore.p12 | base64
 * > cat keystore.p12 | base64
 *
 * @author Guillaume CUSNIEUX (guillaume.cusnieux at graviteesource.com)
 * @author GraviteeSource Team
 */
@ApiDescriptor("/io/gravitee/gateway/standalone/http/client-authentication-pkcs12-inline-support.json")
public class ClientAuthenticationPKCS12InlineTest extends AbstractWiremockGatewayTest {
