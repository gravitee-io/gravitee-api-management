...
public class VertxHttpServerResponseDebugDecorator extends VertxHttpServerResponse {

    private final Buffer buffer = Buffer.buffer();

    public VertxHttpServerResponseDebugDecorator(VertxHttpServerRequest serverRequest) {
        super(serverRequest);
    }
