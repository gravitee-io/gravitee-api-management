...
@CustomLog
public class DistributedCredentialSynchronizer extends AbstractDistributedSynchronizer<CredentialDeployable, CredentialDeployer> {

    private final DeployerFactory deployerFactory;
    private final CredentialMapper credentialMapper;

    public DistributedCredentialSynchronizer(
    ...
    protected DistributedEventType distributedEventType() {
        return DistributedEventType.CREDENTIAL;
    }

    @Override
    protected Maybe<CredentialDeployable> mapTo(final DistributedEvent distributedEvent) {
        return credentialMapper.to(distributedEvent);
    }

    @Override
    protected CredentialDeployer createDeployer() {
        return deployerFactory.createCredentialDeployer();
    }
