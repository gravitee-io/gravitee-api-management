 ...
 */
package io.gravitee.gateway.services.sync.process.distributed.synchronizer.authz;
...
/**
 * Distributed peer-to-peer authz policy synchronizer. Mirrors {@code DistributedSharedPolicyGroupSynchronizer}.
 */
@CustomLog
public class DistributedAuthzPolicySynchronizer extends AbstractDistributedSynchronizer<AuthzPolicyReactorDeployable, AuthzPolicyDeployer> {

    private final DeployerFactory deployerFactory;
    private final AuthzPolicyMapper authzPolicyMapper;

    public DistributedAuthzPolicySynchronizer(
        ...
        this.authzPolicyMapper = authzPolicyMapper;
    }

    @Override
    protected DistributedEventType distributedEventType() {
        return DistributedEventType.AUTHZ_POLICY;
    }

    @Override
    protected Maybe<AuthzPolicyReactorDeployable> mapTo(final DistributedEvent distributedEvent) {
        return authzPolicyMapper.to(distributedEvent);
    }

    @Override
    protected AuthzPolicyDeployer createDeployer() {
