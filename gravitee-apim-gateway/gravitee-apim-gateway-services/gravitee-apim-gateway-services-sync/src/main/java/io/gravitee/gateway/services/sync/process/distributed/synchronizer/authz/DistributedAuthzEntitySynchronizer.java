...
@CustomLog
public class DistributedAuthzEntitySynchronizer extends AbstractDistributedSynchronizer<AuthzEntityReactorDeployable, AuthzEntityDeployer> {

    private final DeployerFactory deployerFactory;
    private final AuthzEntityMapper authzEntityMapper;

    public DistributedAuthzEntitySynchronizer(
        ...
        this.authzEntityMapper = authzEntityMapper;
    }

    @Override
    protected DistributedEventType distributedEventType() {
        return DistributedEventType.AUTHZ_ENTITY;
    }

    @Override
    protected Maybe<AuthzEntityReactorDeployable> mapTo(final DistributedEvent distributedEvent) {
        return authzEntityMapper.to(distributedEvent);
    }

    @Override
    protected AuthzEntityDeployer createDeployer() {
