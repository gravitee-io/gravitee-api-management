...
public class SyncConfiguration {
    ...
    @Bean
    public AuthzRegistry authzRegistry() {
        return new AuthzRegistry();
    }
    ...
    public AuthzAppender authzAppender(
        ...
        @Autowired(required = false) EventLatestRepository eventLatestRepository,
        @Autowired(required = false) AuthzEntityMapper entityMapper,
        @Autowired(required = false) AuthzPolicyMapper policyMapper,
        AuthzEnginePort enginePort
    ) {
        return new AuthzAppender(extractor, eventLatestRepository, entityMapper, policyMapper, enginePort);
    }
