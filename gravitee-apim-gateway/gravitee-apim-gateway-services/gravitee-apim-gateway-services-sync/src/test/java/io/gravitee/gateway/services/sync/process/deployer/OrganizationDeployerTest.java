...
import io.gravitee.gateway.services.sync.process.synchronizer.organization.OrganizationDeployable;
...
class OrganizationDeployerTest {
    ...
    public void beforeEach() {
        cut = new OrganizationDeployer(organizationManager);
    }
