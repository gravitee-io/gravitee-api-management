...
public class AccessPointFetcherTest {
    ...
    void should_fetch_access_points() throws TechnicalException {
        ...
        cut
            .fetchLatest(null, null, List.of(), AccessPointStatus.CREATED)
            .test()
            .assertValueCount(1)
    ...
    void should_fetch_access_points_with_criteria() throws TechnicalException {
        ...
        cut
            .fetchLatest(from.toEpochMilli(), to.toEpochMilli(), List.of("env1", "env2"), AccessPointStatus.CREATED)
            .test()
            .assertValueCount(1)
            .assertValue(accessPoints -> accessPoints.contains(accessPoint));
    }
    ...
    void should_emit_on_error_when_repository_thrown_exception() throws TechnicalException {
        ...
        cut.fetchLatest(null, null, List.of(), AccessPointStatus.CREATED).test().assertError(RuntimeException.class);
    }
}
