...
class HttpConditionalPolicyTest {
    ...
    void shouldStoreTriggerConditionInContextOnRequest() {
        ...
        verify((HttpExecutionContextInternal) ctx).setInternalAttribute("policy.trigger.condition." + POLICY_ID, CONDITION);
    }
    ...
    void shouldNotStoreTriggerConditionWhenNoCondition() {
        ...
        verify((HttpExecutionContextInternal) ctx, never()).setInternalAttribute(eq("policy.trigger.condition." + POLICY_ID), any());
    }
}
