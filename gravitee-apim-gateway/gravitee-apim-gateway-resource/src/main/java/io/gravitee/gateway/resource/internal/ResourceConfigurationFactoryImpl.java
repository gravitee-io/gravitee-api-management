...
public class ResourceConfigurationFactoryImpl implements ResourceConfigurationFactory {
    ...
    public <T extends ResourceConfiguration> T create(Class<T> resourceConfigurationClass, String configuration) {
        if (configuration == null || configuration.isEmpty()) {
            log.error("Unable to create a resource configuration from a null or empty configuration data");
            return null;
        }
        ...
        try {
            ...
            log.error("Unable to instance resource configuration for {}", resourceConfigurationClass.getName(), ex);
        }
