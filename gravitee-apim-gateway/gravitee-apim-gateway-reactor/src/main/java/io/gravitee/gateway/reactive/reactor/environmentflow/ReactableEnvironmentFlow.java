 ...
 */
package io.gravitee.gateway.reactive.reactor.environmentflow;
...
@EqualsAndHashCode
@ToString
public class ReactableEnvironmentFlow implements Reactable, Serializable {
    ...
    private EnvironmentFlow definition;
