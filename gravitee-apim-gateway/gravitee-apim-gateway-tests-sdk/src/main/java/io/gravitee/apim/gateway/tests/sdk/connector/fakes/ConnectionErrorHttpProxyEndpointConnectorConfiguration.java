...
@Getter
@Setter
public class ConnectionErrorHttpProxyEndpointConnectorConfiguration extends HttpProxyEndpointConnectorConfiguration {

    Deque<Failure> connectionErrors = new LinkedList<>();

    record Failure(int status, String message) {}
}
