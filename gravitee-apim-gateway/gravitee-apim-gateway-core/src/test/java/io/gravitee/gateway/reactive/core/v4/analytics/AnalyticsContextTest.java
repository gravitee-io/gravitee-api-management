...
class AnalyticsContextTest {
    ...
    void should_not_be_enabled_if_analytics_is_null() {
        AnalyticsContext analyticsContext = new AnalyticsContext(configuration, null, "100MB", null);
    ...
    void should_be_enabled_if_analytics_is_enabled() {
        ...
        AnalyticsContext analyticsContext = new AnalyticsContext(configuration, analytics, "100MB", null);
