...
import io.gravitee.gateway.jupiter.core.v4.analytics.sampling.ProbabilityStrategyMessage;
        ...
        if (isEventNative) {
            ...
            if (messageSampling != null) {
                switch (messageSampling.getType()) {
                    case PROBABILITY:
                        messageSamplingStrategy = new ProbabilityStrategyMessage(messageSampling.getValue());
                        break;
                    case TEMPORAL:
                    ...
                    default:
                        ...
                        messageSamplingStrategy = new ProbabilityStrategyMessage(null);
                }
            } else {
