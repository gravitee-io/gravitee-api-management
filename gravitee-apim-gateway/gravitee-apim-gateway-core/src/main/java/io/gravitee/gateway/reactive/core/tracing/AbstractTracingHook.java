...
import io.gravitee.gateway.reactive.api.hook.*;
...
public abstract class AbstractTracingHook implements Hook {
    ...
    private static final String CTX_TRACING_SPAN_ATTR = ATTR_INTERNAL_PREFIX + "tracing-span-%s";
    ...
    protected void withAttributes(
        ...
        span.withAttribute(SPAN_PHASE_ATTR, executionPhase.name().toLowerCase(Locale.ROOT));
    }
