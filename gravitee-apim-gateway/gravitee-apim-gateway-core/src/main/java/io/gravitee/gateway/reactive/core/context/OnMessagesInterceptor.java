...
public interface OnMessagesInterceptor {
     ...
     */
    void registerMessagesInterceptor(final MessagesInterceptor messagesInterceptor);
     ...
     */
    @Builder
    record MessagesInterceptor(
        String id,
        Integer priority,
        Function<FlowableTransformer<Message, Message>, FlowableTransformer<Message, Message>> transformersFunction
    ) {
