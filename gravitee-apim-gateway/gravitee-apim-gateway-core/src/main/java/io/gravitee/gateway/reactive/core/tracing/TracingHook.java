 ...
 */
public class TracingHook extends AbstractTracingHook implements ProcessorHook, ChainHook {
    ...
    protected String getSpanName(final String id, final ExecutionPhase phase) {
        StringBuilder spanNameBuilder = new StringBuilder(phase.name()).append(" ");
