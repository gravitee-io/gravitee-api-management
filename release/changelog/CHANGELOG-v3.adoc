...
== https://github.com/gravitee-io/issues/milestone/599?closed=1[APIM - 3.10.50 (2022-09-19)]

=== Bug fixes

*_General_*

- Chagelog generation test bug report https://github.com/gravitee-io/issues/issues/8481[#8481]
