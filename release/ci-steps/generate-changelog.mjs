...
const docApimChangelogFolder = 'docs/apim/releases-and-changelog/changelog/';
const docApimChangelogFile = `${docApimChangelogFolder}gravitee-${versions.branch}-changelog.md`;
