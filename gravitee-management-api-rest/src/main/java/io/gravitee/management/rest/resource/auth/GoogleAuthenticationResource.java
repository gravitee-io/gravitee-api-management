...
public class GoogleAuthenticationResource extends SocialAuthenticationResource {
    ...
    public Response google(@Valid final Payload payload,
        ...
        accessData.add(CLIENT_SECRET,
                (String) authenticationProviderManager.findIdentityProviderByType(AuthenticationProvider.GOOGLE.getName())
    ...
    private Response processUser(final Map<String, Object> userInfo) {
        ...
        try {
            ...
            newUser.setSource(AuthenticationProvider.GOOGLE.getName());
