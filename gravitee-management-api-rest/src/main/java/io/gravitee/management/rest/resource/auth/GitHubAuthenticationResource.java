...
public class GitHubAuthenticationResource extends SocialAuthenticationResource {
    ...
    public Response github(@Valid final Payload payload,
        ...
        accessData.add(CLIENT_SECRET,
                (String) authenticationProviderManager.findIdentityProviderByType(AuthenticationProvider.GITHUB.getName())
                        .get().configuration().get("clientSecret"));
    ...
    private Response processUser(final Map<String, Object> userInfo) {
        ...
        try {
            ...
            newUser.setSource(AuthenticationProvider.GITHUB.getName());
