...
APIM publishes a living register of structural / coexistence debt (migrations Sonar does not track), alongside imported SonarCloud summaries, so contributors can ideate and pick work:

* link:tech-debt/TECH-DEBT-REPORT.md[TECH-DEBT-REPORT.md] — current KPIs, trends, and pick hints
* link:tech-debt/site/index.html[Visual dashboard] — charts, snapshot dropdown, Sonar filter
* link:tech-debt/README.md[tech-debt/README.md] — how to refresh metrics locally
