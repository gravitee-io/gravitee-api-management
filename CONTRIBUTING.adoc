...
[source,shell]
----
DEV_MODULE_ENTRIES="apim=http://localhost:3001/mf-manifest.json,billing=http://localhost:3003/mf-manifest.json" yarn nx serve gravitee-gamma-control-plane-webui
----
