...
[source,shell]
----
DEV_MODULE_ENTRIES="apim=http://localhost:3001/mf-manifest.json,platform=http://localhost:3002/mf-manifest.json,portals=http://localhost:3003/mf-manifest.json" yarn nx serve gravitee-gamma-control-plane-webui
----
