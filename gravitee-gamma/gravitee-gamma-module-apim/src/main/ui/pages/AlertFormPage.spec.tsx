...
import type { AlertTrigger } from '../features/apis/types/api';
import { createAlertTrigger, listAlerts, updateAlertTrigger } from '../services/alerts/alerts';
...
jest.mock('../services/alerts/alerts', () => ({
    ...
    alertTriggerToFormData: jest.requireActual('../services/alerts/alerts').alertTriggerToFormData,
}));
