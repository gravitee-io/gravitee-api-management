...
export const RESPONSE_TEMPLATE_KEYS = ['DEFAULT', ...GATEWAY_ERROR_KEYS] as const;

export type ResponseTemplateKey = (typeof RESPONSE_TEMPLATE_KEYS)[number];
