...
const REVIEW_COPY: ApiReviewBannerCopy = {
...
describe('ApiReviewBanner', () => {
    ...
    it('disables the action and says it is asking while the request is pending', () => {
    ...
    it('leaves the reviewer action label alone while a request is pending', () => {
        renderBanner(REVIEW_COPY, true);
