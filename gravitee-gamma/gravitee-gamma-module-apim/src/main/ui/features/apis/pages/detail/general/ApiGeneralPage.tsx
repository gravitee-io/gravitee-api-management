                                ...
                                {showAskForReview && (
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            isReadOnly || askReviewMutation.isPending
                                                ? 'cursor-not-allowed opacity-50'
                                                : 'cursor-pointer hover:bg-muted/50',
                                        )}
                                        onClick={() => setAskReviewOpen(true)}
                                        disabled={isReadOnly || askReviewMutation.isPending}
                                    >
