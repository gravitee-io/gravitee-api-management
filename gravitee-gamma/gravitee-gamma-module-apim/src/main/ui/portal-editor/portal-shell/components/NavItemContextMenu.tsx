...
interface NavItemContextMenuProps {
    ...
    readonly allowedAddTypes?: PortalNavigationItemType[];
    readonly hideStyleActions?: boolean;
}
...
export function NavItemContextMenu({
    ...
    const allowedTypes = orderAddNavItemTypes(allowedAddTypes ?? getAllowedAddNavItemTypes(allItems, item.id));
