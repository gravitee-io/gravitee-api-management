...
import styles from './NavLinkPagePicker.module.scss';

interface NavLinkPagePickerProps {
    readonly pages: readonly PortalNavigationPage[];
    readonly onSelect: (page: PortalNavigationPage) => void;
    readonly onCancel: () => void;
}

export function NavLinkPagePicker({ pages, onSelect, onCancel }: NavLinkPagePickerProps) {
