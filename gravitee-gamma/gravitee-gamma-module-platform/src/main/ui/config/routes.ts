...
export const ROUTES: Record<RouteKey, { readonly path: string; readonly label: string }> = {
    ...
    'primary-owner-mode': { path: 'primary-owner-mode', label: 'Primary Owner Mode' },
