...
/** Bulk-associates the group with every existing API/API Product/Application of the given type in one
 *  call (mirrors classic group.component.ts's "Add Group To Existing APIs/API Products/Applications"). */
