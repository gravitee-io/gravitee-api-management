...
const TABS = [
    ...
    { to: 'rulesets', end: false, label: 'Rulesets & Functions' },
] as const;

/**
 * Shared chrome for environment API Score: title, subtitle, and sibling Overview / Rulesets tabs.
 * Story 3 fills the Rulesets & Functions tab.
 */
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="border-b">
                <nav className="flex items-center gap-6" aria-label="API Score sections">
                    {TABS.map(tab => (
                        <NavLink
                            key={tab.label}
                            to={tab.to}
