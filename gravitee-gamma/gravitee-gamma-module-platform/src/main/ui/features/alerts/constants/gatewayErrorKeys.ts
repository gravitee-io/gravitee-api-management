...
/** Copied from Classic `entities/gateway-error-keys/GatewayErrorKeys` — do not import console-webui. */
export const GATEWAY_ERROR_KEYS = [
    'API_KEY_INVALID',
    'API_KEY_MISSING',
    'GATEWAY_CLIENT_CONNECTION_CLOSED',
    'GATEWAY_CLIENT_CONNECTION_ERROR',
    'GATEWAY_CLIENT_CONNECTION_REFUSED',
    'GATEWAY_CLIENT_CONNECTION_RESET',
    'GATEWAY_CLIENT_CONNECT_TIMEOUT',
    'GATEWAY_CLIENT_DNS_RESOLUTION_ERROR',
    'GATEWAY_CLIENT_READ_TIMEOUT',
    'GATEWAY_CLIENT_TLS_HANDSHAKE_ERROR',
    'GATEWAY_CLIENT_UNREACHABLE',
    ...
    'CLIENT_ABORTED_DURING_REQUEST_ERROR',
    'CLIENT_ABORTED_TCP_RESET',
    'CLIENT_ABORTED_BROKEN_PIPE',
    'CLIENT_ABORTED_CHANNEL_CLOSED',
] as const;

export const GATEWAY_ERROR_KEY_OPTIONS = GATEWAY_ERROR_KEYS.map(key => ({ value: key, label: key }));
