...
export function QualityRulesTable({
    ...
    const paginated = useMemo(() => paginateClientSideTableItems(sorted, currentPage, pageSize), [sorted, currentPage, pageSize]);

    // Deleting the last rules on a page would otherwise leave the reviewer looking at an empty page.
    useEffect(() => {
