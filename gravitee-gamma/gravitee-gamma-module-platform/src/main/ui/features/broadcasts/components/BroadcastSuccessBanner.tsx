...
export function BroadcastSuccessBanner({ reach, onComposeAnother }: Readonly<{ reach: number; onComposeAnother: () => void }>) {
    return (
        <div className="flex flex-col items-center gap-6 rounded-xl border border-success/25 bg-success/10 p-8 text-center">
