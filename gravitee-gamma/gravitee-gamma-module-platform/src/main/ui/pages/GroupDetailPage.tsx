...
export function GroupDetailPage() {
    ...
    const canAssociateGroup = Boolean(group && canEdit);
    ...
    return (
        <>
            ...
            <GroupSheet
                ...
                onAssociateToExisting={canAssociateGroup ? setAssociatingType : undefined}
                associationPending={associateMutation.isPending}
            />
