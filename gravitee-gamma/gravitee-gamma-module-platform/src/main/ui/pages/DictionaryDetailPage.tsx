        ...
        <div className="space-y-6">
            ...
            <section className="rounded-xl border bg-card p-5">
                <div className="flex items-start justify-between gap-4">
                    ...
                    {canUpdate && dictionary.type === 'MANUAL' ? (
                        <Button
                            type="button"
                            variant="outline"
            ...
            <section className="space-y-4 rounded-xl border bg-card p-5">
                <div className="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Key/value entries that make up this dictionary.</p>
                    </div>
                    {canUpdate ? (
                ...
                {propertyCount === 0 ? (
                    <div className="flex flex-col items-center justify-center gap-2 rounded-lg border border-dashed px-6 py-16 text-center">
                        ...
                        <p className="text-sm text-muted-foreground">No properties yet. Add key/value entries to this dictionary.</p>
                    </div>
                ) : (
