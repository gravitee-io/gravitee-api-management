 ...
 */
/**
 * Listened for by the APIM module, which keeps its own cached copy of these flags under a separate
 * QueryClient. Mirrors `PORTAL_SETTINGS_CHANGED_EVENT` in `gravitee-gamma-module-apim`.
 */
    ...
    function handleSave() {
        ...
        saveMutation.mutate(payload, {
            onSuccess: () => {
                ...
                // The APIM module caches the same flags under its own QueryClient, which this one cannot
                // invalidate, so tell it to drop them.
