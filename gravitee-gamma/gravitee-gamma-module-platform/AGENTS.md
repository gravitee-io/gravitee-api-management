# Coding Guidelines for gravitee-gamma-module-platform
...
```
io.gravitee.gamma.module.platform/
├── rest/
...
- Register a parent resource in `PlatformModule`. Each sub-resource should be referenced in that parent resource.
