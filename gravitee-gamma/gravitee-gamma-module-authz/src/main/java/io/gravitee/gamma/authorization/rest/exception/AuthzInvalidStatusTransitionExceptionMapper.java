...
@Provider
public class AuthzInvalidStatusTransitionExceptionMapper implements ExceptionMapper<AuthzInvalidStatusTransitionException> {

    @Override
    public Response toResponse(AuthzInvalidStatusTransitionException exception) {
