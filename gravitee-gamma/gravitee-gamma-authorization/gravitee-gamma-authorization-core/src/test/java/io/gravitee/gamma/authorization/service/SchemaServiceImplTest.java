...
class SchemaServiceImplTest {
    ...
    void setUp() {
        ...
        schemaService = new SchemaServiceImpl(entityRepository, policyRepository);
    ...
    void entityService_update_invalidates_the_schema_cache() {
        ...
        entityService.update(CALLER, "api.123", new UpdateEntityCommand(Map.of("k", "v1", "extra", "added"), null));
    ...
    void policyService_update_invalidates_the_schema_cache() {
        ...
        policyService.update(CALLER, created.id(), new UpdatePolicyCommand("renamed", ""));
