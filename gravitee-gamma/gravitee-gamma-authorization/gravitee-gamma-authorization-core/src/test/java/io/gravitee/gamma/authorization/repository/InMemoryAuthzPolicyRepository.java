...
public final class InMemoryAuthzPolicyRepository implements AuthzPolicyRepository {

    private final ConcurrentMap<Key, AuthzPolicy> store = new ConcurrentHashMap<>();
