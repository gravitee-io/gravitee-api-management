...
public record AuthzCascadeResult(@NotNull List<String> deletedEntityIds, @NotNull List<String> deletedPolicyIds) {
    public AuthzCascadeResult {
        AuthzValidators.validateCtor(AuthzCascadeResult.class, deletedEntityIds, deletedPolicyIds);
