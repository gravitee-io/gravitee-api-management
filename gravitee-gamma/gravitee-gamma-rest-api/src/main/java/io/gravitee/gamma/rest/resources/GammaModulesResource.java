...
/**
 * REST resource for dynamically loaded Gamma modules.
 *
...
public class GammaModulesResource {
    ...
    @Inject
    private GammaModuleService gammaModuleService;
