...
class AuthzPermissionContractTest {
    ...
    static {
        ...
        m.put("PoliciesResource.create", Set.of(RolePermissionAction.CREATE));
        m.put("PoliciesResource.list", Set.of(RolePermissionAction.READ));
        m.put("PoliciesResource.findById", Set.of(RolePermissionAction.READ));
        m.put("PoliciesResource.update", Set.of(RolePermissionAction.UPDATE));
        m.put("PoliciesResource.deploy", Set.of(RolePermissionAction.UPDATE));
        m.put("PoliciesResource.disable", Set.of(RolePermissionAction.UPDATE));
        m.put("PoliciesResource.delete", Set.of(RolePermissionAction.DELETE));
        m.put("EntitiesResource.upsert", Set.of(RolePermissionAction.CREATE, RolePermissionAction.UPDATE));
        m.put("EntitiesResource.list", Set.of(RolePermissionAction.READ));
        m.put("EntitiesResource.findByEntityId", Set.of(RolePermissionAction.READ));
        m.put("EntitiesResource.update", Set.of(RolePermissionAction.UPDATE));
        m.put("EntitiesResource.delete", Set.of(RolePermissionAction.DELETE));
        m.put("SchemaResource.currentSchema", Set.of(RolePermissionAction.READ));
