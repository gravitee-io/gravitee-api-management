...
@Component("AuthzEntitiesEnvKindIndexUpgrader")
public class EntityKindIndexUpgrader extends IndexUpgrader {

    @Override
    protected Index buildIndex() {
        return Index.builder().collection("authz_entities").name("e1k1").key("environmentId", ascending()).key("kind", ascending()).build();
    }
}
