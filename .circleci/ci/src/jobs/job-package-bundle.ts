...
# Rest API
cp -r gravitee-apim-distribution/gravitee-apim-distribution-standalone/gravitee-apim-distribution-standalone-rest-api/target/distribution ${fullDistributionDir}/graviteeio-apim-rest-api-${graviteeioVersion}

# Gateway
cp -r gravitee-apim-distribution/gravitee-apim-distribution-standalone/gravitee-apim-distribution-standalone-gateway/target/distribution ${fullDistributionDir}/graviteeio-apim-gateway-${graviteeioVersion}
