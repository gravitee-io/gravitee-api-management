...
describe('Build RPM workflow tests', () => {
  it.each`
    ...
    ${'4.1.0-alpha.1'} | ${true}  | ${false}          | ${'build-rpm-prerelease-dry-run.yml'}
    ${'4.1.0-alpha.1'} | ${false} | ${false}          | ${'build-rpm-prerelease-no-dry-run.yml'}
    ${'4.1.0'}         | ${true}  | ${false}          | ${'build-rpm-release-dry-run.yml'}
    ${'4.1.0'}         | ${false} | ${false}          | ${'build-rpm-release-no-dry-run.yml'}
  `(
