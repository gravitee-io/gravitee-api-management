...
import { BuildDockerChainguardFipsImageJob } from '../../jobs';
import { CircleCIEnvironment } from '../../pipelines';
import { config } from '../../config';

/**
 * The chainguard-FIPS component images, published to the private Azure registry only. Java
 * components build on the java-fips base, the web UIs on the nginx-fips one.
 */
export function chainguardFipsImageJobs(dynamicConfig: Config, environment: CircleCIEnvironment): workflow.WorkflowJob[] {
