...
/**
 * The chainguard-FIPS component images, published to the private Azure registry only.
 */
export function chainguardFipsJobs(dynamicConfig: Config, environment: CircleCIEnvironment): workflow.WorkflowJob[] {
