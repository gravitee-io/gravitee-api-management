...
class SseEntrypointSolaceEndpointIntegrationTest extends AbstractSolaceEndpointIntegrationTest {
    ...
    @Test
    @DeployApi({ "/apis/v4/messages/sse/sse-entrypoint-solace-endpoint.json" })
                ...
                return response
                    ...
                    .mergeWith(
                        publishToSolace(
                            topic,
                            List.of(
                                messageBuilder.build("message1".getBytes()),
