...
public class PathParametersV4IntegrationTest extends PathParametersIntegrationTest {
    ...
    void should_add_path_param_to_headers_when_no_param(String method, String path, Map<String, String> expectedHeaders, Set<String> excludedHeaders, HttpClient httpClient) throws InterruptedException {
