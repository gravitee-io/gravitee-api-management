...
import io.gravitee.apim.integration.tests.plan.oauth2.PlanOAuth2V4IntegrationTest;
...
public class PlanKeylessApiKeyJwtOAuth2MutualTLSV4IntegrationTest {
    ...
    public static void configureApi(ReactableApi<?> api, Class<?> definitionClass) {
        ...
        configurePlans(apiDefinition, Set.of("key-less", "api-key", "jwt", "oauth2", "mtls"));
    }
    ...
    public class SelectKeylessTest extends PlanKeylessV4IntegrationTest {
        ...
        public void configureEntrypoints(Map<String, EntrypointConnectorPlugin<?, ?>> entrypoints) {
            PlanKeylessApiKeyJwtOAuth2MutualTLSV4IntegrationTest.configureEntrypoints(entrypoints);
        }

        @Override
        public void configureEndpoints(Map<String, EndpointConnectorPlugin<?, ?>> endpoints) {
            PlanKeylessApiKeyJwtOAuth2MutualTLSV4IntegrationTest.configureEndpoints(endpoints);
        }

        @Override
        public void configureReactors(Set<ReactorPlugin<? extends ReactorFactory<?>>> reactors) {
            PlanKeylessApiKeyJwtOAuth2MutualTLSV4IntegrationTest.configureReactors(reactors);
        }

        @Override
        public void configurePolicies(Map<String, PolicyPlugin> policies) {
            PlanKeylessApiKeyJwtOAuth2MutualTLSV4IntegrationTest.configurePolicies(policies);
        }

        @Override
        public void configureResources(Map<String, ResourcePlugin> resources) {
            PlanKeylessApiKeyJwtOAuth2MutualTLSV4IntegrationTest.configureResources(resources);
        }

        @Override
        protected Stream<Arguments> provideApis() {
            return PlanKeylessApiKeyJwtOAuth2MutualTLSV4IntegrationTest.provideApis();
        }
